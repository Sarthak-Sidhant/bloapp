...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            int iParkedWorkersStackNextIndex = (int) (TarConstants.MAXID & j);
    ...
    private final int getCreatedWorkers() {
        return (int) (getControlState$volatile$FU().get(this) & TarConstants.MAXID);
    }
    ...
    private final int incrementCreatedWorkers() {
        return (int) (controlState$volatile$FU.incrementAndGet(this) & TarConstants.MAXID);
    }

    private final int decrementCreatedWorkers() {
        return (int) (getControlState$volatile$FU().getAndDecrement(this) & TarConstants.MAXID);
    }
    ...
    public final void shutdown(long timeout) {
        ...
        if (_isTerminated$volatile$FU.compareAndSet(this, 0, 1)) {
            ...
            synchronized (this.workers) {
                i = (int) (getControlState$volatile$FU().get(this) & TarConstants.MAXID);
            }
            if (1 <= i) {
                int i2 = 1;
                while (true) {
    ...
    private final int createNewWorker() {
        synchronized (this.workers) {
            ...
            int i2 = ((int) (getControlState$volatile$FU().get(this) & TarConstants.MAXID)) + 1;
            if (i2 <= 0 || this.workers.get(i2) != null) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            Worker worker = new Worker(this, i2);
            this.workers.setSynchronized(i2, worker);
            if (i2 != ((int) (TarConstants.MAXID & controlState$volatile$FU.incrementAndGet(this)))) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
    ...
    public final class Worker extends Thread {
        ...
        private final void tryTerminateWorker() {
            ...
            synchronized (resizableAtomicArray) {
                ...
                if (((int) (CoroutineScheduler.getControlState$volatile$FU().get(coroutineScheduler) & TarConstants.MAXID)) <= coroutineScheduler.corePoolSize) {
                    return;
                }
                if (workerCtl$volatile$FU.compareAndSet(this, -1, 1)) {
                    ...
                    int andDecrement = (int) (CoroutineScheduler.getControlState$volatile$FU().getAndDecrement(coroutineScheduler) & TarConstants.MAXID);
                    if (andDecrement != i) {
        ...
        private final Task trySteal(int stealingMode) {
            int i = (int) (CoroutineScheduler.getControlState$volatile$FU().get(CoroutineScheduler.this) & TarConstants.MAXID);
            if (i < 2) {
                return null;
            }
