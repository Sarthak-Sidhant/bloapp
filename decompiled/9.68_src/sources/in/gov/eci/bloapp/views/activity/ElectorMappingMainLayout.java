            ...
            if (response.isSuccessful() && response.body() != null) {
                try {
                    ...
                    while (i < jSONArray.length()) {
                        ...
                        String str = strOptString2 + StringUtils.SPACE + strOptString3;
                        String str2 = strOptString4 + StringUtils.SPACE + strOptString5;
                        ...
                        String str3 = strOptString7 + StringUtils.SPACE + strOptString8;
                        ...
                        ElectorMappingMainLayout.this.electorList.add(new ElectorMappingListModel(iOptInt4, str, str2, str3, strOptString9 + StringUtils.SPACE + strOptString10, strOptString11, strOptString, iOptInt5, iOptInt6, iOptInt7, strOptString12, iOptInt2, iOptInt3, iOptInt, strOptString6, strOptString13, iOptInt8, iOptInt9, iOptInt10, strOptString14, null));
                        i = i2 + 1;
            ...
            if (response.isSuccessful() && response.body() != null) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        ElectorMappingMainLayout.this.electorList2.add(new SelfProgenyModel(iOptInt, strOptString2 + StringUtils.SPACE + strOptString3, strOptString, iOptInt2, iOptInt3, TextUtils.isEmpty(strOptString5) ? "" : strOptString5, "", iOptInt4, strOptString6, strOptString7, iOptInt5, strOptString4, strOptString8, strOptString9, strOptString10, strOptString11, strOptString12, null));
                    }
                } catch (JSONException unused) {
                }
