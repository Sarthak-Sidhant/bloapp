...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m5433boximpl(m6871deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m6872serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }
    ...
    public void m6872serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m6871deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m5439constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
