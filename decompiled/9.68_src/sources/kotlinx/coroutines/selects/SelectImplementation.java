...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C01551 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01551(SelectImplementation<R> selectImplementation, Continuation<? super C01551> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C01551) {
            ...
            if ((c01551.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01551.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        Object objInvokeBlock = c01551.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01551.label;
        try {
            if (i == 0) {
                ...
                c01551.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c01551);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c01551 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c01551);
            }
            throw th;
        }
    }
