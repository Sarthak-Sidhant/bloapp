...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m6846computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM5265constructorimpl = Result.m5265constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM5264boximpl = Result.m5264boximpl(objM5265constructorimpl);
            Object objPutIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, resultM5264boximpl);
            obj = objPutIfAbsent == null ? resultM5264boximpl : objPutIfAbsent;
        }
