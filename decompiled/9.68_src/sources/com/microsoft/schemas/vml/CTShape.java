    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoaderTypeLoaderForClassLoader == null) {
                schemaTypeLoaderTypeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTShape.class.getClassLoader());
        ...
        public static CTShape newInstance() {
            return (CTShape) getTypeLoader().newInstance(CTShape.type, null);
        }
        ...
        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return getTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTShape.type, null);
        }
        ...
        public static CTShape parse(String str) throws XmlException {
            return (CTShape) getTypeLoader().parse(str, CTShape.type, (XmlOptions) null);
        }

        public static CTShape parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTShape) getTypeLoader().parse(str, CTShape.type, xmlOptions);
        }
