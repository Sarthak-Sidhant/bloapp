...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final /* synthetic */ Double m6545max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = XmlOptions.GENERATE_JAVA_15, hiddenSince = "1.6", warningSince = XmlOptions.GENERATE_JAVA_14)
    /* JADX INFO: renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m6546max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.maxOrNull(sequence);
    }
    ...
    public static final /* synthetic */ Double m6547min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = XmlOptions.GENERATE_JAVA_15, hiddenSince = "1.6", warningSince = XmlOptions.GENERATE_JAVA_14)
    /* JADX INFO: renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m6548min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.minOrNull(sequence);
    }
