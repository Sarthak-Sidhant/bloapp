...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public void onError(Throwable th) {
        ...
        if (!PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.terminalEvent, (Object) null, th)) {
    ...
    public void onComplete() {
        if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.terminalEvent, (Object) null, ExceptionHelper.TERMINATED)) {
