...
public final class EfTrackerCountScreenFinalBinding implements ViewBinding {
    ...
    public final LinearLayout singleSelectll;
    ...
    private EfTrackerCountScreenFinalBinding(LinearLayout rootView, ImageView backBtnIv, ConstraintLayout blaTopLayout, ConstraintLayout efCitizenBlo, ConstraintLayout efDigitBlo, ConstraintLayout efDigitBlo1, ConstraintLayout efDigitTrack, ConstraintLayout efDistBlo, ConstraintLayout efDistrTrack, ConstraintLayout efNotDigitBlo, ConstraintLayout efNotDistBlo, AppCompatAutoCompleteTextView efPartSpinner, ConstraintLayout efUncollectable, LinearLayout singleSelectll, ConstraintLayout sirHeader, ConstraintLayout sirUpdateTime, TextView textView3, TextView textView5, Toolbar toolbar, ImageView toolbarButton, TextView tvEfBloVerified, TextView tvEfCitizenBlo, TextView tvEfDigitBlo, TextView tvEfDistBlo, TextView tvEfNotDigitBlo, TextView tvEfNotDistBlo, TextView tvEfUncollectable, TextView tvSirHeader, TextView tvUpdateTime) {
        ...
        this.singleSelectll = singleSelectll;
                                    ...
                                    if (constraintLayoutFindChildViewById7 != null) {
                                        ...
                                        if (constraintLayoutFindChildViewById8 != null) {
                                            ...
                                            if (constraintLayoutFindChildViewById9 != null) {
                                                ...
                                                AppCompatAutoCompleteTextView appCompatAutoCompleteTextViewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.efPartSpinner);
                                                if (appCompatAutoCompleteTextViewFindChildViewById != null) {
                                                    ...
                                                    if (constraintLayoutFindChildViewById10 != null) {
                                                        i = R.id.singleSelectll;
                                                        LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.singleSelectll);
                                                                                                        ...
                                                                                                        if (textView8 != null) {
                                                                                                            ...
                                                                                                            if (textView9 != null) {
                                                                                                                ...
                                                                                                                if (textView10 != null) {
                                                                                                                    ...
                                                                                                                    if (textView11 != null) {
                                                                                                                        return new EfTrackerCountScreenFinalBinding((LinearLayout) rootView, imageView, constraintLayoutFindChildViewById, constraintLayoutFindChildViewById2, constraintLayoutFindChildViewById3, constraintLayoutFindChildViewById4, constraintLayoutFindChildViewById5, constraintLayoutFindChildViewById6, constraintLayoutFindChildViewById7, constraintLayoutFindChildViewById8, constraintLayoutFindChildViewById9, appCompatAutoCompleteTextViewFindChildViewById, constraintLayoutFindChildViewById10, linearLayout, constraintLayoutFindChildViewById11, constraintLayoutFindChildViewById12, textView, textView2, toolbarFindChildViewById, imageView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11);
                                                                                                                    }
                                                                                                                }
                                                                                                            }
                                                                                                        }
