...
public final class BloFormataPendingRvItemBinding implements ViewBinding {
    ...
    private BloFormataPendingRvItemBinding(ConstraintLayout rootView, TextView HNoTv, TextView SerialNoTv, TextView applicantName, TextView applicantNameTv, TextView epicnumber, ConstraintLayout layout, TextView nationalTv, TextView textView16, View view2) {
    ...
    public static BloFormataPendingRvItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloFormataPendingRvItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_formata_pending_rv_item, parent, false);
        if (attachToParent) {
    ...
    public static BloFormataPendingRvItemBinding bind(View rootView) {
        int i = R.id.H_No_tv;
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (constraintLayoutFindChildViewById != null) {
                                ...
                                if (textView6 != null) {
                                    i = R.id.textView16;
                                    TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.textView16);
                                    if (textView7 != null) {
                                        i = R.id.view2;
                                        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.view2);
                                        if (viewFindChildViewById != null) {
                                            return new BloFormataPendingRvItemBinding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, textView5, constraintLayoutFindChildViewById, textView6, textView7, viewFindChildViewById);
                                        }
                                    }
                                }
                            }
