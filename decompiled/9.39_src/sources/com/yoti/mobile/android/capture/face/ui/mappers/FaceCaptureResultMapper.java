...
public final class FaceCaptureResultMapper {
    ...
    public FaceCaptureResultMapper(FaceValidator faceValidator, FaceDetectionResultValidator faceDetectionResultValidator, ImageFaceCropper imageFaceCropper) {
        ...
        Intrinsics.checkNotNullParameter(imageFaceCropper, "faceCropper");
        this.faceValidator = faceValidator;
        this.faceDetectionResultValidator = faceDetectionResultValidator;
        this.faceCropper = imageFaceCropper;
    }
    ...
    private final FaceCaptureState mapFaceState(List<FaceResult> faces, ImageBuffer imageBuffer, FaceCaptureConfiguration configuration) throws NoWhenBranchMatchedException {
        ...
        Rect boundingBox = ((FaceResult) CollectionsKt.first(faces)).getBoundingBox();
        Rect rectCreateCropRect = this.faceCropper.createCropRect(boundingBox, imageBuffer.getF());
        FacialLandmarks facialLandmarks = ((FaceResult) CollectionsKt.first(faces)).getFacialLandmarks();
        FacialLandmarks croppedFacialLandmarks = this.faceCropper.getCroppedFacialLandmarks(rectCreateCropRect, facialLandmarks);
        ...
        FaceValidationResult faceValidationResultValidateFace = this.faceDetectionResultValidator.validateFace((FaceResult) CollectionsKt.first(faces), configuration);
        ...
        return new FaceCaptureState.ValidFace(imageFaceCropper.encodeImage(imageFaceCropper.performCrop(rectCreateCropRect, imageBuffer), configuration), rectCreateCropRect, boundingBox, facialLandmarks, croppedFacialLandmarks, configuration.getProvideSmileScore() ? ((FaceResult) CollectionsKt.first(faces)).getSmileScore() : null);
    }
}
