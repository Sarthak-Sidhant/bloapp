...
public final class ActivityDseVerifiedListBinding implements ViewBinding {
    ...
    public static ActivityDseVerifiedListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityDseVerifiedListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_dse_verified_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityDseVerifiedListBinding bind(View rootView) {
                                            ...
                                            if (spinner != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (imageView3 != null) {
                                                            return new ActivityDseVerifiedListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, frameLayout, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                        }
                                                    }
                                                }
                                            }
