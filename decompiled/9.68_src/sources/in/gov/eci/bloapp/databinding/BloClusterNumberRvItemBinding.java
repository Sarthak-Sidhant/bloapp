...
public final class BloClusterNumberRvItemBinding implements ViewBinding {
    ...
    private BloClusterNumberRvItemBinding(ConstraintLayout rootView, TextView ACPartNO, TextView SerialNoTv, TextView acPartnoET, LinearLayout actionTokenLayout, TextView actiontokenTv, TextView actiontokenTv1, TextView applicantET, TextView applicantTv, TextView epicNo, TextView epicNoET, ImageView imageView9, ConstraintLayout layout, View view2) {
    ...
    public static BloClusterNumberRvItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloClusterNumberRvItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_cluster_number_rv_item, parent, false);
        if (attachToParent) {
    ...
    public static BloClusterNumberRvItemBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                i = R.id.applicant_ET;
                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.applicant_ET);
                                if (textView6 != null) {
                                    i = R.id.applicant_tv;
                                                ...
                                                if (imageView != null) {
                                                    ...
                                                    if (constraintLayoutFindChildViewById != null) {
                                                        ...
                                                        if (viewFindChildViewById != null) {
                                                            return new BloClusterNumberRvItemBinding((ConstraintLayout) rootView, textView, textView2, textView3, linearLayout, textView4, textView5, textView6, textView7, textView8, textView9, imageView, constraintLayoutFindChildViewById, viewFindChildViewById);
                                                        }
                                                    }
                                                }
                                            }
