...
public class BloPatrika extends BaseFragment {
    ...
    private void getpatrika() {
        ...
        this.commonUtilClass.getuploadedfileBLOpatrika(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.prod, str, new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.blopatrika.BloPatrika$$ExternalSyntheticLambda6
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i, String str2) {
                this.f$0.lambda$getpatrika$6(i, str2);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$getpatrika$5(int i, String str, String str2) {
        ...
        if (i == 401 || i == 400) {
            Logger.d("getRefreshToken DBA---1 ", i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        ...
        Logger.d("getRefreshToken DBA----2 ", i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        getpatrika();
    }
