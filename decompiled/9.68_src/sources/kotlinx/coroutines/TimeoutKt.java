...
public final class TimeoutKt {
    ...
    public static final <T> Object m6755withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m6747toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m6756withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m6747toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM6748timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM6748timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m6748timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM6748timeoutMessageLRDsOJo == null) {
                strM6748timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM6748timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM6748timeoutMessageLRDsOJo, job);
    }
}
