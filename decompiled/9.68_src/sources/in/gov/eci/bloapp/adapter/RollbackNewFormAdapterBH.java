...
public class RollbackNewFormAdapterBH extends RecyclerView.Adapter<ViewHolder> {
    private Context context;
    ArrayList<RollbackNewModel> datalist;
    ArrayList<RollbackNewModel> filteredAl;

    public RollbackNewFormAdapterBH(ArrayList<RollbackNewModel> datalist, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.rollback_new_list_items_bh, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.fillEF.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormAdapterBH.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormAdapterBH.this.context, (Class<?>) specialRevisionActivityBH.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
                RollbackNewFormAdapterBH.this.context.startActivity(intent);
            }
        });
        viewHolder.uncollectable.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormAdapterBH.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormAdapterBH.this.context, (Class<?>) UncollectableSIRoldBH.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
