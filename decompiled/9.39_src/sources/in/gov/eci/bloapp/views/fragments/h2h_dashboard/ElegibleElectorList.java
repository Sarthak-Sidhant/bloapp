...
public class ElegibleElectorList extends BaseFragment {
    ...
    class AnonymousClass3 implements GenericRecyclerView.GenericRecyclerViewInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            ((BloSurveylistRvBinding) holder.binding).applicantTv.setText(String.valueOf(asJsonObject.get(Constants.FIRST_NAME)).replaceAll("^\"|\"$", "").replace("null", " ") + " " + String.valueOf(asJsonObject.get(Constants.LAST_NAME)).replaceAll("^\"|\"$", "").replace("null", " "));
            ((BloSurveylistRvBinding) holder.binding).ageTv.setText(String.valueOf(ElegibleElectorList.this.calculateage(String.valueOf(asJsonObject.get("dob")).replaceAll("^\"|\"$", "").replace("null", " "))));
            ((BloSurveylistRvBinding) holder.binding).housetv.setText(String.valueOf(asJsonObject.get("houseNo")).replaceAll("^\"|\"$", "").replace("null", " "));
