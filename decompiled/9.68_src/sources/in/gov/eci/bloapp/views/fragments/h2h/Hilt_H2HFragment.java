...
abstract class Hilt_H2HFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((H2HFragment_GeneratedInjector) generatedComponent()).injectH2HFragment((H2HFragment) UnsafeCasts.unsafeCast(this));
    }
