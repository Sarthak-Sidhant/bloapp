                                                                ...
                                                                if (linearLayout7 != null) {
                                                                    ...
                                                                    if (linearLayout8 != null) {
                                                                        ...
                                                                        if (linearLayout9 != null) {
                                                                            i = R.id.lvCategoryRadio;
                                                                            LinearLayout linearLayout10 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.lvCategoryRadio);
                                                                            if (linearLayout10 != null) {
                                                                                i = R.id.lv_chooseradioButtons;
                                                                                LinearLayout linearLayout11 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.lv_chooseradioButtons);
