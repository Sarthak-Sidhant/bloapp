...
public final class SingleRowViewFormByAeroBhBinding implements ViewBinding {
    ...
    private SingleRowViewFormByAeroBhBinding(LinearLayout rootView, TextView acName, TextView address, LinearLayout cardViewLL, TextView documentSubmitted, TextView electorName, TextView epic, TextView modifiedBy, TextView partNo, TextView state, TextView viewDetails) {
    ...
    public static SingleRowViewFormByAeroBhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SingleRowViewFormByAeroBhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.single_row_view_form_by_aero_bh, parent, false);
        if (attachToParent) {
    ...
    public static SingleRowViewFormByAeroBhBinding bind(View rootView) {
        int i = R.id.acName;
                ...
                if (linearLayout != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                i = R.id.modifiedBy;
                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.modifiedBy);
                                if (textView6 != null) {
                                    i = R.id.partNo;
                                    ...
                                    if (textView7 != null) {
                                        ...
                                        if (textView8 != null) {
                                            ...
                                            if (textView9 != null) {
                                                return new SingleRowViewFormByAeroBhBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, textView6, textView7, textView8, textView9);
                                            }
                                        }
                                    }
                                }
