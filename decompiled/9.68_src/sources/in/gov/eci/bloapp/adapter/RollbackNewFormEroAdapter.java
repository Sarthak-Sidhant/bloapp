...
public class RollbackNewFormEroAdapter extends RecyclerView.Adapter<ViewHolder> {
    private Context context;
    ArrayList<RollbackNewModel> datalist;
    ArrayList<RollbackNewModel> filteredAl;

    public RollbackNewFormEroAdapter(ArrayList<RollbackNewModel> datalist, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.rollback_new_list_ero_items, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.fillEF.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormEroAdapter.this.context, (Class<?>) specialRevisionActivity.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
                RollbackNewFormEroAdapter.this.context.startActivity(intent);
            }
        });
        viewHolder.uncollectable.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormEroAdapter.this.context, (Class<?>) UncollectableSIRold.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
