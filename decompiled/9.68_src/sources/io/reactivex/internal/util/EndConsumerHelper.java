...
public final class EndConsumerHelper {
    ...
    public static boolean setOnce(AtomicReference<Disposable> atomicReference, Disposable disposable, Class<?> cls) {
        ...
        if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(atomicReference, (Object) null, disposable)) {
            return true;
        }
        disposable.dispose();
    ...
    public static boolean setOnce(AtomicReference<Subscription> atomicReference, Subscription subscription, Class<?> cls) {
        ...
        if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(atomicReference, (Object) null, subscription)) {
            return true;
        }
        subscription.cancel();
