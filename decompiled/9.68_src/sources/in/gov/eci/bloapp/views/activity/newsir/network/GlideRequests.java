...
public class GlideRequests extends RequestManager {
    public /* bridge */ /* synthetic */ RequestManager addDefaultRequestListener(RequestListener listener) {
        return m1992addDefaultRequestListener((RequestListener<Object>) listener);
    }
    ...
    public GlideRequests m1992addDefaultRequestListener(RequestListener<Object> listener) {
    ...
    public GlideRequest<Drawable> m2011load(Bitmap bitmap) {
        return (GlideRequest) super.load(bitmap);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2012load(Drawable drawable) {
        return (GlideRequest) super.load(drawable);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2017load(String string) {
        return (GlideRequest) super.load(string);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2013load(Uri uri) {
        return (GlideRequest) super.load(uri);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2014load(File file) {
        return (GlideRequest) super.load(file);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2015load(Integer id) {
        return (GlideRequest) super.load(id);
    }

    @Deprecated
    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2018load(URL url) {
        return (GlideRequest) super.load(url);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2019load(byte[] bytes) {
        return (GlideRequest) super.load(bytes);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<Drawable> m2016load(Object o) {
    ...
    protected void setRequestOptions(RequestOptions toSet) {
        if (toSet instanceof GlideOptions) {
            ...
            super.setRequestOptions(new GlideOptions().m1868apply((BaseRequestOptions<?>) toSet));
        }
    }
}
