...
public class TrackSubmittedStatusFragment extends Hilt_TrackSubmittedStatusFragment {
    ...
    class AnonymousClass1 implements GenericRecyclerView.GenericRecyclerViewInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
            ...
            ((BloSubmittedListRvItemBinding) holder.binding).firstNameTv.setText(String.valueOf(asJsonObject.get(Constants.FIRST_NAME)).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE) + StringUtils.SPACE + String.valueOf(asJsonObject.get(Constants.LAST_NAME)).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            ((BloSubmittedListRvItemBinding) holder.binding).statusTv.setText(String.valueOf(asJsonObject.get("currentStatus")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            ((BloSubmittedListRvItemBinding) holder.binding).refNoTv.setText(String.valueOf(asJsonObject.get("formRefNo")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            ((BloSubmittedListRvItemBinding) holder.binding).formTypeTv.setText(String.valueOf(asJsonObject.get("formType")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0(Gson gson, int i, View view) {
            ...
            TrackSubmittedStatusFragment.this.bundle.putString(Constants.FIRST_NAME, String.valueOf(asJsonObject.get(Constants.FIRST_NAME)).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString(Constants.LAST_NAME, String.valueOf(asJsonObject.get(Constants.LAST_NAME)).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("formRefNo", String.valueOf(asJsonObject.get("formRefNo")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("formType", String.valueOf(asJsonObject.get("formType")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("submissionDate", String.valueOf(asJsonObject.get("submissionDate")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("currentStatus", String.valueOf(asJsonObject.get("currentStatus")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("submitted", String.valueOf(asJsonObject.get("submitted")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("bloAssigned", String.valueOf(asJsonObject.get("bloAssigned")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("fvrSubmitted", String.valueOf(asJsonObject.get("fvrSubmitted")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("epicNo", String.valueOf(asJsonObject.get("epicNo")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("epicDispatchedDate", String.valueOf(asJsonObject.get("epicDispatchedDate")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("hearingScheduled", String.valueOf(asJsonObject.get("hearingScheduled")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("fvrSubmittedHearingScheduled", String.valueOf(asJsonObject.get("fvrSubmittedHearingScheduled")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("accepted", String.valueOf(asJsonObject.get("accepted")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("rejected", String.valueOf(asJsonObject.get("rejected")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
            TrackSubmittedStatusFragment.this.bundle.putString("erollUpdatedDate", String.valueOf(asJsonObject.get("erollUpdatedDate")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
