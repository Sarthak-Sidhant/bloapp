...
public final class HexExtensionsKt {
    ...
    static {
        ...
        long[] jArr = new long[CpioConstants.C_IRUSR];
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m5485toStringimpl(ULong.m5439constructorimpl(j))));
        }
        return (int) j;
    }
