...
public final class DurationKt {
    ...
    private static final long m6707timesmvk6XK0(int i, long j) {
        return Duration.m6641timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m6706timeskIfJnKk(double d, long j) {
        return Duration.m6640timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM6701getZEROUwyO8pc = Duration.INSTANCE.m6701getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM6639plusLRDsOJo = Duration.m6639plusLRDsOJo(jM6701getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM6701getZEROUwyO8pc = Duration.m6639plusLRDsOJo(jM6639plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM6701getZEROUwyO8pc = Duration.m6639plusLRDsOJo(jM6701getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM6701getZEROUwyO8pc = Duration.INSTANCE.m6699getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM6639plusLRDsOJo2 = Duration.m6639plusLRDsOJo(jM6701getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM6701getZEROUwyO8pc = Duration.m6639plusLRDsOJo(jM6639plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM6701getZEROUwyO8pc = Duration.m6639plusLRDsOJo(jM6701getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m6654unaryMinusUwyO8pc(jM6701getZEROUwyO8pc) : jM6701getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m6610constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m6610constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m6610constructorimpl((j << 1) + ((long) i));
    }
