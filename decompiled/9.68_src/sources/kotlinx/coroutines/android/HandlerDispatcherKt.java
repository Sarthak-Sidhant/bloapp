...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM5265constructorimpl = Result.m5265constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m5271isFailureimpl(objM5265constructorimpl) ? null : objM5265constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo6814dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
