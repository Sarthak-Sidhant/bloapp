...
abstract class Hilt_ApplicantDetailsForm7Fragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_ApplicantDetailsForm7Fragment() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((ApplicantDetailsForm7Fragment_GeneratedInjector) generatedComponent()).injectApplicantDetailsForm7Fragment((ApplicantDetailsForm7Fragment) UnsafeCasts.unsafeCast(this));
    }
