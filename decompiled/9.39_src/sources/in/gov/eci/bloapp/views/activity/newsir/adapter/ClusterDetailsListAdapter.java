...
public class ClusterDetailsListAdapter extends RecyclerView.Adapter<holder> {
    private String acNo;
    List<ClusterDetailsPayload> al;
    private String atkband;
    CommomUtility commonUtilClass = new CommomUtility();
    private Context context;
    private String encodedImage;
    List<ClusterDetailsPayload> filteredAl;
    ItemClickCallback itemClickCallback;
    private String partNo;
    private String rtkband;
    private String token;

    public ClusterDetailsListAdapter(List<ClusterDetailsPayload> al, Context context, ItemClickCallback itemClickCallback) {
        this.al = al;
    ...
    public holder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new holder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cluster_items, viewGroup, false));
    }
    ...
    public void fun(ArrayList<ClusterDetailsPayload> filteredAl) {
        this.al = filteredAl;
