...
public final class ChannelKt {
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x006f A[Catch: all -> 0x0087, TryCatch #1 {all -> 0x0087, blocks: (B:26:0x0067, B:28:0x006f, B:29:0x0079), top: B:44:0x0067 }] */
    ...
    private static final <T> Object collect$$forInline(Publisher<T> publisher, Function1<? super T, Unit> function1, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            try {
                ...
                InlineMarker.finallyStart(1);
                ChannelsKt.cancelConsumed(channel$default, th);
                InlineMarker.finallyEnd(1);
                throw th2;
            }
        }
