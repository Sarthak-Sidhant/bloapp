...
public final class BloAllHousesRvItemBinding implements ViewBinding {
    ...
    private BloAllHousesRvItemBinding(ConstraintLayout rootView, TextView HNoTv, TextView NoOfPeopleTv, TextView NoOfPeopleValueET, TextView SerialNoTv, TextView VerifiedTickTv, TextView VerifiedTv, TextView addprop, TextView apptv, RelativeLayout button, LinearLayout layout, TextView nationalTv, TextView secn, View view2, TextView viewfamily) {
    ...
    public static BloAllHousesRvItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloAllHousesRvItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_all_houses_rv_item, parent, false);
        if (attachToParent) {
    ...
    public static BloAllHousesRvItemBinding bind(View rootView) {
        int i = R.id.H_No_tv;
                                                ...
                                                if (textView9 != null) {
                                                    ...
                                                    if (textView10 != null) {
                                                        ...
                                                        if (viewFindChildViewById != null) {
                                                            ...
                                                            if (textView11 != null) {
                                                                return new BloAllHousesRvItemBinding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, relativeLayout, linearLayout, textView9, textView10, viewFindChildViewById, textView11);
                                                            }
                                                        }
                                                    }
                                                }
