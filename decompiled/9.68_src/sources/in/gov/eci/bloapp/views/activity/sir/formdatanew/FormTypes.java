...
import in.gov.eci.bloapp.views.activity.AdditionalCommentListActivity;
...
import in.gov.eci.bloapp.views.activity.newsir.activity.anomaly.ViewLogicalActivity;
...
public class FormTypes extends SuperBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(SharedPref.getInstance(this).getUserRole()) && SharedPref.getInstance(getApplicationContext()).getUserRole().equalsIgnoreCase("blos")) {
            ...
            this.binding.migratedElector.setVisibility(8);
            ...
            this.binding.llPostAnomaly.setVisibility(8);
            this.binding.efDashboard.setVisibility(0);
            this.binding.efuploadAttendence.setVisibility(8);
            this.binding.viewDocuments.setVisibility(8);
            this.binding.additionalTabLL.setVisibility(8);
        } else if (SharedPref.getInstance(this).getRelativeListCode(Constants.RELATIVE_LIST_CODE).isEmpty() || SharedPref.getInstance(this).getRelativeListName(Constants.RELATIVE_LIST_NAME).isEmpty()) {
        ...
        this.binding.enumerationForm.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda13
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$1(view);
            }
        });
        this.binding.verifyElectors.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$2(view);
            }
        });
        this.binding.llDeceasedElectors.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$3(view);
            }
        });
        this.binding.llpseverification.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.binding.llPostAnomaly.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) ViewLogicalActivity.class));
            }
        });
        this.binding.llnomapping.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) NoMappingFormsListActivity.class));
            }
        });
        this.binding.llselectPhoto.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.6
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) SelectPhotoListActivity.class));
            }
        });
        this.binding.llupdatemobile.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.7
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) UpdateMobileListActivity.class));
            }
        });
        this.binding.filledBLO.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$5(view);
            }
        });
        this.binding.rollBack.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$6(view);
            }
        });
        this.binding.uncollectableEFLL.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$7(view);
            }
        });
        this.binding.efDashboard.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$8(view);
            }
        });
        this.binding.pendingElectorepicmatch.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.8
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) pendingElectorsEpicMatch.class));
            }
        });
        this.binding.viewFormByAero.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$9(view);
            }
        });
        this.binding.offlineLL.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$10(view);
            }
        });
        this.binding.additionalTabLL.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$11(view);
            }
        });
        this.binding.efTracker.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$12(view);
            }
        });
        this.binding.backBtnIv.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda10
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.lambda$onCreate$13(view, motionEvent);
            }
        });
        this.binding.noteOpen.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
            }
        });
        this.binding.llDelivery.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$14(view);
            }
        });
        this.binding.lldraftlist.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.10
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) ElectorEfListActivity.class));
            }
        });
        this.binding.viewDocuments.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.11
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) ViewDoumentsListActivity.class));
            }
        });
        this.binding.efuploadAttendence.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.12
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FormTypes.this.startActivity(new Intent((Context) FormTypes.this, (Class<?>) UploadAttendenceListActivity.class));
            }
        });
        this.binding.migratedElector.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$onCreate$11(View view) {
        startActivity(new Intent((Context) this, (Class<?>) AdditionalCommentListActivity.class));
    }
    ...
    public /* synthetic */ void lambda$onCreate$15(View view) {
        startActivity(new Intent((Context) this, (Class<?>) MigratedElectors.class));
    }
    ...
    public void setValues() {
        if (SharedPref.getInstance(getApplicationContext()).getpostDraft().equalsIgnoreCase("Y")) {
            this.binding.postTV.setVisibility(0);
        } else {
            this.binding.postTV.setVisibility(8);
        }
        ...
        if (SharedPref.getInstance(getApplicationContext()).getAdditionalCommentTab().equalsIgnoreCase("Y")) {
            this.binding.additionalTabLL.setVisibility(0);
        } else {
            this.binding.additionalTabLL.setVisibility(8);
        }
        ...
        if (SharedPref.getInstance(getApplicationContext()).getmigratedElectors().equalsIgnoreCase("Y")) {
            this.binding.migratedElector.setVisibility(0);
        } else if (SharedPref.getInstance(getApplicationContext()).getmigratedElectors().equalsIgnoreCase("N")) {
            this.binding.migratedElector.setVisibility(8);
        }
        if (SharedPref.getInstance(getApplicationContext()).getPostAnomaly().equalsIgnoreCase("Y")) {
            this.binding.llPostAnomaly.setVisibility(0);
        } else if (SharedPref.getInstance(getApplicationContext()).getPostAnomaly().equalsIgnoreCase("N")) {
            this.binding.llPostAnomaly.setVisibility(8);
        }
    }
    ...
    public void getRelationTypeDropdown() {
        ...
        ((UserClient) ApiClient.getClient2(this).create(UserClient.class)).getRelationDropdownSIR(map).enqueue(new AnonymousClass13());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$13, reason: invalid class name */
    class AnonymousClass13 implements Callback<JsonObject> {
        ...
        /* JADX WARN: Type inference failed for: r1v5, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes] */
        /* JADX WARN: Type inference failed for: r8v7, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes] */
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                FormTypes.this.dismissDialogSafely();
            ...
            if (response.code() == 401) {
                ...
                try {
                    ...
                    ?? r8 = FormTypes.this;
                    commomUtility.getRefreshToken(r8, ((FormTypes) r8).refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$13$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$onResponse$1(int i, String str, String str2) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = FormTypes.this.commomUtility;
                ?? r5 = FormTypes.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes$13$$ExternalSyntheticLambda1
    ...
    public void getAllAC() {
        ...
        ((UserClient) ApiClient.getClient(getApplicationContext()).create(UserClient.class)).getAllAssmbly(map).enqueue(new Callback<JsonObject>() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.14
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            ...
            ((UserClient) ApiClient.getClient2(this).create(UserClient.class)).getSirFeatureStatusSIR(stateCode, Token, SharedPref.getInstance(this).getAtknBnd(), SharedPref.getInstance(this).getRtknBnd(), "BLOAPP", "blo", stateCode).enqueue(new Callback<SIRResponseData>() { // from class: in.gov.eci.bloapp.views.activity.sir.formdatanew.FormTypes.15
                public void onResponse(Call<SIRResponseData> call, Response<SIRResponseData> response) {
                    if (response.code() == 200) {
                        ...
                        SharedPref.getInstance(FormTypes.this).setmigratedElectors(payload.getMigratedElectors());
                        SharedPref.getInstance(FormTypes.this).setpostDraft(payload.getPostDraft());
                        SharedPref.getInstance(FormTypes.this).setPostAnomaly(payload.getViewPostAnomaly());
                        SharedPref.getInstance(FormTypes.this).setAdditionalCommentTab(payload.getAdditionalCommentTab());
                        FormTypes.this.dismissDialogSafely();
