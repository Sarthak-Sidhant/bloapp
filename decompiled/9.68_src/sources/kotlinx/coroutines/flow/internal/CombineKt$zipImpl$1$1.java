    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                ((SendChannel) receiveChannelProduce$default).mo6827invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.1
                    {
                        super(1);
                    }
            ...
            static final class C00581 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        objMo6762receiveCatchingJP2dKIU = this.$second.mo6762receiveCatchingJP2dKIU(this);
                    ...
                    if (objMo6762receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM6773exceptionOrNullimpl = ChannelResult.m6773exceptionOrNullimpl(objMo6762receiveCatchingJP2dKIU);
                    ...
                    if (objMo6762receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo6762receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = obj2;
                    this.label = 2;
                    obj = function3.invoke(obj3, objMo6762receiveCatchingJP2dKIU, this);
                    r1 = obj2;
