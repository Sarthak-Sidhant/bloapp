...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    public static GlideOptions bitmapTransform(Transformation<Bitmap> transformation) {
        return new GlideOptions().m1909transform(transformation);
    }
    ...
    public static <T> GlideOptions option(Option<T> option, T t) {
        return new GlideOptions().m1903set(option, t);
    }

    public static GlideOptions decodeTypeOf(Class<?> clazz) {
        return new GlideOptions().m1875decode(clazz);
    }
    ...
    public GlideOptions m1909transform(Transformation<Bitmap> transformation) {
        return super.transform(transformation);
    }

    @SafeVarargs
    /* JADX INFO: renamed from: transform, reason: collision with other method in class */
    public final GlideOptions m1911transform(Transformation<Bitmap>... transformations) {
    ...
    public final GlideOptions m1912transforms(Transformation<Bitmap>... transformations) {
    ...
    public GlideOptions m1896optionalTransform(Transformation<Bitmap> transformation) {
    ...
    public GlideOptions m1868apply(BaseRequestOptions<?> options) {
