...
public final class BloFragmentEPICBinding implements ViewBinding {
    ...
    public static BloFragmentEPICBinding bind(View rootView) {
        int i = 2131362201;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, 2131362201);
        if (textView != null) {
            i = R.id.add1;
                                                                        ...
                                                                        if (imageView != null) {
                                                                            ...
                                                                            if (imageView2 != null) {
                                                                                ...
                                                                                if (imageView3 != null) {
                                                                                    ...
                                                                                    if (imageView4 != null) {
                                                                                        i = 2131364478;
                                                                                        LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, 2131364478);
