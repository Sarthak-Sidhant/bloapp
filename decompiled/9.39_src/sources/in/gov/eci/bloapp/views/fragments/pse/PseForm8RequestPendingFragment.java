...
public class PseForm8RequestPendingFragment extends BaseFragment {
    ...
    class AnonymousClass2 implements GenericRecyclerView.GenericRecyclerViewInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            ((BloFormataPendingRvItemBinding) holder.binding).applicantName.setText(((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getApplicantFirstname() + " " + ((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getApplicantLastname());
            ...
            final String str = ((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getApplicantFirstname() + " " + ((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getApplicantLastname();
            final String str2 = ((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getRelationfirstname() + " " + ((clusterDetailsDseModel) PseForm8RequestPendingFragment.this.allhousesList.get(position)).getRelationlastname();
