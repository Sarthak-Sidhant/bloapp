...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m5433boximpl(ULong.m5439constructorimpl(getMostSignificantBits())), ULong.m5433boximpl(ULong.m5439constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m6744fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$0(Uuid a, Uuid b) {
        ...
        if (j != b.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m5439constructorimpl(j), ULong.m5439constructorimpl(b.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m5439constructorimpl(a.leastSignificantBits), ULong.m5439constructorimpl(b.leastSignificantBits));
    }
}
