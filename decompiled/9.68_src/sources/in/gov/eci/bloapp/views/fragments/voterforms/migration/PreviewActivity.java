...
public class PreviewActivity extends Hilt_PreviewActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundleExtra != null) {
            ...
            this.flagid = bundleExtra.getString("flagid");
            this.addDocUrl = bundleExtra.getString("addDocUrl");
            this.addDocImageName = bundleExtra.getString("addDocImageName");
            this.addDocImageSize = bundleExtra.getString("addDocImageSize");
            this.addDocName = bundleExtra.getString("addDocName");
            this.uploadForm6Page1Url = bundleExtra.getString("offlineSignedPage1Url");
            this.uploadForm6Page2Url = bundleExtra.getString("offlineSignedPage2Url");
            this.uploadDoc1Photoname = bundleExtra.getString("addDoc1ImageName");
            this.uploadDoc1Size = bundleExtra.getString("addDoc1ImageSize");
            this.uploadDoc2Photoname = bundleExtra.getString("addDoc2ImageName");
            this.uploadDoc2Size = bundleExtra.getString("addDoc2ImageSize");
        ...
        this.binding.viewpager.setAdapter(new ViewStateAdapter(this, this.blostatecode, this.draftname, this.draftcreatedon, this.location, this.epicNumber, this.ornamereg, this.corname, this.cornamereg, this.correlname, this.correlnamereg, this.orgrelatname, this.orgrelatnamereg, this.orggender, this.orggenderreg, this.corgender, this.corgendereg, this.orgdob, this.cordob, this.orgaddress, this.orgaddressreg, this.addresssor, this.addresssorreg, this.addresscor, this.addresscorreg, this.appdate, this.relationType, this.sordistrict, this.coedistrict, this.orgstreet, this.orghouseno, this.orghousenoreg, this.sectionNumber, this.shiftingImage, this.formverificationPayload, this.isdeclarationEnabled, this.addDocUrl, this.addDocImageName, this.addDocImageSize, this.addDocName, this.uploadForm6Page1Url, this.uploadForm6Page2Url, this.uploadDoc1Photoname, this.uploadDoc1Size, this.uploadDoc2Photoname, this.uploadDoc2Size));
    ...
    public /* synthetic */ void lambda$onCreate$5(int i, String str) {
        ...
        if (i == 200) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage(this.msg + StringUtils.SPACE + this.referenceNumber);
