...
public final class BloFragmentShiftingOfResidenceBinding implements ViewBinding {
    ...
    public static BloFragmentShiftingOfResidenceBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloFragmentShiftingOfResidenceBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_fragment_shifting_of_residence, parent, false);
        if (attachToParent) {
    ...
    public static BloFragmentShiftingOfResidenceBinding bind(View rootView) {
