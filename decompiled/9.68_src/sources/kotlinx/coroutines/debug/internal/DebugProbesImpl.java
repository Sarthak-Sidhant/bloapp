...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM5265constructorimpl = Result.m5265constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5271isFailureimpl(objM5265constructorimpl)) {
            objM5265constructorimpl = null;
        }
        return (Function1) objM5265constructorimpl;
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM5265constructorimpl = Result.m5265constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM5265constructorimpl;
