...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m6911deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m6913deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) throws CloneNotSupportedException {
        ...
        String[] strArrEffectiveCipherSuites = Internal.effectiveCipherSuites(this, socketEnabledCipherSuites);
        ...
        if (isFallback && iIndexOf != -1) {
            ...
            strArrEffectiveCipherSuites = Util.concat(strArrEffectiveCipherSuites, str);
        }
        Builder builderCipherSuites = new Builder(this).cipherSuites((String[]) Arrays.copyOf(strArrEffectiveCipherSuites, strArrEffectiveCipherSuites.length));
