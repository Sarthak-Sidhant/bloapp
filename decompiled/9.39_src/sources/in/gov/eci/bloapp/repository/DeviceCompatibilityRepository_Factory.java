...
public final class DeviceCompatibilityRepository_Factory implements Factory<DeviceCompatibilityRepository> {
    ...
    public DeviceCompatibilityRepository m601get() {
        DeviceCompatibilityRepository deviceCompatibilityRepositoryNewInstance = newInstance((ApiInterface) this.apiInterfaceProvider.get());
        DeviceCompatibilityRepository_MembersInjector.injectDbHandler(deviceCompatibilityRepositoryNewInstance, (DatabaseHelper) this.dbHandlerProvider.get());
        DeviceCompatibilityRepository_MembersInjector.injectEciDatabase(deviceCompatibilityRepositoryNewInstance, (EciDatabase) this.eciDatabaseProvider.get());
