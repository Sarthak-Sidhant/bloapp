...
public final class CheckListViewModel_Factory implements Factory<CheckListViewModel> {
    ...
    public CheckListViewModel get() {
        CheckListViewModel checkListViewModelNewInstance = newInstance(this.repoProvider.get());
        CheckListViewModel_MembersInjector.injectApiInterface(checkListViewModelNewInstance, this.apiInterfaceProvider.get());
