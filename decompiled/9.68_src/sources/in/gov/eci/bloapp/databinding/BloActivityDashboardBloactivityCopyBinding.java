...
public final class BloActivityDashboardBloactivityCopyBinding implements ViewBinding {
    ...
    public static BloActivityDashboardBloactivityCopyBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloActivityDashboardBloactivityCopyBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_activity_dashboard_bloactivity_copy, parent, false);
        if (attachToParent) {
    ...
    public static BloActivityDashboardBloactivityCopyBinding bind(View rootView) {
                                                    ...
                                                    if (textView6 != null) {
                                                        ...
                                                        if (textView7 != null) {
                                                            ...
                                                            if (textView8 != null) {
                                                                ...
                                                                if (textView9 != null) {
                                                                    return new BloActivityDashboardBloactivityCopyBinding(swipeRefreshLayout, imageView, cardViewFindChildViewById, cardViewFindChildViewById2, frameLayout, linearLayout, swipeRefreshLayout, linearLayout2, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9);
                                                                }
                                                            }
                                                        }
                                                    }
