...
public class SharedPref {
    ...
    public void setUserRole(String bloPhone) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("userRole", bloPhone);
        editorEdit.apply();
    }
    ...
    public String getSupervisorData() {
        return sharedPreferences.contains("supervisor") ? sharedPreferences.getString("supervisor", "") : "";
    }
    ...
    public void setSupervisorData(String gender) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("supervisor", gender);
        editorEdit.apply();
    }
    ...
    public String getAdditionalCommentTab() {
        return sharedPreferences.getString("additionalCommentTab", "");
    }

    public void setAdditionalCommentTab(String efTrackerTab) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("additionalCommentTab", efTrackerTab);
        editorEdit.apply();
    }
    ...
    public void setEroAppStatus(int sharedTrainingStatus) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putInt("eroAppStatus", sharedTrainingStatus);
        editorEdit.apply();
    }

    public int getEroAppStatus() {
        return sharedPreferences.getInt("eroAppStatus", 0);
    }

    public void setEroAppMessage(String sharedTrainingMessage) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("eroAppStatusMessage", sharedTrainingMessage);
        editorEdit.apply();
    }

    public String getEroAppMessage() {
        return sharedPreferences.getString("eroAppStatusMessage", "");
    }
    ...
    public void setmigratedElectors(String viewModifiedByAEROERO) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("migratedElectors", viewModifiedByAEROERO);
        editorEdit.apply();
    }

    public String getmigratedElectors() {
        return sharedPreferences.getString("migratedElectors", "");
    }

    public void setpostDraft(String viewModifiedByAEROERO) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("postDraft", viewModifiedByAEROERO);
        editorEdit.apply();
    }

    public String getpostDraft() {
        return sharedPreferences.getString("postDraft", "");
    }

    public void setPostAnomaly(String viewPostAnomaly) {
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        editorEdit.putString("viewPostAnomaly", viewPostAnomaly);
        editorEdit.apply();
    }

    public String getPostAnomaly() {
        return sharedPreferences.getString("viewPostAnomaly", "");
    }
}
