...
public final class MigrationRepository_Factory implements Factory<MigrationRepository> {
    ...
    public MigrationRepository m607get() {
        MigrationRepository migrationRepositoryNewInstance = newInstance((ApiInterface) this.apiInterfaceProvider.get());
        MigrationRepository_MembersInjector.injectDbHandler(migrationRepositoryNewInstance, (DatabaseHelper) this.dbHandlerProvider.get());
        MigrationRepository_MembersInjector.injectEciDatabase(migrationRepositoryNewInstance, (EciDatabase) this.eciDatabaseProvider.get());
