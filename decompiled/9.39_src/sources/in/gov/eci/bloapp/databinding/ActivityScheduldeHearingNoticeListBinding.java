...
public final class ActivityScheduldeHearingNoticeListBinding implements ViewBinding {
    ...
    public static ActivityScheduldeHearingNoticeListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityScheduldeHearingNoticeListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_schedulde_hearing_notice_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityScheduldeHearingNoticeListBinding bind(View rootView) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (imageView3 != null) {
                                                        return new ActivityScheduldeHearingNoticeListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                    }
                                                }
                                            }
                                        }
