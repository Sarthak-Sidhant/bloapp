...
abstract class Hilt_FormsInDraft extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_FormsInDraft(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FormsInDraft_GeneratedInjector) generatedComponent()).injectFormsInDraft((FormsInDraft) UnsafeCasts.unsafeCast(this));
    }
