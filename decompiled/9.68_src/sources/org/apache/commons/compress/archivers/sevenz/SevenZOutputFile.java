...
public class SevenZOutputFile implements Closeable {
    ...
    public void finish() throws IOException {
        ...
        ByteBuffer byteBufferOrder = ByteBuffer.allocate(SevenZFile.sevenZSignature.length + 26).order(ByteOrder.LITTLE_ENDIAN);
        this.channel.position(0L);
        byteBufferOrder.put(SevenZFile.sevenZSignature);
        ...
        crc32.reset();
        crc32.update(byteBufferOrder.array(), SevenZFile.sevenZSignature.length + 6, 20);
        byteBufferOrder.putInt(SevenZFile.sevenZSignature.length + 2, (int) crc32.getValue());
    ...
    private class OutputStreamWrapper extends OutputStream {
        ...
        public void write(byte[] bArr, int i, int i2) throws IOException {
            ...
            SevenZOutputFile.this.fileBytesWritten += (long) i2;
        }
    }
}
