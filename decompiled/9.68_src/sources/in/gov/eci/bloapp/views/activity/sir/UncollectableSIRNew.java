...
public class UncollectableSIRNew extends SuperBaseActivity {
    private int acNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.binding.uncollectableRG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.1
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton radioButton = (RadioButton) UncollectableSIRNew.this.findViewById(radioGroup.getCheckedRadioButtonId());
                int iIndexOfChild = radioGroup.indexOfChild(radioButton);
                if (iIndexOfChild == 0) {
                    UncollectableSIRNew.this.reasonTrans = String.valueOf(iIndexOfChild);
                } else {
                    UncollectableSIRNew.this.reasonTrans = String.valueOf(iIndexOfChild - 1);
                }
                UncollectableSIRNew.this.unCollectReason = radioButton.getText().toString();
                if (UncollectableSIRNew.this.unCollectReason.equalsIgnoreCase(UncollectableSIRNew.this.getString(R.string.already_enrolled_sir))) {
                    UncollectableSIRNew.this.binding.alreadyEpicLayout.setVisibility(0);
                } else {
                    UncollectableSIRNew.this.binding.alreadyEpicLayout.setVisibility(8);
                    UncollectableSIRNew.this.binding.enterEpicSirTv.setText("");
                }
            }
        });
        this.binding.submitSIR.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$0(view);
            }
        });
        this.binding.speakReason.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.2
            ...
            public void onClick(View v) {
                UncollectableSIRNew.this.utils.showVoicePopup(UncollectableSIRNew.this, new SpeechtoTextCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.2.1
                    @Override // in.gov.eci.bloapp.views.activity.newsir.callback.SpeechtoTextCallback
                    public void onCallBack(String result) {
                        if (result.length() > 150) {
                            UncollectableSIRNew.this.showDialog1(UncollectableSIRNew.this.getString(R.string.alertMsg), "Reason should not be more the 150 characters.");
                        } else {
                            UncollectableSIRNew.this.binding.resontv.setText(result);
                        }
                    }
                });
            }
        });
        this.binding.uploadEnumerationFormPage1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.pickPhoto(101, "enFormPage1");
            }
        });
        this.binding.uploadEnumerationFormPage2.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument1UrlS)) {
                    UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                    uncollectableSIRNew.showDialog1(uncollectableSIRNew.alertText, "Please Upload Page 1");
                } else {
                    UncollectableSIRNew.this.pickPhoto(102, "enFormPage2");
                }
            }
        });
        this.binding.uploadSupportingDocumentsPage1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.pickPhoto(103, "sDPage1");
            }
        });
        this.binding.uploadSupportingDocumentsPage2.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS)) {
                    UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                    uncollectableSIRNew.showDialog1(uncollectableSIRNew.alertText, "Please Upload Page 1");
                } else {
                    UncollectableSIRNew.this.pickPhoto(104, "sDPage2");
                }
            }
        });
        this.binding.cancelEnumerationFormPage1Image.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$1(view);
            }
        });
        this.binding.cancelEnumerationFormPage2Image.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$2(view);
            }
        });
        this.binding.cancelSupportingDocumentsPage1Image.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda11
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreate$3(view);
            }
        });
        this.binding.cancelSupportingDocumentsPage2Image.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void submit() {
        ...
        if (this.binding.uncollectableRG.getCheckedRadioButtonId() == -1) {
            ...
            this.service.saveEnumerationStatusSIRNew(lowerCase, map, uncollectablemodel).enqueue(new AnonymousClass7());
        }
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$7, reason: invalid class name */
    class AnonymousClass7 implements Callback<JsonObject> {
        AnonymousClass7() {
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r5v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:596)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.isSuccessful() && response.body() != null) {
                if (UncollectableSIRNew.this.alertDialog != null) {
                    UncollectableSIRNew.this.alertDialog.dismiss();
                }
                UncollectableSIRNew.this.showDialog2("", ((JsonObject) response.body()).get("message").toString());
                return;
            }
            if (response.code() == 400 || response.code() == 401) {
                ...
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r5 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$7$$ExternalSyntheticLambda0
            ...
            try {
                ...
                UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                uncollectableSIRNew.showDialog1(uncollectableSIRNew.alertText, strOptString);
        ...
        public /* synthetic */ void lambda$onResponse$0(DialogInterface dialogInterface, int i) {
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setIsLoggedIn(false);
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setLocaleBool(false);
            UncollectableSIRNew.this.startActivity(new Intent(UncollectableSIRNew.this.getApplicationContext(), (Class<?>) LoginActivity.class));
        }
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$8, reason: invalid class name */
    class AnonymousClass8 implements Callback<JsonArray> {
        AnonymousClass8() {
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r4v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:596)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
            if (response.code() == 200 && response.body() != null) {
                if (!((JsonArray) response.body()).isEmpty()) {
                    Toast.makeText((Context) UncollectableSIRNew.this, (CharSequence) "Valid EPIC", 0).show();
                    UncollectableSIRNew.this.validEpicFlag = "Y";
                    UncollectableSIRNew.this.submit();
                    UncollectableSIRNew.this.alertDialog.dismiss();
                    return;
                }
                UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                uncollectableSIRNew.showDialog1(uncollectableSIRNew.getString(R.string.alertMsg), UncollectableSIRNew.this.getString(R.string.please_check_epic_number));
                UncollectableSIRNew.this.alertDialog.dismiss();
                return;
            }
            if (response.code() == 400 || response.code() == 401) {
                ...
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r4 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r4, r4.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$8$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i);
                    }
    ...
    public void showDialog1(String alertText, String message) {
        ...
        new AlertDialog.Builder(this).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void showDialog2(String alertText, String message) {
        ...
        new AlertDialog.Builder(this).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void initClickListener() {
        this.binding.backBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void pickPhoto(final int code, final String listCode) {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda7
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$9, reason: invalid class name */
    class AnonymousClass9 implements Callback<JsonObject> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r13v25, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:596)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 401) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r13 = UncollectableSIRNew.this;
                String str = ((UncollectableSIRNew) r13).refreshToken;
                ...
                commomUtility.getRefreshToken(r13, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$9$$ExternalSyntheticLambda0
            ...
            if (response.code() == 429) {
                ...
                if (jsonResponse.getPayload() != null) {
                    ...
                    if (payload instanceof Map) {
                        ...
                        UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                        uncollectableSIRNew.uploadPhoto(this.val$statecode, this.val$asmblyNo, this.val$partno, this.val$filepath, this.val$captureFileName, uncollectableSIRNew.token, this.val$reference, this.val$uploadtype);
                        return;
                    }
                    return;
                }
            ...
            if (response.code() == 200) {
                try {
                    ...
                    String strDecryptUrl = UncollectableSIRNew.this.decryptUrl(String.valueOf(jSONObject.get("presignedUrl")));
                    String strValueOf = String.valueOf(jSONObject.get("fileName"));
                    if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo1strNew)) {
                        UncollectableSIRNew.this.relativeDocument1UrlS = strValueOf.replace(RegexMatcher.JSON_STRING_REGEX, "");
                        UncollectableSIRNew.this.uploadImageons3(strDecryptUrl, this.val$filepath + this.val$captureFileName, this.val$uploadtype, UncollectableSIRNew.this.relativeDocument1UrlS);
                    }
                    if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo2strNew)) {
                        UncollectableSIRNew.this.relativeDocument2UrlS = strValueOf.replace(RegexMatcher.JSON_STRING_REGEX, "");
                        UncollectableSIRNew.this.uploadImageons3(strDecryptUrl, this.val$filepath + this.val$captureFileName, this.val$uploadtype, UncollectableSIRNew.this.relativeDocument2UrlS);
                    }
                    if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo3strNew)) {
                        UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS = strValueOf.replace(RegexMatcher.JSON_STRING_REGEX, "");
                        UncollectableSIRNew.this.uploadImageons3(strDecryptUrl, this.val$filepath + this.val$captureFileName, this.val$uploadtype, UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS);
                    }
                    if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo4strNew)) {
                        UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS = strValueOf.replace(RegexMatcher.JSON_STRING_REGEX, "");
                        UncollectableSIRNew.this.uploadImageons3(strDecryptUrl, this.val$filepath + this.val$captureFileName, this.val$uploadtype, UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS);
                    }
                    ...
                    UncollectableSIRNew.this.resetImage(this.val$uploadtype, e.getMessage());
                    Logger.d("", e.getMessage());
                    return;
                }
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo1strNew)) {
                ...
                UncollectableSIRNew.this.photo1countNew = 0;
                UncollectableSIRNew.this.binding.enumerationFormPage1.setVisibility(8);
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setEnabled(true);
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo2strNew)) {
                if (UncollectableSIRNew.this.alertDialog != null) {
                    UncollectableSIRNew.this.alertDialog.dismiss();
                }
                UncollectableSIRNew.this.photo2countNew = 0;
                UncollectableSIRNew.this.binding.enumerationFormPage2.setVisibility(8);
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setEnabled(true);
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo3strNew)) {
                if (UncollectableSIRNew.this.alertDialog != null) {
                    UncollectableSIRNew.this.alertDialog.dismiss();
                }
                UncollectableSIRNew.this.photo3countNew = 0;
                UncollectableSIRNew.this.binding.supportingDocumentsPage1.setVisibility(8);
                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage1.setEnabled(true);
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo4strNew)) {
                if (UncollectableSIRNew.this.alertDialog != null) {
                    UncollectableSIRNew.this.alertDialog.dismiss();
                }
                UncollectableSIRNew.this.photo4countNew = 0;
                UncollectableSIRNew.this.binding.supportingDocumentsPage2.setVisibility(8);
                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage2.setEnabled(true);
            }
            UncollectableSIRNew.this.alertDialog.dismiss();
            try {
                JSONObject jSONObject2 = new JSONObject(response.errorBody().string());
                String string = jSONObject2.getString("message");
                UncollectableSIRNew uncollectableSIRNew2 = UncollectableSIRNew.this;
                uncollectableSIRNew2.showDialog1(uncollectableSIRNew2.alertText, string);
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r2v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:596)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, String str8, String str9) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r2 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r2, r2.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$9$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
            ...
            UncollectableSIRNew.this.token = "Bearer " + str8;
            UncollectableSIRNew.this.refreshToken = str9;
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setRefreshToken(str9);
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setToken("Bearer " + str8);
            UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
            uncollectableSIRNew.uploadPhoto(str, str2, str3, str4, str5, uncollectableSIRNew.token, str6, str7);
        }
        ...
        public /* synthetic */ void lambda$onResponse$0(DialogInterface dialogInterface, int i) {
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setIsLoggedIn(false);
            SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setLocaleBool(false);
            UncollectableSIRNew.this.startActivity(new Intent((Context) UncollectableSIRNew.this, (Class<?>) LoginActivity.class));
        }

        public void onFailure(Call<JsonObject> call, Throwable t) {
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo1strNew)) {
                if (UncollectableSIRNew.this.photo1countNew < 2 && TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument1UrlS)) {
                    UncollectableSIRNew.this.photo1countNew++;
                    UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
                    uncollectableSIRNew.uploadPhoto(this.val$statecode, this.val$asmblyNo, this.val$partno, this.val$filepath, this.val$captureFileName, uncollectableSIRNew.token, this.val$reference, this.val$uploadtype);
                } else {
                    if (UncollectableSIRNew.this.alertDialog != null) {
                    ...
                    UncollectableSIRNew.this.binding.enumerationFormPage1.setVisibility(8);
                    UncollectableSIRNew uncollectableSIRNew2 = UncollectableSIRNew.this;
                    uncollectableSIRNew2.showDialog1(uncollectableSIRNew2.alertText, UncollectableSIRNew.this.fileNotFoundMessage);
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setEnabled(true);
                }
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo2strNew)) {
                if (UncollectableSIRNew.this.photo2countNew < 2 && TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument2UrlS)) {
                    UncollectableSIRNew.this.photo2countNew++;
                    UncollectableSIRNew uncollectableSIRNew3 = UncollectableSIRNew.this;
                    uncollectableSIRNew3.uploadPhoto(this.val$statecode, this.val$asmblyNo, this.val$partno, this.val$filepath, this.val$captureFileName, uncollectableSIRNew3.token, this.val$reference, this.val$uploadtype);
                } else {
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                    UncollectableSIRNew.this.photo2countNew = 0;
                    UncollectableSIRNew.this.binding.enumerationFormPage2.setVisibility(8);
                    UncollectableSIRNew uncollectableSIRNew4 = UncollectableSIRNew.this;
                    uncollectableSIRNew4.showDialog1(uncollectableSIRNew4.alertText, UncollectableSIRNew.this.fileNotFoundMessage);
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setEnabled(true);
                }
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo3strNew)) {
                if (UncollectableSIRNew.this.photo3countNew < 2 && TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS)) {
                    UncollectableSIRNew.this.photo3countNew++;
                    UncollectableSIRNew uncollectableSIRNew5 = UncollectableSIRNew.this;
                    uncollectableSIRNew5.uploadPhoto(this.val$statecode, this.val$asmblyNo, this.val$partno, this.val$filepath, this.val$captureFileName, uncollectableSIRNew5.token, this.val$reference, this.val$uploadtype);
                } else {
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                    UncollectableSIRNew.this.photo3countNew = 0;
                    UncollectableSIRNew.this.binding.supportingDocumentsPage1.setVisibility(8);
                    UncollectableSIRNew uncollectableSIRNew6 = UncollectableSIRNew.this;
                    uncollectableSIRNew6.showDialog1(uncollectableSIRNew6.alertText, UncollectableSIRNew.this.fileNotFoundMessage);
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                    UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setEnabled(true);
                }
            }
            if (this.val$uploadtype.equals(UncollectableSIRNew.this.photo4strNew)) {
                if (UncollectableSIRNew.this.photo4countNew < 2 && TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS)) {
                    UncollectableSIRNew.this.photo4countNew++;
                    UncollectableSIRNew uncollectableSIRNew7 = UncollectableSIRNew.this;
                    uncollectableSIRNew7.uploadPhoto(this.val$statecode, this.val$asmblyNo, this.val$partno, this.val$filepath, this.val$captureFileName, uncollectableSIRNew7.token, this.val$reference, this.val$uploadtype);
                    return;
                }
                if (UncollectableSIRNew.this.alertDialog != null) {
                    UncollectableSIRNew.this.alertDialog.dismiss();
                ...
                UncollectableSIRNew.this.photo4countNew = 0;
                UncollectableSIRNew.this.binding.supportingDocumentsPage2.setVisibility(8);
                UncollectableSIRNew uncollectableSIRNew8 = UncollectableSIRNew.this;
                uncollectableSIRNew8.showDialog1(uncollectableSIRNew8.alertText, UncollectableSIRNew.this.fileNotFoundMessage);
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.whitecolor));
                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setEnabled(true);
            }
        }
    ...
    private void handledeleteClick() {
        this.binding.deleteFrontImage.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.binding.firstLL.setVisibility(8);
                UncollectableSIRNew.this.binding.lvPage1EnumrationChoose.setVisibility(0);
                UncollectableSIRNew.this.binding.enumerationFormLayout.setVisibility(0);
                UncollectableSIRNew.this.relativeDocument1UrlS = "";
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument1UrlS) && TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument2UrlS)) {
                    UncollectableSIRNew.this.binding.lvPage2EnumrationChoose.setVisibility(0);
                    UncollectableSIRNew.this.binding.fbImageLL.setVisibility(8);
                }
                if (UncollectableSIRNew.this.binding.secondLL.getVisibility() != 8 || TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument2UrlS)) {
                    return;
                }
                UncollectableSIRNew.this.binding.fbImageLL.setVisibility(8);
            }
        });
        this.binding.deleteBackImage.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.11
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.binding.secondLL.setVisibility(8);
                UncollectableSIRNew.this.binding.lvPage2EnumrationChoose.setVisibility(0);
                UncollectableSIRNew.this.relativeDocument2UrlS = "";
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument1UrlS) && TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument2UrlS)) {
                    UncollectableSIRNew.this.binding.lvPage1EnumrationChoose.setVisibility(0);
                    UncollectableSIRNew.this.binding.fbImageLL.setVisibility(8);
                }
                if (UncollectableSIRNew.this.binding.firstLL.getVisibility() == 8 && !TextUtils.isEmpty(UncollectableSIRNew.this.relativeDocument1UrlS)) {
                    UncollectableSIRNew.this.binding.fbImageLL.setVisibility(8);
                }
                UncollectableSIRNew.this.binding.enumerationFormLayout.setVisibility(0);
            }
        });
        this.binding.deleteFrontImage1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.binding.firstLL1.setVisibility(8);
                UncollectableSIRNew.this.binding.lvSupportChoose1.setVisibility(0);
                UncollectableSIRNew.this.binding.supprtingDocumentsLayout.setVisibility(0);
                UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS = "";
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS) && TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS)) {
                    UncollectableSIRNew.this.binding.lvSupportChoose2.setVisibility(0);
                }
            }
        });
        this.binding.deleteBackImage1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.13
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UncollectableSIRNew.this.binding.secondLL1.setVisibility(8);
                UncollectableSIRNew.this.binding.lvSupportChoose2.setVisibility(0);
                UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS = "";
                if (TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage1UrlS) && TextUtils.isEmpty(UncollectableSIRNew.this.relativeSupportingDocumentPage2UrlS)) {
                    UncollectableSIRNew.this.binding.lvSupportChoose1.setVisibility(0);
                }
                UncollectableSIRNew.this.binding.supprtingDocumentsLayout.setVisibility(0);
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$14, reason: invalid class name */
    class AnonymousClass14 implements Callback<JsonObject> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r6v9, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
        /* JADX WARN: Type inference fix 'apply assigned field type' failed
        java.lang.UnsupportedOperationException: ArgType.getObject(), call class: class jadx.core.dex.instructions.args.ArgType$UnknownArg
        	at jadx.core.dex.instructions.args.ArgType.getObject(ArgType.java:596)
        	at jadx.core.dex.attributes.nodes.ClassTypeVarsAttr.getTypeVarsMapFor(ClassTypeVarsAttr.java:35)
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                UncollectableSIRNew.this.preSignedurl1 = ((JsonObject) response.body()).get("preSignedUrl").toString().replace(RegexMatcher.JSON_STRING_REGEX, "");
                if (!this.val$fileref.endsWith(".pdf")) {
                    Glide.with(UncollectableSIRNew.this).load(UncollectableSIRNew.this.preSignedurl1).into(UncollectableSIRNew.this.binding.frontImage);
                }
                if (TextUtils.isEmpty(UncollectableSIRNew.this.preSignedurl1)) {
                    UncollectableSIRNew.this.binding.frontImage.setImageBitmap(BitmapFactory.decodeResource(UncollectableSIRNew.this.getResources(), R.drawable.blo_dummy_image));
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                }
                ...
                try {
                    CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                    ?? r6 = UncollectableSIRNew.this;
                    String str = ((UncollectableSIRNew) r6).refreshToken;
                    final String str2 = this.val$fileref;
                    commomUtility.getRefreshToken(r6, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$14$$ExternalSyntheticLambda1
                        @Override // in.gov.eci.bloapp.aadharcallback
                    ...
                    Logger.e("UncollectableTAG", UncollectableSIRNew.this.comingTag);
                }
            } else {
                try {
                    UncollectableSIRNew.this.runOnUiThread(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$14$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$2();
                        }
                    });
                    Logger.e("UncollectableTAG", new JSONObject(response.errorBody().string()).optString(UncollectableSIRNew.this.messageString));
                } catch (IOException | JSONException e) {
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r5 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$14$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
                ...
                UncollectableSIRNew.this.token = "Bearer " + str2;
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setRefreshToken(str3);
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setToken("Bearer " + str2);
                UncollectableSIRNew.this.getFile1(str);
            }
        }
        ...
        public void onFailure(Call<JsonObject> call, Throwable t) {
            Logger.e("UncollectableTAG", UncollectableSIRNew.this.comingTag + t.getMessage());
            if (UncollectableSIRNew.this.alertDialog != null) {
                UncollectableSIRNew.this.alertDialog.dismiss();
            }
            UncollectableSIRNew uncollectableSIRNew = UncollectableSIRNew.this;
            uncollectableSIRNew.showDialog1(uncollectableSIRNew.getString(R.string.alertMsg), Constants.somethingWentWrong);
        }
    }
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$15, reason: invalid class name */
    class AnonymousClass15 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                UncollectableSIRNew.this.preSignedurl2 = ((JsonObject) response.body()).get("preSignedUrl").toString().replace(RegexMatcher.JSON_STRING_REGEX, "");
                if (!this.val$fileref.endsWith(".pdf")) {
                    Glide.with(UncollectableSIRNew.this).load(UncollectableSIRNew.this.preSignedurl2).into(UncollectableSIRNew.this.binding.backImage);
                }
                if (TextUtils.isEmpty(UncollectableSIRNew.this.preSignedurl2)) {
                    UncollectableSIRNew.this.binding.backImage.setImageBitmap(BitmapFactory.decodeResource(UncollectableSIRNew.this.getResources(), R.drawable.blo_dummy_image));
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                }
                ...
                try {
                    ...
                    String str = ((UncollectableSIRNew) r6).refreshToken;
                    final String str2 = this.val$fileref;
                    commomUtility.getRefreshToken(r6, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$15$$ExternalSyntheticLambda1
                        @Override // in.gov.eci.bloapp.aadharcallback
                        public final void onCallBack(int i, String str3, String str4) {
                            this.f$0.lambda$onResponse$1(str2, i, str3, str4);
                        }
                ...
                try {
                    UncollectableSIRNew.this.runOnUiThread(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$15$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$2();
                        }
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r5 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$15$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
                ...
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setRefreshToken(str3);
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setToken("Bearer " + str2);
                UncollectableSIRNew.this.getFile2(str);
            }
        }
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$16, reason: invalid class name */
    class AnonymousClass16 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                UncollectableSIRNew.this.preSignedurl3 = ((JsonObject) response.body()).get("preSignedUrl").toString().replace(RegexMatcher.JSON_STRING_REGEX, "");
                if (!this.val$fileref.endsWith(".pdf")) {
                    Glide.with(UncollectableSIRNew.this).load(UncollectableSIRNew.this.preSignedurl3).into(UncollectableSIRNew.this.binding.frontImage1);
                }
                if (TextUtils.isEmpty(UncollectableSIRNew.this.preSignedurl3)) {
                    UncollectableSIRNew.this.binding.frontImage1.setImageBitmap(BitmapFactory.decodeResource(UncollectableSIRNew.this.getResources(), R.drawable.blo_dummy_image));
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                }
                ...
                try {
                    ...
                    String str = ((UncollectableSIRNew) r6).refreshToken;
                    final String str2 = this.val$fileref;
                    commomUtility.getRefreshToken(r6, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$16$$ExternalSyntheticLambda1
                        @Override // in.gov.eci.bloapp.aadharcallback
                        public final void onCallBack(int i, String str3, String str4) {
                            this.f$0.lambda$onResponse$1(str2, i, str3, str4);
                        }
                ...
                try {
                    UncollectableSIRNew.this.runOnUiThread(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$16$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$2();
                        }
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r5 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$16$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
                ...
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setRefreshToken(str3);
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setToken("Bearer " + str2);
                UncollectableSIRNew.this.getFile3(str);
            }
        }
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$17, reason: invalid class name */
    class AnonymousClass17 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                UncollectableSIRNew.this.preSignedurl4 = ((JsonObject) response.body()).get("preSignedUrl").toString().replace(RegexMatcher.JSON_STRING_REGEX, "");
                if (!this.val$fileref.endsWith(".pdf")) {
                    Glide.with(UncollectableSIRNew.this).load(UncollectableSIRNew.this.preSignedurl4).into(UncollectableSIRNew.this.binding.backImage1);
                }
                if (TextUtils.isEmpty(UncollectableSIRNew.this.preSignedurl4)) {
                    UncollectableSIRNew.this.binding.backImage1.setImageBitmap(BitmapFactory.decodeResource(UncollectableSIRNew.this.getResources(), R.drawable.blo_dummy_image));
                    if (UncollectableSIRNew.this.alertDialog != null) {
                        UncollectableSIRNew.this.alertDialog.dismiss();
                    }
                }
                ...
                try {
                    ...
                    String str = ((UncollectableSIRNew) r6).refreshToken;
                    final String str2 = this.val$fileref;
                    commomUtility.getRefreshToken(r6, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$17$$ExternalSyntheticLambda1
                        @Override // in.gov.eci.bloapp.aadharcallback
                        public final void onCallBack(int i, String str3, String str4) {
                            this.f$0.lambda$onResponse$1(str2, i, str3, str4);
                        }
                ...
                try {
                    UncollectableSIRNew.this.runOnUiThread(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$17$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$2();
                        }
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            if (i == 401 || i == 400) {
                CommomUtility commomUtility = UncollectableSIRNew.this.commomUtility;
                ?? r5 = UncollectableSIRNew.this;
                commomUtility.showMessageOK(r5, r5.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$17$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
                ...
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setRefreshToken(str3);
                SharedPref.getInstance(UncollectableSIRNew.this.getApplicationContext()).setToken("Bearer " + str2);
                UncollectableSIRNew.this.getFile4(str);
            }
        }
    ...
    private void showImageDialog(String preSignedUrlP, String name) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
    ...
    public void displayFile(final String fileref, final String uploadType) {
        ((UserClient) ApiClient.getClient1(this).create(UserClient.class)).getFileforSIRPN(this.objectStorageString, fileref, this.token, this.atkband, this.rtkband, "BLOAPP", "blo", "BLOAPP", "ANDROIDMOB").enqueue(new Callback<JsonObject>() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.18
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.code() == 200) {
                    final String strReplace = ((JsonObject) response.body()).get("preSignedUrl").toString().replace(RegexMatcher.JSON_STRING_REGEX, "");
                    if (uploadType.equals(UncollectableSIRNew.this.photo1strNew)) {
                        UncollectableSIRNew.this.checkImageFromURL(strReplace, new DownloadCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.18.1
                            @Override // in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.DownloadCallback
                            public void onSuccess(File pdfFile) {
                                if (UncollectableSIRNew.this.alertDialog != null) {
                                    UncollectableSIRNew.this.alertDialog.dismiss();
                                }
                                UncollectableSIRNew.this.binding.enumerationFormPage1.setVisibility(0);
                                UncollectableSIRNew.this.binding.cancelEnumerationFormPage1Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage1ImageName.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage1ImageSize.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage1Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.greycolor));
                                UncollectableSIRNew.this.binding.uploadEnumerationFormPage1.setEnabled(false);
                                Glide.with(UncollectableSIRNew.this).load(strReplace).into(UncollectableSIRNew.this.binding.enumerationFormPage1Image);
                            }
                            ...
                            public void onError(String message, Throwable cause) {
                                ...
                                UncollectableSIRNew.this.resetImage(uploadType, message);
                            }
                        });
                    }
                    if (uploadType.equals(UncollectableSIRNew.this.photo2strNew)) {
                        UncollectableSIRNew.this.checkImageFromURL(strReplace, new DownloadCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.18.2
                            @Override // in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.DownloadCallback
                            public void onSuccess(File pdfFile) {
                                if (UncollectableSIRNew.this.alertDialog != null) {
                                    UncollectableSIRNew.this.alertDialog.dismiss();
                                }
                                UncollectableSIRNew.this.binding.enumerationFormPage2.setVisibility(0);
                                UncollectableSIRNew.this.binding.cancelEnumerationFormPage2Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage2ImageName.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage2ImageSize.setVisibility(0);
                                UncollectableSIRNew.this.binding.enumerationFormPage2Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.greycolor));
                                UncollectableSIRNew.this.binding.uploadEnumerationFormPage2.setEnabled(false);
                                Glide.with(UncollectableSIRNew.this).load(strReplace).into(UncollectableSIRNew.this.binding.enumerationFormPage2Image);
                            }
                    ...
                    if (uploadType.equals(UncollectableSIRNew.this.photo3strNew)) {
                        UncollectableSIRNew.this.checkImageFromURL(strReplace, new DownloadCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.18.3
                            @Override // in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.DownloadCallback
                            public void onSuccess(File pdfFile) {
                                if (UncollectableSIRNew.this.alertDialog != null) {
                                    UncollectableSIRNew.this.alertDialog.dismiss();
                                }
                                UncollectableSIRNew.this.binding.supportingDocumentsPage1.setVisibility(0);
                                UncollectableSIRNew.this.binding.cancelSupportingDocumentsPage1Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage1ImageName.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage1ImageSize.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage1Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage1.setTextColor(Color.parseColor(UncollectableSIRNew.this.greycolor));
                                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage1.setEnabled(false);
                                Glide.with(UncollectableSIRNew.this).load(strReplace).into(UncollectableSIRNew.this.binding.supportingDocumentsPage1Image);
                            }
                    ...
                    if (uploadType.equalsIgnoreCase(UncollectableSIRNew.this.photo4strNew)) {
                        UncollectableSIRNew.this.checkImageFromURL(strReplace, new DownloadCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.18.4
                            @Override // in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.DownloadCallback
                            public void onSuccess(File pdfFile) {
                                if (UncollectableSIRNew.this.alertDialog != null) {
                                    UncollectableSIRNew.this.alertDialog.dismiss();
                                }
                                UncollectableSIRNew.this.binding.supportingDocumentsPage2.setVisibility(0);
                                UncollectableSIRNew.this.binding.cancelSupportingDocumentsPage2Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage2ImageName.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage2ImageSize.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage2Image.setVisibility(0);
                                UncollectableSIRNew.this.binding.supportingDocumentsPage2Image.setImageBitmap(BitmapFactory.decodeByteArray(UncollectableSIRNew.this.pdfbyteArray, 0, UncollectableSIRNew.this.pdfbyteArray.length));
                                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage2.setTextColor(Color.parseColor(UncollectableSIRNew.this.greycolor));
                                UncollectableSIRNew.this.binding.uploadSupportingDocumentsPage2.setEnabled(false);
                                Glide.with(UncollectableSIRNew.this).load(strReplace).into(UncollectableSIRNew.this.binding.supportingDocumentsPage2Image);
                            }
                ...
                if (response.code() == 401) {
                    ...
                    UncollectableSIRNew.this.resetImage(uploadType, Constants.somethingWentWrong);
                    return;
                }
                try {
                    String strOptString = new JSONObject(response.errorBody().string()).optString(UncollectableSIRNew.this.messageString);
                    Logger.e("UncollectableTAG", strOptString);
                    UncollectableSIRNew.this.retryAPI(fileref, uploadType, strOptString);
                } catch (Exception e) {
                    Logger.e("UncollectableTAG", e.getMessage());
                    UncollectableSIRNew.this.retryAPI(fileref, uploadType, Constants.somethingWentWrong);
                }
            }
    ...
    public void uploadImageons3(String presignedurl, String flename, final String uploadtype, final String filereference) {
        new UploadCaller().uploadFileInBackground(this, presignedurl, new File(flename), new ValidationEFCallback() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.19
            ...
            public void onResult(boolean isValidate, String error) {
                if (!isValidate) {
                    ...
                    UncollectableSIRNew.this.resetImage(uploadtype, error);
                    return;
                }
                new Handler().postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew.19.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (uploadtype.equals(UncollectableSIRNew.this.photo1strNew)) {
                            UncollectableSIRNew.this.displayFile(filereference, uploadtype);
                        }
                        if (uploadtype.equals(UncollectableSIRNew.this.photo2strNew)) {
                            UncollectableSIRNew.this.displayFile(filereference, uploadtype);
                        }
                        ...
                        if (uploadtype.equals(UncollectableSIRNew.this.photo4strNew)) {
                            UncollectableSIRNew.this.displayFile(filereference, uploadtype);
                        }
                    }
                }, 1000L);
    ...
    public void checkImageFromURL(final String preSignedUrl, final DownloadCallback callback) {
        Executors.newSingleThreadExecutor().execute(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
    ...
    /* JADX WARN: Type inference failed for: r8v0, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew] */
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda4
                                @Override // java.lang.Runnable
                                public final void run() {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectableSIRNew$$ExternalSyntheticLambda5
                            @Override // java.lang.Runnable
                            public final void run() {
                                UncollectableSIRNew.DownloadCallback downloadCallback2 = downloadCallback;
                                Exception exc = e;
