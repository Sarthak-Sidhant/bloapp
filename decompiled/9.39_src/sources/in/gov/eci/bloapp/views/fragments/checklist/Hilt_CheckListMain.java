...
abstract class Hilt_CheckListMain extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_CheckListMain(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CheckListMain_GeneratedInjector) generatedComponent()).injectCheckListMain((CheckListMain) UnsafeCasts.unsafeCast(this));
    }
