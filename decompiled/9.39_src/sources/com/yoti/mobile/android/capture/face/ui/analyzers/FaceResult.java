...
public final /* data */ class FaceResult {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.boundingBox, faceResult.boundingBox) && this.eyesClosed == faceResult.eyesClosed && this.invalidAngle == faceResult.invalidAngle && Intrinsics.areEqual(this.facialLandmarks, faceResult.facialLandmarks) && Intrinsics.areEqual(this.smileScore, faceResult.smileScore);
    }
    ...
    public FaceResult(Rect rect, boolean z, boolean z2, FacialLandmarks facialLandmarks, Float f) {
        Intrinsics.checkNotNullParameter(rect, "boundingBox");
        Intrinsics.checkNotNullParameter(facialLandmarks, "facialLandmarks");
