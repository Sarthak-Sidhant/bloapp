...
public class BZip2CompressorOutputStream extends CompressorOutputStream implements BZip2Constants {
    ...
    private static void hbMakeCodeLengths(byte[] bArr, int[] iArr, Data data, int i, int i2) {
        ...
        while (z) {
            ...
            while (i7 > 1) {
                ...
                int i33 = i30 & KotlinVersion.MAX_COMPONENT_VALUE;
                int i34 = i31 & KotlinVersion.MAX_COMPONENT_VALUE;
                if (i33 <= i34) {
                    i33 = i34;
                }
                iArr3[i13] = i32 | (i33 + 1);
    ...
    private void write0(int i) throws IOException {
        int i2 = this.currentChar;
        if (i2 == -1) {
            this.currentChar = i & KotlinVersion.MAX_COMPONENT_VALUE;
            this.runLength++;
            return;
        }
    ...
    private static void hbAssignCodes(int[] iArr, byte[] bArr, int i, int i2, int i3) {
        ...
        while (i <= i2) {
            for (int i5 = 0; i5 < i3; i5++) {
                if ((bArr[i5] & KotlinVersion.MAX_COMPONENT_VALUE) == i) {
                    iArr[i5] = i4;
                    i4++;
                }
            }
    ...
    private void bsPutInt(int i) throws IOException {
        bsW(8, (i >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
        bsW(8, (i >> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
        bsW(8, (i >> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
        bsW(8, i & KotlinVersion.MAX_COMPONENT_VALUE);
    }
    ...
    private void sendMTFValues() throws IOException {
        ...
        sendMTFValues0(i, i2);
        int iSendMTFValues1 = sendMTFValues1(i, i2);
        sendMTFValues2(i, iSendMTFValues1);
        sendMTFValues3(i, i2);
        sendMTFValues4();
        sendMTFValues5(i, iSendMTFValues1);
        sendMTFValues6(i, i2);
        sendMTFValues7();
    }
            ...
            while (i11 < bZip2CompressorOutputStream.nMTF) {
                ...
                if (i == 6) {
                    ...
                    while (i13 <= iMin) {
                        char c = cArr[i13];
                        int i14 = i6;
                        short s7 = (short) (s + (bArr4[c] & UByte.MAX_VALUE));
                        byte[] bArr10 = bArr4;
                        short s8 = (short) (s2 + (bArr5[c] & UByte.MAX_VALUE));
                        short s9 = (short) (s3 + (bArr6[c] & UByte.MAX_VALUE));
                        short s10 = (short) (s4 + (bArr7[c] & UByte.MAX_VALUE));
                        short s11 = (short) (s5 + (bArr8[c] & UByte.MAX_VALUE));
                        i13++;
    ...
    private void sendMTFValues6(int i, int i2) throws IOException {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            byte[] bArr2 = bArr[i5];
            int i6 = bArr2[0] & UByte.MAX_VALUE;
            while (i3 >= 8) {
                outputStream.write(i4 >> 24);
                i4 <<= 8;
                i3 -= 8;
    ...
    private void sendMTFValues7() throws IOException {
        ...
        while (i4 < i) {
            ...
            while (i4 <= iMin) {
                ...
                int i7 = bArr3[c] & UByte.MAX_VALUE;
                i3 |= iArr2[c] << ((32 - i2) - i7);
                i2 += i7;
                i4++;
            }
    ...
    private void generateMTFValues() {
        ...
        for (int i8 = 0; i8 <= i; i8++) {
            byte b = bArr2[bArr[iArr[i8]] & UByte.MAX_VALUE];
            byte b2 = bArr3[0];
            int i9 = 0;
            while (b != b2) {
                i9++;
