...
public final class UnsignedKt {
    ...
    public static final int m5617uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m5360constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m5616uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m5360constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m5618ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m5439constructorimpl(0L) : ULong.m5439constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m5439constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m5439constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m5439constructorimpl(j - (j3 * j2)), ULong.m5439constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m5619ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m5439constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m5439constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m5439constructorimpl(j3), ULong.m5439constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m5439constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m5360constructorimpl((int) d);
        }
        return UInt.m5360constructorimpl(UInt.m5360constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m5360constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m5439constructorimpl((long) d);
        }
        return ULong.m5439constructorimpl(ULong.m5439constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
