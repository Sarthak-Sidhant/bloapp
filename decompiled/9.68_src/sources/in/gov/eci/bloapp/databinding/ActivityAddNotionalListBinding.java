...
public final class ActivityAddNotionalListBinding implements ViewBinding {
    ...
    public static ActivityAddNotionalListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityAddNotionalListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_add_notional_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityAddNotionalListBinding bind(View rootView) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (imageView3 != null) {
                                                        return new ActivityAddNotionalListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                    }
                                                }
                                            }
                                        }
