...
public class VerifyPayload implements Parcelable {
    ...
    protected VerifyPayload(Parcel in2) {
        ...
        this.dseId = in2.readInt();
        this.inProcessForm7 = in2.readInt();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.dseId);
        dest.writeInt(this.inProcessForm7);
    }
    ...
    public int getInProcessForm7() {
        return this.inProcessForm7;
    }

    public void setInProcessForm7(int inProcessForm7) {
        this.inProcessForm7 = inProcessForm7;
    }
}
