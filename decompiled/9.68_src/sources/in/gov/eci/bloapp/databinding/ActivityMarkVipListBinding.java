...
public final class ActivityMarkVipListBinding implements ViewBinding {
    ...
    public static ActivityMarkVipListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityMarkVipListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_mark_vip_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityMarkVipListBinding bind(View rootView) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (imageView3 != null) {
                                                        return new ActivityMarkVipListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                    }
                                                }
                                            }
                                        }
