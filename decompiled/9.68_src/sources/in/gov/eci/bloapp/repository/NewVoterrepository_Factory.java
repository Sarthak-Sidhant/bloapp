...
public final class NewVoterrepository_Factory implements Factory<NewVoterrepository> {
    ...
    public NewVoterrepository get() {
        NewVoterrepository newVoterrepositoryNewInstance = newInstance(this.apiInterfaceProvider.get());
        NewVoterrepository_MembersInjector.injectDbHandler(newVoterrepositoryNewInstance, this.dbHandlerProvider.get());
        NewVoterrepository_MembersInjector.injectEciDatabase(newVoterrepositoryNewInstance, this.eciDatabaseProvider.get());
