...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C01271 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01271(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C01271) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        public static final <T> Flow<T> m6798catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
