...
public final class BloFragmentPendingProfileBinding implements ViewBinding {
    ...
    private BloFragmentPendingProfileBinding(FrameLayout rootView, TextView assembly5, TextView assembly5Value, ImageButton backBtnIv, ImageButton btnAnimation, LinearLayout card1, LinearLayout cardView4, TextView district, TextView districtValue, TextView emailId, TextView firstName, ConstraintLayout homeFragmentTopConstraintLayout, ImageView imageView2, ImageView imageView3, ImageView imageView8, TextView mobileNumber, TextView officeAddress, ScrollView scrollView2, TextView state, TextView stateValue, LinearLayout test6, TextView textView3) {
    ...
    public static BloFragmentPendingProfileBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloFragmentPendingProfileBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_fragment_pending_profile, parent, false);
        if (attachToParent) {
    ...
    public static BloFragmentPendingProfileBinding bind(View rootView) {
                                                                            ...
                                                                            if (textView9 != null) {
                                                                                ...
                                                                                if (textView10 != null) {
                                                                                    ...
                                                                                    if (linearLayout3 != null) {
                                                                                        ...
                                                                                        if (textView11 != null) {
                                                                                            return new BloFragmentPendingProfileBinding((FrameLayout) rootView, textView, textView2, imageButton, imageButton2, linearLayout, linearLayout2, textView3, textView4, textView5, textView6, constraintLayoutFindChildViewById, imageView, imageView2, imageView3, textView7, textView8, scrollView, textView9, textView10, linearLayout3, textView11);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
