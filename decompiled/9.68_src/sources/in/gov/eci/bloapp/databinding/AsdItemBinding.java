...
public final class AsdItemBinding implements ViewBinding {
    ...
    private AsdItemBinding(LinearLayout rootView, TextView acName, TextView address, LinearLayout cardViewLL, TextView categoryTypeLabel, TextView electorName, TextView epic, LinearLayout llDeceased, LinearLayout lvAsd, LinearLayout lvEightfive, TextView partNo, TextView serialNo, TextView state, TextView tvAsd, TextView uncollectablePendingSir, TextView viewDetails) {
    ...
    public static AsdItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AsdItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.asd_item, parent, false);
        if (attachToParent) {
    ...
    public static AsdItemBinding bind(View rootView) {
        int i = R.id.acName;
                            ...
                            if (textView5 != null) {
                                ...
                                if (linearLayout2 != null) {
                                    ...
                                    if (linearLayout3 != null) {
                                        i = R.id.lv_eightfive;
                                        LinearLayout linearLayout4 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.lv_eightfive);
                                                    ...
                                                    if (textView8 != null) {
                                                        ...
                                                        if (textView9 != null) {
                                                            ...
                                                            if (textView10 != null) {
                                                                ...
                                                                if (textView11 != null) {
                                                                    return new AsdItemBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, linearLayout2, linearLayout3, linearLayout4, textView6, textView7, textView8, textView9, textView10, textView11);
                                                                }
                                                            }
                                                        }
                                                    }
