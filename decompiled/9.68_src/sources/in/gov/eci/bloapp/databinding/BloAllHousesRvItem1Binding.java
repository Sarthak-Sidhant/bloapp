...
public final class BloAllHousesRvItem1Binding implements ViewBinding {
    ...
    private BloAllHousesRvItem1Binding(ConstraintLayout rootView, TextView HNoTv, TextView NoOfPeopleTv, TextView SerialNoTv, TextView VerifiedTickTv, TextView VerifiedTv, TextView addprop, TextView apptv, RelativeLayout button, LinearLayout layout, TextView nametv, TextView nationalTv, TextView secn, View view2, TextView viewfamily) {
    ...
    public static BloAllHousesRvItem1Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloAllHousesRvItem1Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_all_houses_rv_item1, parent, false);
        if (attachToParent) {
    ...
    public static BloAllHousesRvItem1Binding bind(View rootView) {
        int i = R.id.H_No_tv;
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            i = R.id.addprop;
                            TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.addprop);
                            if (textView6 != null) {
                                i = R.id.apptv;
                                TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.apptv);
                                if (textView7 != null) {
                                    i = R.id.button;
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (linearLayout != null) {
                                            i = R.id.nametv;
                                            TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.nametv);
                                            if (textView8 != null) {
                                                i = R.id.national_tv;
                                                ...
                                                if (textView9 != null) {
                                                    ...
                                                    if (textView10 != null) {
                                                        ...
                                                        if (viewFindChildViewById != null) {
                                                            i = R.id.viewfamily;
                                                            TextView textView11 = (TextView) ViewBindings.findChildViewById(rootView, R.id.viewfamily);
                                                            if (textView11 != null) {
                                                                return new BloAllHousesRvItem1Binding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, textView5, textView6, textView7, relativeLayout, linearLayout, textView8, textView9, textView10, viewFindChildViewById, textView11);
                                                            }
                                                        }
                                                    }
                                                }
