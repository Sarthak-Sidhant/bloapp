...
public class DSEVerifiedClusterDetailsListAdapter extends RecyclerView.Adapter<holder> {
    ...
    public void onBindViewHolder(holder holder2, int i) {
        ...
        holder2.Serial_No_tv.setText(this.context.getResources().getString(R.string.serial_no) + " " + String.valueOf(this.al.get(i).getSlnoInPart()));
        holder2.epic_no.setText(this.context.getResources().getString(R.string.epic_no) + " " + this.al.get(i).getEpicNo());
