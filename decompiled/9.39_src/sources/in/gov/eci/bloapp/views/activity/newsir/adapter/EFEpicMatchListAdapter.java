...
public class EFEpicMatchListAdapter extends RecyclerView.Adapter<holder> {
    fillEFCallBack callback;
    private Context context;
    ArrayList<EFPayload> datalist;
    ArrayList<EFPayload> searchList;

    public EFEpicMatchListAdapter(ArrayList<EFPayload> datalist, Context context, fillEFCallBack callback) {
    ...
    public void onBindViewHolder(holder viewHolder, int i) {
        ...
        viewHolder.fillEF.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.adapter.EFEpicMatchListAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                EFEpicMatchListAdapter.this.callback.onFillEFClicked(eFPayload, "fill");
            }
        });
        viewHolder.uncollectable.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.adapter.EFEpicMatchListAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onBindViewHolder$0(eFPayload, view);
            }
        });
        viewHolder.call.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.adapter.EFEpicMatchListAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                EFEpicMatchListAdapter.this.callback.onFillEFClicked(eFPayload, "call");
            }
        });
    }
