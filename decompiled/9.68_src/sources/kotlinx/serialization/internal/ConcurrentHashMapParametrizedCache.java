...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo6841getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM5265constructorimpl = Result.m5265constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM5264boximpl);
