...
public final class DeletionObjectionRepository_Factory implements Factory<DeletionObjectionRepository> {
    ...
    public DeletionObjectionRepository m600get() {
        DeletionObjectionRepository deletionObjectionRepositoryNewInstance = newInstance((ApiInterface) this.apiInterfaceProvider.get());
        DeletionObjectionRepository_MembersInjector.injectDbHandler(deletionObjectionRepositoryNewInstance, (DatabaseHelper) this.dbHandlerProvider.get());
        DeletionObjectionRepository_MembersInjector.injectEciDatabase(deletionObjectionRepositoryNewInstance, (EciDatabase) this.eciDatabaseProvider.get());
