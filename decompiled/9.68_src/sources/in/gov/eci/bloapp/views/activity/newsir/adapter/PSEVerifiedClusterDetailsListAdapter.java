...
public class PSEVerifiedClusterDetailsListAdapter extends RecyclerView.Adapter<holder> {
    private String acNo;
    ...
    public PSEVerifiedClusterDetailsListAdapter(List<DSEVerifiedClusterDetailsPayload> al, Context context, ItemClickCallbackPse itemClickCallback) {
        this.al = al;
