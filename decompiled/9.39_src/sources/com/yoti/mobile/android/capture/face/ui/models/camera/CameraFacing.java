...
public final class CameraFacing {
    ...
    static {
        ...
        FRONT = new CameraFacing("FRONT", 0, cameraSelector, 0.0f);
        CameraSelector cameraSelector2 = CameraSelector.DEFAULT_BACK_CAMERA;
        Intrinsics.checkNotNullExpressionValue(cameraSelector2, "DEFAULT_BACK_CAMERA");
        BACK = new CameraFacing("BACK", 1, cameraSelector2, 0.7f);
        $VALUES = $values();
    }
}
