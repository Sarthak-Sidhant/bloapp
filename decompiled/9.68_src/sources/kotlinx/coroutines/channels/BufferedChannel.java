...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo6762receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m6760receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo6758trySendJP2dKIU(E element) {
        ...
        return ChannelResult.INSTANCE.m6782closedJP2dKIU(getSendException());
    }
    ...
    protected final Object m6764trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegment;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM6769boximpl = ChannelResult.m6769boximpl(ChannelResult.INSTANCE.m6784successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM6769boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0014  */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: receiveCatching-JP2dKIU$suspendImpl, reason: not valid java name */
    static /* synthetic */ <E> Object m6760receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof BufferedChannel$receiveCatching$1) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & IntCompanionObject.MIN_VALUE) != 0) {
                bufferedChannel$receiveCatching$1.label -= IntCompanionObject.MIN_VALUE;
            } else {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM6761receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m6761receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$2);
                        return objM6761receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM6761receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m6784successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m6782closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    public final Object m6761receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM6769boximpl;
            ...
            try {
                ...
                if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                    ...
                    if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                        ...
                        while (true) {
                            ...
                            if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                    ...
                                    channelSegment2.cleanPrev();
                                    channelResultM6769boximpl = ChannelResult.m6769boximpl(ChannelResult.INSTANCE.m6784successJP2dKIU(objUpdateCellReceive2));
                                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                                    if (function1 != null) {
                        ...
                        channelSegment.cleanPrev();
                        channelResultM6769boximpl = ChannelResult.m6769boximpl(ChannelResult.INSTANCE.m6784successJP2dKIU(objUpdateCellReceive));
                        Function1<E, Unit> function2 = this.onUndeliveredElement;
                        if (function2 != null) {
                    ...
                    orCreateCancellableContinuation.resume(channelResultM6769boximpl, function1BindCancellationFun);
                    break;
                }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5265constructorimpl(ChannelResult.m6769boximpl(ChannelResult.INSTANCE.m6782closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo6763tryReceivePtdJZtk() {
        ChannelSegment channelSegment;
        long j = receivers$volatile$FU.get(this);
        long j2 = sendersAndCloseStatus$volatile$FU.get(this);
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m6782closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m6769boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m6782closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m6784successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m5265constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    public void mo6827invokeOnClose(Function1<? super Throwable, Unit> handler) {
    ...
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM6805constructorimpl$default = InlineList.m6805constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM6805constructorimpl$default = InlineList.m6810plusFjFbRPM(objM6805constructorimpl$default, waiter);
        ...
        if (objM6805constructorimpl$default != null) {
            if (!(objM6805constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM6805constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM6805constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) objM6805constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM6805constructorimpl$default = InlineList.m6810plusFjFbRPM(objM6805constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM6805constructorimpl$default = InlineList.m6810plusFjFbRPM(objM6805constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM6805constructorimpl$default != null) {
            if (!(objM6805constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM6805constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM6805constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) objM6805constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m5265constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m5265constructorimpl(ChannelResult.m6769boximpl(ChannelResult.INSTANCE.m6782closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m6822isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM6820getSegmentimpl = SegmentOrClosed.m6820getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM6820getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM6820getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$.ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM6820getSegmentimpl)) {
                    ...
                    if (segmentM6820getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM6820getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m6820getSegmentimpl(objFindSegmentInternal);
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        Object objM5265constructorimpl;
        Object result;
        ...
        try {
            ...
            if (iUpdateCellSend == 0) {
                ...
                Result.Companion companion = Result.INSTANCE;
                objM5265constructorimpl = Result.m5265constructorimpl(Unit.INSTANCE);
            } else {
                if (iUpdateCellSend != 1) {
                    if (iUpdateCellSend != 2) {
                        if (iUpdateCellSend == 4) {
            ...
            cancellableContinuationImpl.resumeWith(objM5265constructorimpl);
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
            }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m5265constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            Result.Companion companion3 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m5265constructorimpl(Boxing.boxBoolean(true)));
            break;
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
