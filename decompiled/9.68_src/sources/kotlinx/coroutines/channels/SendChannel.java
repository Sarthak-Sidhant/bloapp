...
public interface SendChannel<E> {
    ...
    void mo6827invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo6758trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m6779isSuccessimpl(objMo6758trySendJP2dKIU)) {
                return true;
            }
            Throwable thM6773exceptionOrNullimpl = ChannelResult.m6773exceptionOrNullimpl(objMo6758trySendJP2dKIU);
