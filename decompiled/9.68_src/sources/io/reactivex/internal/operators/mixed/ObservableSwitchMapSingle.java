...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        void innerError(SwitchMapSingleObserver<R> switchMapSingleObserver, Throwable th) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapSingleObserver, (Object) null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z2 && switchMapSingleObserver.item != null) {
                    PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(atomicReference, switchMapSingleObserver, (Object) null);
