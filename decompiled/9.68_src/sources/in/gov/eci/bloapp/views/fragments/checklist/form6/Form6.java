...
import in.gov.eci.bloapp.utils.PdfLoader;
...
public class Form6 extends Hilt_Form6 implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    Date DoB;
    private JsonObject additionalDocpayloadData1;
    ...
    String addDocumentcode = "";
    String addDocumentName = "";
    boolean isUserAddDocClicked = false;
    ...
    int addDocumentpos = 0;
    ArrayList<String> addDocName = new ArrayList<>();
    ArrayList<String> addDocCode = new ArrayList<>();
    String addDocUrl = "";
    String addphoto = "Add Photo!";
    ActivityResultLauncher<Intent> activityResultLauncher481 = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.65
        /* JADX WARN: Code duplicated, block: B:33:0x0092 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:35:0x00b0 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:36:0x0148 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:38:0x0163 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:39:0x017b A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:41:0x0204 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        public void onActivityResult(ActivityResult result) throws Throwable {
            ...
            try {
                inputStreamOpenInputStream = Form6.this.getContext().getContentResolver().openInputStream(data);
                try {
                    bArr = new byte[1024];
            ...
            try {
                while (true) {
                    try {
                        ...
                        Form6.this.pdfbyteArray = byteArrayOutputStream.toByteArray();
                        saveImagePath = Form6.this.getSaveImagePath(Base64.encodeToString(Form6.this.pdfbyteArray, 0), ".pdf");
                        cursorQuery = Form6.this.getContext().getContentResolver().query(saveImagePath, null, null, null, null);
                        if (cursorQuery.getCount() > 0) {
                            cursorQuery.close();
                            throw new IllegalArgumentException(Form6.this.imgmsg);
                        }
                        cursorQuery.moveToFirst();
                        strArrSplit = saveImagePath.getPath().split("/");
                        if (Form6.this.filesize < 1024) {
                            double dRound2 = Math.round(Form6.this.filesize * 100.0d) / 100.0d;
                            cursorQuery.close();
                            Form6.this.alertDialog.show();
                            Form6 form6 = Form6.this;
                            form6.uploadPhoto(form6.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page2");
                            Form6.this.binding.uploadDoc2Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                            Form6.this.binding.uploadDoc2Certi.setVisibility(0);
                            Form6.this.binding.uploadDoc2ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                            Form6.this.binding.uploadDoc2Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                            Form6.this.binding.uploadDoc2Size.setText(dRound2 + "KB");
                        } else {
                            dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                            cursorQuery.close();
                            if (dRound > 3.0d) {
                                Form6.this.binding.addDocCerti.setVisibility(8);
                                Form6 form7 = Form6.this;
                                form7.showdialog("ALERT", form7.pdf3);
                            } else {
                                Form6.this.alertDialog.show();
                                Form6 form8 = Form6.this;
                                form8.uploadPhoto(form8.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page2");
                                Form6.this.binding.uploadDoc2Certi.setVisibility(0);
                                Form6.this.binding.uploadDoc2Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                                Form6.this.binding.uploadDoc2ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                                Form6.this.binding.uploadDoc2Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                                Form6.this.binding.uploadDoc2Size.setText(dRound + "MB");
                            }
                        }
                        cursorQuery.close();
                        return;
                ...
                strArrSplit = saveImagePath.getPath().split("/");
                if (Form6.this.filesize < 1024) {
                    double dRound3 = Math.round(Form6.this.filesize * 100.0d) / 100.0d;
                    cursorQuery.close();
                    Form6.this.alertDialog.show();
                    Form6 form9 = Form6.this;
                    form9.uploadPhoto(form9.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page2");
                    Form6.this.binding.uploadDoc2Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                    Form6.this.binding.uploadDoc2Certi.setVisibility(0);
                    Form6.this.binding.uploadDoc2ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                    Form6.this.binding.uploadDoc2Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                    Form6.this.binding.uploadDoc2Size.setText(dRound3 + "KB");
                } else {
                    dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                    cursorQuery.close();
                    if (dRound > 3.0d) {
                        ...
                        form10.showdialog("ALERT", form10.pdf3);
                    } else {
                        Form6.this.alertDialog.show();
                        Form6 form11 = Form6.this;
                        form11.uploadPhoto(form11.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page2");
                        Form6.this.binding.uploadDoc2Certi.setVisibility(0);
                        Form6.this.binding.uploadDoc2Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                        Form6.this.binding.uploadDoc2ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                        Form6.this.binding.uploadDoc2Photoname.setText(strArrSplit[strArrSplit.length - 1]);
    ...
    ActivityResultLauncher<Intent> activityResultLauncher480 = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.66
        /* JADX WARN: Code duplicated, block: B:33:0x0092 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:35:0x00b0 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:36:0x0148 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:38:0x0163 A[Catch: Exception -> 0x0211, TryCatch #5 {Exception -> 0x0211, blocks: (B:31:0x0067, B:33:0x0092, B:35:0x00b0, B:40:0x0200, B:36:0x0148, B:38:0x0163, B:39:0x017b, B:41:0x0204, B:42:0x0210), top: B:56:0x0067 }] */
        ...
        public void onActivityResult(ActivityResult result) throws Throwable {
            ...
            try {
                while (true) {
                    try {
                        ...
                        if (Form6.this.filesize < 1024) {
                            ...
                            Form6.this.alertDialog.show();
                            Form6 form6 = Form6.this;
                            form6.uploadPhoto(form6.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page1");
                            Form6.this.binding.uploadDoc1Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                            Form6.this.binding.uploadDoc1Certi.setVisibility(0);
                            Form6.this.binding.uploadDoc1ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                            Form6.this.binding.uploadDoc1Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                            Form6.this.binding.uploadDoc1Size.setText(dRound2 + "KB");
                        } else {
                            dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                            cursorQuery.close();
                            if (dRound > 3.0d) {
                                ...
                                Form6.this.alertDialog.show();
                                Form6 form8 = Form6.this;
                                form8.uploadPhoto(form8.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page1");
                                Form6.this.binding.uploadDoc1Certi.setVisibility(0);
                                Form6.this.binding.uploadDoc1Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                                Form6.this.binding.uploadDoc1ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                                Form6.this.binding.uploadDoc1Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                                Form6.this.binding.uploadDoc1Size.setText(dRound + "MB");
                            }
                        }
                        cursorQuery.close();
                        return;
                ...
                if (Form6.this.filesize < 1024) {
                    ...
                    Form6.this.alertDialog.show();
                    Form6 form9 = Form6.this;
                    form9.uploadPhoto(form9.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page1");
                    Form6.this.binding.uploadDoc1Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                    Form6.this.binding.uploadDoc1Certi.setVisibility(0);
                    Form6.this.binding.uploadDoc1ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                    Form6.this.binding.uploadDoc1Photoname.setText(strArrSplit[strArrSplit.length - 1]);
                    Form6.this.binding.uploadDoc1Size.setText(dRound3 + "KB");
                } else {
                    dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                    cursorQuery.close();
                    if (dRound > 3.0d) {
                        ...
                        Form6.this.alertDialog.show();
                        Form6 form11 = Form6.this;
                        form11.uploadPhoto(form11.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "UploadForm6Page1");
                        Form6.this.binding.uploadDoc1Certi.setVisibility(0);
                        Form6.this.binding.uploadDoc1Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                        Form6.this.binding.uploadDoc1ChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                        Form6.this.binding.uploadDoc1Photoname.setText(strArrSplit[strArrSplit.length - 1]);
    ...
    String additionalDocumentEncoded = null;
    ActivityResultLauncher<Intent> activityResultLauncher470 = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.67
        /* JADX WARN: Code duplicated, block: B:33:0x0096 A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:35:0x00b4 A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:36:0x014c A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:38:0x0167 A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:39:0x017f A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        /* JADX WARN: Code duplicated, block: B:41:0x0208 A[Catch: Exception -> 0x0215, TryCatch #3 {Exception -> 0x0215, blocks: (B:31:0x0067, B:33:0x0096, B:35:0x00b4, B:40:0x0204, B:36:0x014c, B:38:0x0167, B:39:0x017f, B:41:0x0208, B:42:0x0214), top: B:52:0x0067 }] */
        public void onActivityResult(ActivityResult result) throws Throwable {
            ByteArrayOutputStream byteArrayOutputStream;
            Uri saveImagePath;
            Cursor cursorQuery;
            ...
            try {
                try {
                    InputStream inputStreamOpenInputStream = Form6.this.getContext().getContentResolver().openInputStream(data);
                    try {
                        ...
                        while (true) {
                            try {
                                ...
                                Form6.this.pdfbyteArray = byteArrayOutputStream.toByteArray();
                                String strEncodeToString = Base64.encodeToString(Form6.this.pdfbyteArray, 0);
                                Form6.this.additionalDocumentEncoded = strEncodeToString;
                                saveImagePath = Form6.this.getSaveImagePath(strEncodeToString, ".pdf");
                                cursorQuery = Form6.this.getContext().getContentResolver().query(saveImagePath, null, null, null, null);
                                if (cursorQuery.getCount() > 0) {
                                    cursorQuery.close();
                                    throw new IllegalArgumentException(Form6.this.imgmsg);
                                ...
                                if (Form6.this.filesize < 1024) {
                                    ...
                                    Form6.this.alertDialog.show();
                                    Form6 form6 = Form6.this;
                                    form6.uploadPhoto(form6.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "AddDoc");
                                    Form6.this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
                                    Form6.this.binding.addDocCerti.setVisibility(0);
                                    Form6.this.binding.addDocChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                                    Form6.this.binding.addDocPhotoname.setText(strArrSplit[strArrSplit.length - 1]);
                                    Form6.this.binding.addDocSize.setText(dRound2 + "KB");
                                } else {
                                    dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                                    cursorQuery.close();
                                    if (dRound > 3.0d) {
                                        ...
                                        Form6.this.alertDialog.show();
                                        Form6 form8 = Form6.this;
                                        form8.uploadPhoto(form8.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "AddDoc");
                                        Form6.this.binding.addDocCerti.setVisibility(0);
                                        Form6.this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
                                        Form6.this.binding.addDocChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                                        Form6.this.binding.addDocPhotoname.setText(strArrSplit[strArrSplit.length - 1]);
                                        Form6.this.binding.addDocSize.setText(dRound + "MB");
                                    }
                                }
                                cursorQuery.close();
                                return;
                ...
                String strEncodeToString2 = Base64.encodeToString(Form6.this.pdfbyteArray, 0);
                Form6.this.additionalDocumentEncoded = strEncodeToString2;
                saveImagePath = Form6.this.getSaveImagePath(strEncodeToString2, ".pdf");
                cursorQuery = Form6.this.getContext().getContentResolver().query(saveImagePath, null, null, null, null);
                if (cursorQuery.getCount() > 0) {
                    cursorQuery.close();
                    throw new IllegalArgumentException(Form6.this.imgmsg);
                ...
                if (Form6.this.filesize < 1024) {
                    ...
                    Form6.this.alertDialog.show();
                    Form6 form9 = Form6.this;
                    form9.uploadPhoto(form9.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "AddDoc");
                    Form6.this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
                    Form6.this.binding.addDocCerti.setVisibility(0);
                    Form6.this.binding.addDocChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                    Form6.this.binding.addDocPhotoname.setText(strArrSplit[strArrSplit.length - 1]);
                    Form6.this.binding.addDocSize.setText(dRound3 + "KB");
                } else {
                    dRound = Math.round(((double) (Form6.this.filesize / 1024.0f)) * 100.0d) / 100.0d;
                    cursorQuery.close();
                    if (dRound > 3.0d) {
                        ...
                        Form6.this.alertDialog.show();
                        Form6 form11 = Form6.this;
                        form11.uploadPhoto(form11.stateCode, Form6.this.asmblyNO, Form6.this.partNo, Form6.this.filepathimg, Form6.this.saveImageFileName, Form6.this.token, Form6.this.referenceNo, "AddDoc");
                        Form6.this.binding.addDocCerti.setVisibility(0);
                        Form6.this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
                        Form6.this.binding.addDocChooseFile.setTextColor(Color.parseColor(Form6.this.greycolor));
                        Form6.this.binding.addDocPhotoname.setText(strArrSplit[strArrSplit.length - 1]);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.binding.noRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda67
        ...
        if (this.selectedButton.trim().equals("Save")) {
            ...
            try {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda79
            ...
            try {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda91
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (this.formProcessingId == 0) {
                this.commomUtility.showMessageWithTitleOK(requireContext(), this.form6Error, "Form Processing Id can't be zero", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda103
                ...
                this.commomUtility.showMessageWithTitleOK(requireContext(), this.form6Error, "Form Master Id can't be zero", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda106
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                this.commomUtility.showMessageWithTitleOK(requireContext(), this.form6Error, "Form Current Status Id can't be zero", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda107
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        this.binding.annexureDIncludedLayout.imageList6.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda108
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$6(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageBefore2004Self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda109
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$7(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageAfter2004self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$8(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageList2.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$9(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageList3.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda68
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$10(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageList7.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda69
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$11(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageList1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda70
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$12(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageSign.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda71
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$13(view);
            }
        });
        this.binding.annexureDIncludedLayout.imageList4.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda72
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.binding.annexureDIncludedLayout.parentYesRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda73
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$15(view);
            }
        });
        this.binding.annexureDIncludedLayout.parentNoRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda74
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$16(view);
            }
        });
        this.binding.annexureDIncludedLayout.parentFatherRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda75
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$17(view);
            }
        });
        this.binding.annexureDIncludedLayout.parentMotherRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda76
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.binding.annexureDIncludedLayout.chooseFileAfter2004Self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda78
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$19(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileBefore1987.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda80
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$20(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileBefore2004Self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda81
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$21(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileBefore2004Father.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda82
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$22(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileAfter2004Father.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda83
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$23(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileAfter2004Mother.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda84
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$24(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileAfter2004NotIndian.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda85
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$25(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileBornOutOfIndia.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda86
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$26(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileAcquired.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda87
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$27(view);
            }
        });
        this.binding.annexureDIncludedLayout.betweenParentFatherRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda89
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$28(view);
            }
        });
        this.binding.annexureDIncludedLayout.betweenParentMotherRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda90
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$29(view);
            }
        });
        this.binding.annexureDIncludedLayout.parentYesRb.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda92
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$30(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList1.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda93
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$31(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelBefore2004Self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda94
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$32(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList2.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda95
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$33(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelAfter2004self.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda96
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$34(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList3.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda97
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$35(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList4.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda98
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$36(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList5.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda100
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$37(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList6.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda101
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$38(view);
            }
        });
        this.binding.annexureDIncludedLayout.cancelList7.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda102
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onCreateView$39(view);
            }
        });
        this.binding.annexureDIncludedLayout.chooseFileSign.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda104
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.binding.checkDseButton.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda105
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.binding.addDocumentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.28
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onNothingSelected(AdapterView<?> adapterView) {
            }
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0) {
                    Form6.this.addDocumentcode = "";
                    Form6.this.addDocumentName = "";
                    Form6.this.addDocumentpos = 0;
                    Form6.this.checkListForm6Model.setAddtionalDocType("");
                    Form6.this.binding.cbNotsubmittedAddDoc.setVisibility(0);
                    return;
                }
                Form6.this.binding.cbNotsubmittedAddDoc.setVisibility(8);
                Form6 form6 = Form6.this;
                form6.addDocumentcode = form6.addDocCode.get(i);
                Form6.this.checkListForm6Model.setAddtionalDocType(Form6.this.addDocumentcode);
                Form6 form7 = Form6.this;
                form7.addDocumentName = form7.addDocName.get(i);
                Form6.this.addDocumentpos = i;
                if (Form6.this.isUserAddDocClicked) {
                    Form6.this.deleteAddDoc();
                }
                Form6.this.isUserAddDocClicked = true;
            }
        });
        this.binding.addDocChooseFile.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.29
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.selectImage4();
            }
        });
        this.binding.uploadDoc1ChooseFile.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.30
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.selectImage5();
            }
        });
        this.binding.uploadDoc2ChooseFile.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.31
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.selectImage6();
            }
        });
        this.binding.addDocDelete.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.32
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.binding.cbNotsubmittedAddDoc.setVisibility(0);
                Form6.this.deleteAddDoc();
        ...
        this.binding.uploadDoc1Delete.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.33
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.deleteuploadDocPage1();
            }
        });
        this.binding.uploadDoc2Delete.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.34
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.deleteuploadDocPage2();
            }
        });
        this.binding.tvAddDocEditTextview.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.35
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.binding.addDocumentSpinner.setEnabled(true);
                Form6.this.binding.addDocChooseFile.setEnabled(true);
                Form6.this.binding.addDocDelete.setVisibility(0);
            }
        });
        this.binding.addDocButton.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.36
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.binding.addDocumentSpinner.setEnabled(true);
                Form6.this.binding.addDocDelete.setVisibility(0);
        ...
        this.binding.tvUploadformDocEditTextview.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.37
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.binding.uploadDoc1Delete.setVisibility(0);
                Form6.this.binding.uploadDoc2Delete.setVisibility(0);
            }
        });
        this.binding.uploadformDocButton.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.38
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Form6.this.binding.uploadDoc1Delete.setVisibility(0);
                Form6.this.binding.uploadDoc2Delete.setVisibility(0);
        ...
        this.binding.addDocPhoto.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.39
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
            }
        });
        this.binding.cbNotsubmittedAddDoc.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.40
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Form6.this.binding.cvDoc.setVisibility(8);
                    Form6.this.checkListForm6Model.setAddtionalDocDln(null);
                    Form6.this.checkListForm6Model.setAddtionalDocType(null);
                    Form6.this.checkListForm6Model.setBloAddDocDeclaration(true);
                    return;
                }
                Form6.this.binding.cvDoc.setVisibility(0);
                Form6.this.binding.addDocumentSpinner.setSelection(0);
                Form6.this.binding.addDocumentSpinner.setEnabled(false);
                Form6.this.binding.addDocChooseFile.setEnabled(false);
                Form6.this.checkListForm6Model.setBloAddDocDeclaration(false);
            }
        });
    ...
    private void callCheckDSE() {
        ...
        String str = this.checkListForm6Model.getFirstName() + StringUtils.SPACE + this.checkListForm6Model.getLastName();
        String str2 = this.checkListForm6Model.getApplicantRelativeName() + StringUtils.SPACE + this.checkListForm6Model.getApplicantRelativeSurname();
        ...
        ((UserClient) ApiClient.getClient(requireContext()).create(UserClient.class)).checkDSEinState(map, map2).enqueue(new Callback<CheckDSESDetailsRoot>() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.41
    ...
    public void getDetailByClusterId(final List<CheckDSEDetailsPayload> verifyPayload) {
        ...
        recyclerViewFindViewById.setAdapter(new CheckDSEDetailsListAdapter(verifyPayload, requireContext(), new CheckDSEDetailsListAdapter.OnItemSelectedListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda58
            @Override // in.gov.eci.bloapp.views.activity.newsir.adapter.CheckDSEDetailsListAdapter.OnItemSelectedListener
            public final void onItemSelected() {
                radioButton2.setEnabled(false);
            }
        }));
        radioButton.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda59
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$getDetailByClusterId$43(verifyPayload, radioButton, radioButton2, dialog, view);
            }
        });
        radioButton2.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda60
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void fetchDataFromForm6Data() {
        ...
        this.commomUtility.getRetrofitClient(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd()).getForm6Data(this.referenceNo, "blo", this.stateCode, "ANDROIDMOB").enqueue(new AnonymousClass42());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42, reason: invalid class name */
    class AnonymousClass42 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() != 200 || Form6.this.formProcessingId == 0 || Form6.this.processMasterId == 0 || Form6.this.currentStatusId == 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
                }, 2000L);
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            try {
                ...
                if (Utils.isValideSIRState(Form6.this.stateCode) || Utils.isValide19SIRState(Form6.this.stateCode)) {
                    Form6.this.setDeclarationUI();
        ...
        /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1, reason: invalid class name */
        class AnonymousClass1 implements Callback<JSONArray> {
            ...
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                if (response.code() == 200) {
                    ...
                    this.val$userClient.getaddproof(Form6.this.token, SharedPref.getInstance(Form6.this.requireContext()).getAtknBnd(), SharedPref.getInstance(Form6.this.requireContext()).getRtknBnd(), Form6.this.channelidobo, "blo", "ANDROIDMOB").enqueue(new C00501());
                    return;
                }
                if (response.code() == 401) {
                    Form6.this.refreshTokenApi();
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
                }, 2000L);
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Relation Type List - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnClickListener
            ...
            /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1, reason: invalid class name and collision with other inner class name */
            class C00501 implements Callback<JSONArray> {
                C00501() {
                }
                ...
                public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                    if (response.code() == 200) {
                        ...
                        AnonymousClass1.this.val$userClient.getageproof(Form6.this.token, SharedPref.getInstance(Form6.this.requireContext()).getAtknBnd(), SharedPref.getInstance(Form6.this.requireContext()).getRtknBnd(), Form6.this.channelidobo, "blo", "ANDROIMOB").enqueue(new C00511());
                        return;
                    }
                    if (response.code() == 401) {
                        Form6.this.refreshTokenApi();
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$0();
                        }
                    }, 2000L);
                    Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Address Proof List - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$$ExternalSyntheticLambda3
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            this.f$0.lambda$onResponse$1(dialogInterface, i2);
                        }
                ...
                /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1, reason: invalid class name and collision with other inner class name */
                class C00511 implements Callback<JSONArray> {
                    C00511() {
                    }
                    ...
                    public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                        if (response.code() == 200) {
                            ...
                            if (!SharedPref.getInstance(Form6.this.requireContext()).getSectionData().equals("")) {
                                ...
                                try {
                                    ...
                                    Form6.this.checkListForm6Model.getSectionNameAndNumberModel().sort(Comparator.comparingInt(new Form6$42$1$1$1$$ExternalSyntheticLambda2()));
                                } catch (ParseException e) {
                                    Logger.d("", e.getMessage());
                                }
                                Form6.this.sectionNameAndNumber.sort(Comparator.comparingInt(new ToIntFunction() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$$ExternalSyntheticLambda3
                            ...
                            AnonymousClass1.this.val$userClient.getSectionForm6(Form6.this.token, SharedPref.getInstance(Form6.this.requireContext()).getAtknBnd(), SharedPref.getInstance(Form6.this.requireContext()).getRtknBnd(), Form6.this.channelidobo, "blo", Form6.this.stateCode, "application/json", "ANDROIMOB", Form6.this.asmblyNO, Form6.this.partNo).enqueue(new C00521());
                            return;
                        }
                        if (response.code() == 401) {
                            Form6.this.refreshTokenApi();
                        ...
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$$ExternalSyntheticLambda4
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onResponse$1();
                            }
                        }, 2000L);
                        Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Age Proof List - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$$ExternalSyntheticLambda5
                            @Override // android.content.DialogInterface.OnClickListener
                    ...
                    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$1, reason: invalid class name and collision with other inner class name */
                    class C00521 implements Callback<List<SectionNumberModel.Root>> {
                        C00521() {
                        }
                        ...
                        public void onResponse(Call<List<SectionNumberModel.Root>> call, Response<List<SectionNumberModel.Root>> response) {
                            ...
                            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$1$$ExternalSyntheticLambda2
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$onResponse$0();
                                }
                            }, 2000L);
                            Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Section Number - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$1$$ExternalSyntheticLambda3
                                @Override // android.content.DialogInterface.OnClickListener
                                public final void onClick(DialogInterface dialogInterface, int i2) {
                                    this.f$0.lambda$onResponse$1(dialogInterface, i2);
                                }
                        ...
                        public void onFailure(Call<List<SectionNumberModel.Root>> call, Throwable t) {
                            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$1$$ExternalSyntheticLambda0
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$onFailure$2();
                                }
                            }, 2000L);
                            Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Section Number OnFailure ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$1$$ExternalSyntheticLambda1
                                @Override // android.content.DialogInterface.OnClickListener
                                public final void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    public void onFailure(Call<JSONArray> call, Throwable t) {
                        ...
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onFailure$3();
                            }
                        }, 2000L);
                        Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Age Proof List OnFailure ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$1$$ExternalSyntheticLambda1
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                public void onFailure(Call<JSONArray> call, Throwable t) {
                    Log.d(Form6.TAG, Form6.this.comingInOnFailure + t.getMessage());
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onFailure$2();
                        }
                    }, 2000L);
                    Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Address Proof List OnFailure ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$1$$ExternalSyntheticLambda1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            this.f$0.lambda$onFailure$3(dialogInterface, i);
                        }
            ...
            public void onFailure(Call<JSONArray> call, Throwable t) {
                Log.d(Form6.TAG, Form6.this.comingInOnFailure + t.getMessage());
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onFailure$2();
                    }
                }, 2000L);
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Error Relation Type List OnFailure ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        this.f$0.lambda$onFailure$3(dialogInterface, i);
                    }
        ...
        public void onFailure(Call<JsonObject> call, Throwable t) {
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onFailure$2();
                }
            }, 2000L);
            Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 OnFailure ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$42$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$onFailure$3(dialogInterface, i);
                }
    ...
    public void refreshTokenApi() {
        this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda53
    ...
    public /* synthetic */ void lambda$refreshTokenApi$47(int i, String str, String str2) {
        ...
        if (i == 401 || i == 400) {
            this.commonUtilClass.showMessageOK(getContext(), this.sessionTokenExpiredPleaseLogin, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda8
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
        ...
        this.commomUtility.showMessageWithTitleOK(requireContext(), "ALERT", "Page refreshed due to the token expiry", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda9
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public void setTextValues() {
        ...
        this.binding.applicantNameTv1.setText(this.checkListForm6Model.getFirstName() + StringUtils.SPACE + this.checkListForm6Model.getLastName());
        this.binding.applicantNameOfficialTv1.setText(this.checkListForm6Model.getFirstNameL1() + StringUtils.SPACE + this.checkListForm6Model.getLastNameL1());
        this.binding.applicantNameOfficialTv2.setText(this.checkListForm6Model.getFirstNameL2() + StringUtils.SPACE + this.checkListForm6Model.getLastNameL2());
        if (this.checkListForm6Model.getAgeProofType().length() > 0) {
            ...
            for (int i = 0; i < this.checkListForm6Model.getAgeProofList().size(); i++) {
                if (this.checkListForm6Model.getAgeProofType().equals(this.checkListForm6Model.getAgeProofList().get(i)) || this.checkListForm6Model.getAgeProofType().equals(this.checkListForm6Model.getAgeProofListCode().get(i))) {
                    z = this.checkListForm6Model.getAgeProofType().equalsIgnoreCase("ADHR") || this.checkListForm6Model.getAgeProofType().equalsIgnoreCase("Aadhaar Card");
        ...
        if (this.checkListForm6Model.getCurrentAddressProofType().length() > 0) {
            ...
            for (int i4 = 0; i4 < this.checkListForm6Model.getAddressPoofList().size(); i4++) {
                if (this.checkListForm6Model.getCurrentAddressProofType().equals(this.checkListForm6Model.getAddressPoofList().get(i4)) || this.checkListForm6Model.getCurrentAddressProofType().equals(this.checkListForm6Model.getAddressPoofListCode().get(i4))) {
                    z2 = this.checkListForm6Model.getCurrentAddressProofType().equalsIgnoreCase("ADHR") || this.checkListForm6Model.getCurrentAddressProofType().equalsIgnoreCase("Aadhaar Card");
        ...
        this.binding.relativeTv1.setText(this.checkListForm6Model.getApplicantRelativeName() + StringUtils.SPACE + this.checkListForm6Model.getApplicantRelativeSurname());
        this.binding.relativeOfficialTv1.setText(this.checkListForm6Model.getApplicantRelativeNameL1() + StringUtils.SPACE + this.checkListForm6Model.getApplicantRelativeSurnameL1());
        this.binding.relativeOfficialTv2.setText(this.checkListForm6Model.getApplicantRelativeNameL2() + StringUtils.SPACE + this.checkListForm6Model.getApplicantRelativeSurnameL2());
        ...
        if (this.checkListForm6Model.getSectionNo().length() == 0 || Integer.parseInt(this.checkListForm6Model.getSectionNo()) == 0) {
            ...
            this.binding.sectionNoName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.43
                @Override // android.widget.AdapterView.OnItemSelectedListener
        ...
        if (Utils.isValideSIRState(this.stateCode) || Utils.isValide19SIRState(this.stateCode)) {
            ...
            if ((TextUtils.isEmpty(this.checkListForm6Model.getIsSir03()) || !this.checkListForm6Model.getIsSir03().equalsIgnoreCase("Y")) && !TextUtils.isEmpty(this.checkListForm6Model.getIsSir2526()) && this.checkListForm6Model.getIsSir2526().equalsIgnoreCase("Y")) {
        ...
        if (this.checkListForm6Model.getBloAddDocDeclaration() != null) {
            if (this.checkListForm6Model.getBloAddDocDeclaration().booleanValue()) {
                this.binding.cbNotsubmittedAddDoc.setChecked(true);
            } else {
                this.binding.cbNotsubmittedAddDoc.setChecked(false);
            }
        }
        if (isBiharState()) {
            if (this.binding.annexureDIncludedLayout.formAnnxBornIndia.isChecked()) {
                this.binding.cvDoc.setVisibility(0);
                this.binding.addDocumentSpinner.setEnabled(false);
                this.binding.addDocChooseFile.setEnabled(false);
                if (TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocDln())) {
                    this.binding.cbNotsubmittedAddDoc.setVisibility(0);
                } else {
                    this.binding.cbNotsubmittedAddDoc.setVisibility(8);
                }
                getAdditionalDocumenttype("LIST-1");
                if (!TextUtils.isEmpty(this.checkListForm6Model.getCtDocTypeForSelf()) && this.checkListForm6Model.getCtDocTypeForSelf().equalsIgnoreCase("L1D13") && z && z2) {
                    this.binding.cvDoc.setVisibility(0);
                    this.binding.addDocChooseFile.setVisibility(8);
                    this.binding.addDocCerti.setVisibility(0);
                    this.binding.addDocPhotoname.setVisibility(8);
                    this.binding.addDocSize.setVisibility(8);
                    this.binding.addDocDelete.setVisibility(8);
                    if (!TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocDln())) {
                        if (this.checkListForm6Model.getAddtionalDocDln().contains(".jpg") || this.checkListForm6Model.getAddtionalDocDln().contains(this.jpeg) || this.checkListForm6Model.getAddtionalDocDln().contains(".png")) {
                            this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda3
                                @Override // in.gov.eci.bloapp.MyCallback
                                public final void onCallback(int i7, String str4) {
                                    this.f$0.lambda$setTextValues$50(i7, str4);
                                }
                            });
                        } else {
                            this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
                        }
                    } else if (this.binding.cbNotsubmittedAddDoc.getVisibility() == 0 && this.binding.cbNotsubmittedAddDoc.isChecked()) {
                        this.binding.cvDoc.setVisibility(8);
                    }
                } else {
                    this.binding.lvTitle.setVisibility(8);
                    this.binding.cbNotsubmittedAddDoc.setVisibility(8);
                    this.binding.cvDoc.setVisibility(8);
                }
            } else if (z && z2) {
                ...
                if (!TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocDln()) && !TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocType())) {
                    this.binding.cvDoc.setVisibility(0);
                    this.binding.addDocChooseFile.setVisibility(8);
                    this.binding.addDocCerti.setVisibility(0);
                    this.binding.addDocPhotoname.setVisibility(8);
                    ...
                    this.binding.addDocDelete.setVisibility(8);
                    if (this.checkListForm6Model.getAddtionalDocDln().contains(".jpg") || this.checkListForm6Model.getAddtionalDocDln().contains(this.jpeg) || this.checkListForm6Model.getAddtionalDocDln().contains(".png")) {
                        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda4
                            @Override // in.gov.eci.bloapp.MyCallback
                            public final void onCallback(int i7, String str4) {
                                this.f$0.lambda$setTextValues$53(i7, str4);
                            }
                        });
                    } else {
                        this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
            ...
            if (!TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocDln()) && !TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocType())) {
                ...
                this.binding.addDocDelete.setVisibility(8);
                if (this.checkListForm6Model.getAddtionalDocDln().contains(".jpg") || this.checkListForm6Model.getAddtionalDocDln().contains(this.jpeg) || this.checkListForm6Model.getAddtionalDocDln().contains(".png")) {
                    this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda5
                        @Override // in.gov.eci.bloapp.MyCallback
                        public final void onCallback(int i7, String str4) {
                            this.f$0.lambda$setTextValues$56(i7, str4);
                        }
                    });
                } else {
                    this.binding.addDocPhoto.setImageResource(R.drawable.blo_pfd_thumbnail);
        ...
        if (!TextUtils.isEmpty(this.checkListForm6Model.getFormSubmissionChannel()) && (this.checkListForm6Model.getFormSubmissionChannel().equalsIgnoreCase("ERONET") || this.checkListForm6Model.getFormSubmissionChannel().equalsIgnoreCase("GARUDA"))) {
            this.binding.cvUploadDoc.setVisibility(0);
            if (!TextUtils.isEmpty(this.checkListForm6Model.getOfflineSignedPage1Url())) {
                this.binding.uploadDoc1ChooseFile.setVisibility(8);
                this.binding.uploadDoc1Certi.setVisibility(0);
                this.binding.uploadDoc1Photoname.setVisibility(8);
                this.binding.uploadDoc1Size.setVisibility(8);
                this.binding.uploadDoc1Delete.setVisibility(8);
                this.binding.tvUploadformDocEditTextview.setVisibility(0);
                this.binding.uploadformDocButton.setVisibility(0);
                if (this.checkListForm6Model.getOfflineSignedPage1Url().contains(".jpg") || this.checkListForm6Model.getOfflineSignedPage1Url().contains(this.jpeg) || this.checkListForm6Model.getOfflineSignedPage1Url().contains(".png")) {
                    this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getOfflineSignedPage1Url(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda6
                        @Override // in.gov.eci.bloapp.MyCallback
                        public final void onCallback(int i7, String str4) {
                            this.f$0.lambda$setTextValues$59(i7, str4);
                        }
                    });
                } else {
                    this.binding.uploadDoc1Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                }
            } else {
                this.binding.uploadDoc1ChooseFile.setVisibility(0);
                this.binding.tvUploadformDocEditTextview.setVisibility(8);
                this.binding.uploadformDocButton.setVisibility(8);
            }
            if (!TextUtils.isEmpty(this.checkListForm6Model.getOfflineSignedPage2Url())) {
                this.binding.uploadDoc2ChooseFile.setVisibility(8);
                this.binding.uploadDoc2Certi.setVisibility(0);
                this.binding.uploadDoc2Photoname.setVisibility(8);
                this.binding.uploadDoc2Size.setVisibility(8);
                this.binding.uploadDoc2Delete.setVisibility(8);
                this.binding.tvUploadformDocEditTextview.setVisibility(0);
                this.binding.uploadformDocButton.setVisibility(0);
                if (this.checkListForm6Model.getOfflineSignedPage1Url().contains(".jpg") || this.checkListForm6Model.getOfflineSignedPage2Url().contains(this.jpeg) || this.checkListForm6Model.getOfflineSignedPage2Url().contains(".png")) {
                    this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getOfflineSignedPage2Url(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda7
                        @Override // in.gov.eci.bloapp.MyCallback
                        public final void onCallback(int i7, String str4) {
                            this.f$0.lambda$setTextValues$62(i7, str4);
                        }
                    });
                    return;
                } else {
                    this.binding.uploadDoc2Photo.setImageResource(R.drawable.blo_pfd_thumbnail);
                    return;
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$50(int i, String str) {
        if (i == 401) {
            this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda42
                @Override // in.gov.eci.bloapp.aadharcallback
                public final void onCallBack(int i2, String str2, String str3) {
                    this.f$0.lambda$setTextValues$49(i2, str2, str3);
                }
            });
            return;
        }
        byte[] bArrDecode = Base64.decode(str, 0);
        this.additionalDocumentEncoded = str;
        this.binding.addDocPhoto.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$49(int i, String str, String str2) {
        System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        if (i == 401 || i == 400) {
            return;
        }
        ...
        SharedPref.getInstance(requireContext()).setRefreshToken(str2);
        SharedPref.getInstance(requireContext()).setToken("Bearer " + str);
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda65
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i2, String str3) {
                this.f$0.lambda$setTextValues$48(i2, str3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$48(int i, String str) {
        this.additionalDocumentEncoded = str;
        byte[] bArrDecode = Base64.decode(str, 0);
        this.binding.addDocPhoto.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$53(int i, String str) {
        if (i == 401) {
            this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda62
                @Override // in.gov.eci.bloapp.aadharcallback
                public final void onCallBack(int i2, String str2, String str3) {
                    this.f$0.lambda$setTextValues$52(i2, str2, str3);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$52(int i, String str, String str2) {
        System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        if (i == 401 || i == 400) {
            return;
        }
        ...
        SharedPref.getInstance(requireContext()).setRefreshToken(str2);
        SharedPref.getInstance(requireContext()).setToken("Bearer " + str);
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda35
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i2, String str3) {
                this.f$0.lambda$setTextValues$51(i2, str3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$51(int i, String str) {
        byte[] bArrDecode = Base64.decode(str, 0);
        this.additionalDocumentEncoded = str;
        this.binding.addDocPhoto.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$56(int i, String str) {
        if (i == 401) {
            this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda12
                @Override // in.gov.eci.bloapp.aadharcallback
                public final void onCallBack(int i2, String str2, String str3) {
                    this.f$0.lambda$setTextValues$55(i2, str2, str3);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$55(int i, String str, String str2) {
        System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        if (i == 401 || i == 400) {
            return;
        }
        ...
        SharedPref.getInstance(requireContext()).setRefreshToken(str2);
        SharedPref.getInstance(requireContext()).setToken("Bearer " + str);
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getAddtionalDocDln(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda0
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i2, String str3) {
                this.f$0.lambda$setTextValues$54(i2, str3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$54(int i, String str) {
        byte[] bArrDecode = Base64.decode(str, 0);
        this.additionalDocumentEncoded = str;
        this.binding.addDocPhoto.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$59(int i, String str) {
        if (i == 401) {
            this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda43
                @Override // in.gov.eci.bloapp.aadharcallback
                public final void onCallBack(int i2, String str2, String str3) {
                    this.f$0.lambda$setTextValues$58(i2, str2, str3);
                }
            });
            return;
        }
        byte[] bArrDecode = Base64.decode(str, 0);
        this.uploadDoc1DocumentEncoded = str;
        this.binding.uploadDoc1Photo.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$58(int i, String str, String str2) {
        System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        if (i == 401 || i == 400) {
            return;
        }
        ...
        SharedPref.getInstance(requireContext()).setRefreshToken(str2);
        SharedPref.getInstance(requireContext()).setToken("Bearer " + str);
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getOfflineSignedPage1Url(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda40
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i2, String str3) {
                this.f$0.lambda$setTextValues$57(i2, str3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$57(int i, String str) {
        byte[] bArrDecode = Base64.decode(str, 0);
        this.uploadDoc1DocumentEncoded = str;
        this.binding.uploadDoc1Photo.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$62(int i, String str) {
        if (i == 401) {
            this.commonUtilClass.getRefreshToken(requireContext(), this.refreshToken, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda50
                @Override // in.gov.eci.bloapp.aadharcallback
                public final void onCallBack(int i2, String str2, String str3) {
                    this.f$0.lambda$setTextValues$61(i2, str2, str3);
                }
            });
            return;
        }
        byte[] bArrDecode = Base64.decode(str, 0);
        this.uploadDoc2DocumentEncoded = str;
        this.binding.uploadDoc2Photo.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$61(int i, String str, String str2) {
        System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str + StringUtils.SPACE + str2);
        if (i == 401 || i == 400) {
            return;
        }
        ...
        SharedPref.getInstance(requireContext()).setRefreshToken(str2);
        SharedPref.getInstance(requireContext()).setToken("Bearer " + str);
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.checkListForm6Model.getOfflineSignedPage2Url(), new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda32
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i2, String str3) {
                this.f$0.lambda$setTextValues$60(i2, str3);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextValues$60(int i, String str) {
        byte[] bArrDecode = Base64.decode(str, 0);
        this.uploadDoc2DocumentEncoded = str;
        this.binding.uploadDoc2Photo.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == 2131365307) {
            ...
            if (!this.checkListForm6Model.getPhotograph().trim().isEmpty()) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda21
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onClick$63();
                    }
                }, 2000L);
                return;
            }
        }
        if (v.getId() == 2131363359) {
            if (!this.checkListForm6Model.getAgeProofDocument().trim().isEmpty()) {
                ...
                this.commomUtility.displayAlertWithTitleAndMessage(requireContext(), this.statusText, this.noDocumentAttached);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda23
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onClick$64();
                    }
                }, 2000L);
                return;
            }
        }
        if (v.getId() == 2131362270) {
            if (!this.checkListForm6Model.getCurrentAddressProofDocument().trim().isEmpty()) {
                ...
                this.commomUtility.displayAlertWithTitleAndMessage(requireContext(), this.statusText, this.noDocumentAttached);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda24
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onClick$65();
                    }
                }, 2000L);
                return;
            }
        }
        if (v.getId() == 2131362722) {
            if (!this.checkListForm6Model.getDisabilityCertificate().trim().isEmpty()) {
                ...
                this.commomUtility.displayAlertWithTitleAndMessage(requireContext(), this.statusText, this.noDocumentAttached);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda25
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onClick$66();
                    }
                }, 2000L);
                return;
            }
        }
        if (v.getId() == 2131363105) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onClick$63() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onClick$64() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onClick$65() {
        this.alertDialog.dismiss();
    }
    ...
    private void getWorkFlowID() {
        ...
        this.commomUtility.getRetrofitClient(getContext(), this.token, SharedPref.getInstance(getContext()).getAtknBnd(), SharedPref.getInstance(getContext()).getRtknBnd()).getWorkflowid("blo", this.stateCode, map).enqueue(new Callback<JSONArray>() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.44
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                if (response.code() == 200) {
                    JSONArray jSONArray = (JSONArray) response.body();
                    for (int i = 0; i < jSONArray.size(); i++) {
    ...
    public void reInitiateToAero() {
        ...
        ((UserClient) ApiClient.getClient(getContext()).create(UserClient.class)).reInitiateToAero("blo", this.stateCode, this.formProcessingId, this.workflowConfigId, "ANDROIDMOB", this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), map2).enqueue(new AnonymousClass45());
        this.commomUtility.showMessageWithTitleOK(requireContext(), this.statusText, "Form reInitated to AERO successfully.", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda54
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$reInitiateToAero$68(dialogInterface, i);
            }
        });
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$45, reason: invalid class name */
    class AnonymousClass45 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.isSuccessful()) {
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), Form6.this.statusText, "Form reInitated to AERO successfully.", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$45$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$reInitiateToAero$68(DialogInterface dialogInterface, int i) {
        openFragment(new CheckListMain());
    }
    ...
    private void showPersonImageDialog(Bitmap bitmapPersonImage) {
        ...
        ((ImageView) dialog.findViewById(R.id.person_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda44
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        });
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda55
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showPersonImageDialog$70();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showPersonImageDialog$70() {
        this.alertDialog.dismiss();
    }
    ...
    public void showAgeProofImageDialog(Bitmap bitmapAgeProofImage) {
        ...
        ((ImageView) dialog.findViewById(R.id.age_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda56
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        });
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda57
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showAgeProofImageDialog$72();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showAgeProofImageDialog$72() {
        this.alertDialog.dismiss();
    }
    ...
    public void showAgeProofPdfDialog(String encodedAgeProofImage) throws IOException {
        ...
        PdfLoader.loadFromBase64(requireContext(), pDFViewFindViewById, encodedAgeProofImage);
        textView.setText(this.checkListForm6Model.getAgeProofDocument().trim());
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda48
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        dialog.show();
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda49
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showAgeProofPdfDialog$74();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showAgeProofPdfDialog$74() {
        this.alertDialog.dismiss();
    }
    ...
    public void showAddressImageDialog(Bitmap bitmapAddressProofImage) {
        ...
        ((ImageView) dialog.findViewById(R.id.address_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda30
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        });
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda31
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showAddressImageDialog$76();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showAddressImageDialog$76() {
        this.alertDialog.dismiss();
    }
    ...
    private void showDeclarationImageDialog(Bitmap bitmapDeclarationImage) {
        ...
        ((ImageView) dialog.findViewById(R.id.declaration_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda22
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda33
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showDeclarationImageDialog$78();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showDeclarationImageDialog$78() {
        this.alertDialog.dismiss();
    }
    ...
    public void showAddressPdfDialog(String encodedAddressProofImage) throws IOException {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda51
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        dialog.show();
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda52
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showAddressPdfDialog$80();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showAddressPdfDialog$80() {
        this.alertDialog.dismiss();
    }
    ...
    private void showDeclarationPdfDialog(String encodedDeclarationImage) throws IOException {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda18
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        dialog.show();
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showDeclarationPdfDialog$82();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showDeclarationPdfDialog$82() {
        this.alertDialog.dismiss();
    }
    ...
    public void showDisabilityImageDialog(Bitmap bitmapDisabilityImage) {
        ...
        ((ImageView) dialog.findViewById(R.id.disability_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda63
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        });
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda64
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showDisabilityImageDialog$84();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showDisabilityImageDialog$84() {
        this.alertDialog.dismiss();
    }
    ...
    public void showDisabilityPdfDialog(String encodedDisabilityProofImage) throws IOException {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda45
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        dialog.show();
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda46
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showDisabilityPdfDialog$86();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showDisabilityPdfDialog$86() {
        this.alertDialog.dismiss();
    }
    ...
    private boolean isApplicantValidated() {
        ...
        if (this.binding.cbNotsubmittedAddDoc.getVisibility() == 0 && !this.binding.cbNotsubmittedAddDoc.isChecked()) {
            showdialog("ALERT", "Please check applicant has provided any valid Additional Document or not");
            return false;
        }
        if (this.binding.cvDoc.getVisibility() == 0 && TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocType())) {
            showdialog("ALERT", "Please select document type");
            return false;
        }
        if (this.binding.cvDoc.getVisibility() == 0 && TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocDln())) {
            showdialog("ALERT", "Please add document image");
            return false;
        }
        ...
        if (this.binding.cvUploadDoc.getVisibility() == 0 && TextUtils.isEmpty(this.checkListForm6Model.getOfflineSignedPage1Url())) {
            showdialog("ALERT", "Please Upload Page 1 of Form");
            return false;
        }
        if (this.binding.cvUploadDoc.getVisibility() != 0 || !TextUtils.isEmpty(this.checkListForm6Model.getOfflineSignedPage2Url())) {
            return true;
        }
        showdialog("ALERT", "Please Upload Page 2 of Form");
        return false;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:453:0x0dfd A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:462:0x0e53 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:464:0x0e5f A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:465:0x0e6b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:468:0x0e7d A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:469:0x0e89 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:472:0x0ef3 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:473:0x0eff A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:476:0x0f11 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:477:0x0f1d A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:480:0x0f2f A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:481:0x0f3b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:484:0x0f4d A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:485:0x0f59 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:488:0x0f6b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:489:0x0f77 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:492:0x0f89 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:493:0x0f95 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:496:0x0fa7 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:497:0x0fb3 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:500:0x0fc5 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:501:0x0fd1 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:504:0x0fe3 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:505:0x0fef A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:508:0x1001 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:509:0x100d A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:512:0x101f A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:513:0x102b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:516:0x103d A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:517:0x1049 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:520:0x105b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:521:0x1067 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:524:0x1079 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:525:0x1085 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:528:0x1097 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:529:0x10a3 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:532:0x10b5 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:533:0x10c1 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:536:0x10d3 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:537:0x10df A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:540:0x10f1 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:541:0x10fd A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:544:0x110f A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:545:0x111b A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:549:0x1150 A[Catch: Exception -> 0x1294, TRY_ENTER, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:564:0x11ca A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:566:0x11d2 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:569:0x11ea A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:571:0x11fa A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:572:0x1208 A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:575:0x121c A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:576:0x122a A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:579:0x123e A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:580:0x124c A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    /* JADX WARN: Code duplicated, block: B:583:0x125a A[Catch: Exception -> 0x1294, TryCatch #2 {Exception -> 0x1294, blocks: (B:406:0x0c75, B:408:0x0c7d, B:410:0x0c8e, B:412:0x0ca2, B:448:0x0de3, B:450:0x0de7, B:452:0x0dee, B:458:0x0e43, B:460:0x0e4b, B:581:0x1250, B:583:0x125a, B:585:0x127b, B:584:0x1271, B:462:0x0e53, B:464:0x0e5f, B:466:0x0e71, B:468:0x0e7d, B:470:0x0e8f, B:472:0x0ef3, B:474:0x0f05, B:476:0x0f11, B:478:0x0f23, B:480:0x0f2f, B:482:0x0f41, B:484:0x0f4d, B:486:0x0f5f, B:488:0x0f6b, B:490:0x0f7d, B:492:0x0f89, B:494:0x0f9b, B:496:0x0fa7, B:498:0x0fb9, B:500:0x0fc5, B:502:0x0fd7, B:504:0x0fe3, B:506:0x0ff5, B:508:0x1001, B:510:0x1013, B:512:0x101f, B:514:0x1031, B:516:0x103d, B:518:0x104f, B:520:0x105b, B:522:0x106d, B:524:0x1079, B:526:0x108b, B:528:0x1097, B:530:0x10a9, B:532:0x10b5, B:534:0x10c7, B:536:0x10d3, B:538:0x10e5, B:540:0x10f1, B:542:0x1103, B:544:0x110f, B:546:0x1121, B:549:0x1150, B:551:0x115c, B:553:0x116c, B:555:0x117e, B:557:0x118e, B:559:0x11a0, B:561:0x11b0, B:563:0x11c3, B:562:0x11bf, B:558:0x119c, B:554:0x117a, B:564:0x11ca, B:566:0x11d2, B:568:0x11de, B:569:0x11ea, B:571:0x11fa, B:573:0x120c, B:575:0x121c, B:577:0x122e, B:579:0x123e, B:580:0x124c, B:576:0x122a, B:572:0x1208, B:545:0x111b, B:541:0x10fd, B:537:0x10df, B:533:0x10c1, B:529:0x10a3, B:525:0x1085, B:521:0x1067, B:517:0x1049, B:513:0x102b, B:509:0x100d, B:505:0x0fef, B:501:0x0fd1, B:497:0x0fb3, B:493:0x0f95, B:489:0x0f77, B:485:0x0f59, B:481:0x0f3b, B:477:0x0f1d, B:473:0x0eff, B:469:0x0e89, B:465:0x0e6b, B:451:0x0deb, B:413:0x0cb3, B:415:0x0cbd, B:417:0x0cc5, B:418:0x0cda, B:420:0x0ce2, B:421:0x0cf7, B:423:0x0d01, B:425:0x0d09, B:426:0x0d24, B:428:0x0d2c, B:430:0x0d34, B:432:0x0d3c, B:434:0x0d49, B:436:0x0d53, B:437:0x0d69, B:439:0x0d73, B:441:0x0d7d, B:442:0x0d92, B:444:0x0da1, B:445:0x0dbb, B:447:0x0dca, B:453:0x0dfd, B:455:0x0e05, B:457:0x0e0d), top: B:599:0x0c75 }] */
    ...
    public void json() {
        ...
        try {
            if (!this.checkListForm6Model.getAadharRefNo().trim().isEmpty()) {
                try {
                    ...
                    str = TAG;
                    str2 = str;
                    Logger.d(str2, "ChecklistForm6JsonError ---> " + exc.getMessage());
                    Logger.d(str2, this.exception + exc.getMessage());
                }
            } else {
            ...
            if (!TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocType())) {
                map.put("addtionalDocType", this.checkListForm6Model.getAddtionalDocType().trim());
            } else {
                map.put("addtionalDocType", null);
            }
            if (!TextUtils.isEmpty(this.checkListForm6Model.getAddtionalDocType())) {
                map.put("addtionalDocDln", this.checkListForm6Model.getAddtionalDocDln().trim());
            } else {
                map.put("addtionalDocDln", null);
            }
            ...
            boolean zIsBiharState = isBiharState();
            str = TAG;
            if (!zIsBiharState) {
                obj = "addtionalDocType";
                if (isBiharState()) {
                ...
                if (!Utils.isValideSIRState(this.stateCode)) {
                    ...
                    if (this.checkListForm6Model.getIsIndia() == null) {
                        if (this.checkListForm6Model.getIsIndia() == null) {
                    ...
                    } else if (this.checkListForm6Model.getIsIndia() == null) {
                        if (!this.checkListForm6Model.getBirthStateCd().trim().isEmpty()) {
                            map.put("birthStateCd", this.checkListForm6Model.getBirthStateCd().trim());
                        } else {
                            map.put("birthStateCd", null);
                ...
                if (this.binding.cvDoc.getVisibility() == 0) {
                    map.put(obj, this.checkListForm6Model.getAddtionalDocType());
                    map.put("addtionalDocDln", this.checkListForm6Model.getAddtionalDocDln());
                } else {
                    map.put(obj, "");
                    map.put("addtionalDocDln", "");
                }
                map.put("offlineSignedPage1Url", this.checkListForm6Model.getOfflineSignedPage1Url());
                map.put("offlineSignedPage2Url", this.checkListForm6Model.getOfflineSignedPage2Url());
                str2 = str;
            } else {
                try {
                    if (TextUtils.isEmpty(this.citizenshipTypeCat)) {
                        ...
                        String str3 = this.anxDSignUrl;
                        if (str3 != null) {
                            map.put("anxDSignUrl", str3);
                        } else {
                            map.put("anxDSignUrl", "");
                        }
                        map.put("citizenshipType", this.choice);
        ...
        Logger.d(str2, "Form6CheckListDataJsonObject " + new JSONObject(map));
        Logger.d(str2, "token " + this.token);
        Logger.d(str2, "atkn_bnd " + SharedPref.getInstance(requireContext()).getAtknBnd());
        Logger.d(str2, "rtkn_bnd " + SharedPref.getInstance(requireContext()).getRtknBnd());
        Logger.d(str2, "channelidobo " + this.channelidobo);
        Logger.d(str2, "state " + this.stateCode);
        ((UserClient) ApiClient.getClient(getContext()).create(UserClient.class)).submitform6(this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.stateCode, "application/json", "ANDROIMOB", map).enqueue(new AnonymousClass46());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46, reason: invalid class name */
    class AnonymousClass46 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, final Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                if (Form6.this.binding.remarkll.getVisibility() == 0) {
                    map.put("fieldVerificationRemark", Form6.this.binding.remark.getText().toString().trim() + StringUtils.SPACE + Form6.this.binding.anyotherremark.getText().toString());
                } else {
                ...
                if (Form6.this.binding.cbNotsubmittedAddDoc.getVisibility() == 0 && Form6.this.binding.cbNotsubmittedAddDoc.isChecked()) {
                    map.put("bloAddDocDeclaration", "Y");
                } else {
                    map.put("bloAddDocDeclaration", "N");
                }
            ...
            try {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$1();
                    }
                }, 2000L);
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Submission Error - " + response.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Submission Error - " + response.code(), "Internal Server Error, Please Try again.", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1, reason: invalid class name */
        class AnonymousClass1 implements Callback<Void> {
            ...
            public void onResponse(Call<Void> call1, Response<Void> response1) {
                if (response1.code() == 200) {
                    ...
                    try {
                        ...
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onResponse$0();
                            }
                        ...
                        Logger.d(Form6.TAG, Form6.this.exception + e.getMessage());
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda3
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onResponse$1();
                            }
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$2();
                        }
                    }, 2000L);
                    Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), Form6.this.statusText, "Verified Successfully.", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda5
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            this.f$0.lambda$onResponse$3(dialogInterface, i);
                        }
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$4();
                        }
                    }, 2000L);
                    Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 FVR Submission Error - " + response1.code(), Form6.this.errorResponse, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda7
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 FVR Submission Error - " + response1.code(), "Internal Server Error, Please Try again.", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda8
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            public void onFailure(Call<Void> call1, Throwable t) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onFailure$7();
                    }
                }, 2000L);
                Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 FVR Submission Error ", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        public void onFailure(Call<JsonObject> call, Throwable t) {
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onFailure$4();
                }
            }, 2000L);
            Form6.this.commomUtility.showMessageWithTitleOK(Form6.this.requireContext(), "Form 6 Submission Error", t.getMessage(), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$46$$ExternalSyntheticLambda5
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void getPersonImageUploadedfilePersonalDetials(String fileName) {
        ...
        userClient.getFile(str, fileName, this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.bloApp, "ANDROIMOB").enqueue(new AnonymousClass47());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$47, reason: invalid class name */
    class AnonymousClass47 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$47$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
            ...
            try {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$47$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$1();
                    }
    ...
    private void getAgeProffUploadedfilePersonalDetials(String fileName) {
        ...
        String str = this.objectStorage;
        Logger.d(this.getToken, this.token);
        userClient.getFile(str, fileName, this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.bloApp, "ANDROIMOB").enqueue(new AnonymousClass48());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$48, reason: invalid class name */
    class AnonymousClass48 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            ...
            try {
                ...
                Log.d(Form6.TAG, Form6.this.imageError + Form6.this.errorResponse);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$48$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
    ...
    private void getDisabilityCertificateDetials(String fileName) {
        ...
        String str = this.objectStorage;
        Logger.d(this.getToken, this.token);
        userClient.getFile(str, fileName, this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.bloApp, "ANDROIMOB").enqueue(new AnonymousClass49());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$49, reason: invalid class name */
    class AnonymousClass49 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            ...
            try {
                ...
                form8.errorResponse = jSONObject.optString(form8.message);
                Log.d(Form6.TAG, Form6.this.imageError + Form6.this.errorResponse);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$49$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
    ...
    private void getAddressProofUploadedfilePersonalDetials(String fileName) {
        ...
        String str = this.objectStorage;
        Logger.d(this.getToken, this.token);
        userClient.getFile(str, fileName, this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.bloApp, "ANDROIMOB").enqueue(new AnonymousClass50());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$50, reason: invalid class name */
    class AnonymousClass50 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            ...
            try {
                ...
                form8.errorResponse = jSONObject.optString(form8.message);
                Log.d(Form6.TAG, Form6.this.imageError + Form6.this.errorResponse);
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$50$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onResponse$0();
                    }
    ...
    private void getDeclarationFormUploadedSign(String fileName) {
        ...
        String str = this.objectStorage;
        Logger.d(this.getToken, this.token);
        userClient.getFile(str, fileName, this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), this.channelidobo, "blo", this.bloApp, "ANDROIMOB").enqueue(new AnonymousClass51());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$51, reason: invalid class name */
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() != 200) {
                ...
                try {
                    ...
                    form6.errorResponse = jSONObject.optString(form6.message);
                    Log.d(Form6.TAG, Form6.this.imageError + Form6.this.errorResponse);
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$51$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onResponse$0();
                        }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        if (group == this.binding.personalDetailRg) {
            if (checkedId == 2131365772) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda99
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$87();
                    }
                }, 2000L);
            } else if (checkedId == 2131365132) {
            ...
            if (checkedId == 2131365771) {
                this.alertDialog.show();
                this.binding.authenticationButton.setVisibility(8);
                this.binding.tvAuthenticationEditTextview.setVisibility(8);
                this.checkListForm6Model.setAuthenticationSameOrNot("Y");
                checkRemarkVisibility();
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda110
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$88();
                    }
                }, 2000L);
            } else if (checkedId == 2131365131) {
                this.binding.authenticationButton.setVisibility(0);
                this.binding.tvAuthenticationEditTextview.setVisibility(0);
            ...
            if (checkedId == 2131365769) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$89();
                    }
                }, 2000L);
            } else if (checkedId == 2131365121) {
            ...
            if (checkedId == 2131362267) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda13
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$90();
                    }
                }, 2000L);
            } else if (checkedId == 2131362266) {
            ...
            if (checkedId == 2131363899) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$91();
                    }
                }, 2000L);
            } else if (checkedId == 2131363897) {
            ...
            if (checkedId == 2131363282) {
                ...
                checkRemarkVisibility();
                this.alertDialog.show();
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$92();
                    }
                }, 2000L);
            } else if (checkedId == 2131363280) {
        ...
        if (group == this.binding.annexureDetailRg) {
            if (checkedId == 2131362399) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$93();
                    }
                }, 2000L);
            } else if (checkedId == 2131362397) {
                this.binding.annexureDIncludedLayout.annxureEditDetailButton.setVisibility(0);
                this.binding.annexureDIncludedLayout.tvAnnxureEditTextview.setVisibility(0);
        ...
        if (group == this.binding.declarationDetailRg) {
            if (checkedId == 2131363145) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda17
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onCheckedChanged$94();
                    }
                }, 2000L);
                return;
            }
            if (checkedId == 2131363142) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$87() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$88() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$89() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$90() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$91() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$92() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$93() {
        this.alertDialog.dismiss();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCheckedChanged$94() {
        this.alertDialog.dismiss();
    }
    ...
    public void getList1(String list) {
        try {
            ...
            HashMap map2 = new HashMap();
            map2.put("lists", list);
            ((UserClient) ApiClient.getClient(getActivity()).create(UserClient.class)).getSpecialRevisionList(map, map2).enqueue(new AnonymousClass52(list));
        } catch (Exception e) {
            Log.e("error@getList1", e.toString());
        }
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$52, reason: invalid class name */
    class AnonymousClass52 implements Callback<JsonObject> {
        final /* synthetic */ String val$list;

        AnonymousClass52(final String val$list) {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            ...
            if (response.code() == 401) {
                try {
                    ...
                    commomUtility.getRefreshToken(activity, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$52$$ExternalSyntheticLambda0
                        @Override // in.gov.eci.bloapp.aadharcallback
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            if (i == 401 || i == 400) {
                Form6.this.commomUtility.showMessageOK(Form6.this.getActivity(), Form6.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$52$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public void showdialog(String title, String msg) {
        new android.app.AlertDialog.Builder(getContext()).setTitle(title).setMessage(msg).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda27
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showdialog$95(dialogInterface, i);
            }
        }).create().show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showdialog$95(DialogInterface dialogInterface, int i) {
        this.alertDialog.dismiss();
    ...
    public void showDialog1(String ALERT2, String message) {
        ...
        new android.app.AlertDialog.Builder(getActivity()).setTitle(ALERT2).setMessage(message).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda39
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showDialog1$96(dialogInterface, i);
            }
        }).create().show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showDialog1$96(DialogInterface dialogInterface, int i) {
        AlertDialog alertDialog = this.alertDialog;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
    ...
    private void showdialog1(String success, String msg) {
        new android.app.AlertDialog.Builder(getContext()).setTitle(success).setMessage(msg).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda41
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showdialog1$97(dialogInterface, i);
            }
        }).create().show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showdialog1$97(DialogInterface dialogInterface, int i) {
        try {
            FileUtils.deleteDirectory(new File("/storage/self/primary/Android/data/in.gov.eci.bloapp/filesGaruda/"));
        } catch (Exception e) {
            Logger.d("", e.getMessage());
    ...
    private void showdialog2(String success, String msg) {
        new android.app.AlertDialog.Builder(getContext()).setTitle(success).setMessage(msg).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda10
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showdialog2$98(dialogInterface, i);
            }
        }).create().show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showdialog2$98(DialogInterface dialogInterface, int i) {
        startActivity(new Intent((Context) getActivity(), (Class<?>) MainActivity.class));
    }
    ...
    private void pickFile(final int code, String listCode) {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda88
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$pickFile$99(charSequenceArr, code, dialogInterface, i);
            }
        });
        builder.show();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pickFile$99(CharSequence[] charSequenceArr, int i, DialogInterface dialogInterface, int i2) {
    ...
    public void uploadPhoto(String statecode, String asmblyNo, String partno, String filepath, String captureFileName, String Token, String reference, String uploadtype) {
        ...
        restClient.uploadImageWithData1(Token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), "BLOAPP", "blo", "BLOAPP", partCreateFormData, RequestBody.create(this.applicationpdf, MediaType.parse("fileType")), requestBodyCreate, RequestBody.create(statecode, MediaType.parse("stateCode")), RequestBody.create(asmblyNo, MediaType.parse("acNo")), RequestBody.create(partno, MediaType.parse("partNo")), RequestBody.create("form", MediaType.parse("type")), RequestBody.create("BLOAPP", MediaType.parse("appName"))).enqueue(new AnonymousClass53(statecode, asmblyNo, partno, filepath, captureFileName, reference, uploadtype));
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$53, reason: invalid class name */
    class AnonymousClass53 implements Callback<JsonObject> {
        ...
        AnonymousClass53(final String val$statecode, final String val$asmblyNo, final String val$partno, final String val$filepath, final String val$captureFileName, final String val$reference, final String val$uploadtype) {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 401) {
                ...
                commomUtility.getRefreshToken(contextRequireContext, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$53$$ExternalSyntheticLambda0
                    @Override // in.gov.eci.bloapp.aadharcallback
            ...
            if (response.code() == 200) {
                ...
                handler.postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$53$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i, String str8, String str9) {
            ...
            if (i == 401 || i == 400) {
                Form6.this.commonUtilClass.showMessageOK(Form6.this.getContext(), Form6.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$53$$ExternalSyntheticLambda2
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
        ...
        public /* synthetic */ void lambda$onResponse$2(String str, String str2) {
            ...
            if (str.equalsIgnoreCase("AddDoc")) {
                Form6.this.addDocUrl = str2.replace(RegexMatcher.JSON_STRING_REGEX, "");
                Form6.this.checkListForm6Model.setAddtionalDocDln(Form6.this.addDocUrl);
                if (Form6.this.alertDialog != null) {
                    Form6.this.alertDialog.dismiss();
                }
                Form6.this.binding.cbNotsubmittedAddDoc.setChecked(false);
                Form6.this.binding.cbNotsubmittedAddDoc.setVisibility(8);
                return;
            }
            if (str.equalsIgnoreCase("UploadForm6Page1")) {
                Form6.this.uploadForm6Page1Url = str2.replace(RegexMatcher.JSON_STRING_REGEX, "");
                Form6.this.checkListForm6Model.setOfflineSignedPage1Url(Form6.this.uploadForm6Page1Url);
                if (Form6.this.alertDialog != null) {
                    Form6.this.alertDialog.dismiss();
                    return;
                }
            ...
            if (str.equalsIgnoreCase("UploadForm6Page2")) {
                Form6.this.uploadForm6Page2Url = str2.replace(RegexMatcher.JSON_STRING_REGEX, "");
                Form6.this.checkListForm6Model.setOfflineSignedPage2Url(Form6.this.uploadForm6Page2Url);
                if (Form6.this.alertDialog != null) {
                    Form6.this.alertDialog.dismiss();
                    return;
                }
    ...
    public void showdialogref(String title, String msg, final String type, final String filepathimg, final String captureFileName) {
        new android.app.AlertDialog.Builder(getContext()).setTitle(title).setMessage(msg).setCancelable(false).setPositiveButton("Retry", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda66
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$showdialogref$100(filepathimg, captureFileName, type, dialogInterface, i);
            }
        }).create().show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showdialogref$100(String str, String str2, String str3, DialogInterface dialogInterface, int i) {
        this.alertDialog.show();
        dialogInterface.dismiss();
        uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, str, str2, this.token, this.referenceNo, str3);
    }

    /* JADX WARN: Code duplicated, block: B:100:0x0469 A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:101:0x047b A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:102:0x0512 A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:106:0x0528  */
    /* JADX WARN: Code duplicated, block: B:107:0x052b  */
    /* JADX WARN: Code duplicated, block: B:110:0x053b  */
    /* JADX WARN: Code duplicated, block: B:135:0x075b  */
    /* JADX WARN: Code duplicated, block: B:160:0x097b  */
    /* JADX WARN: Code duplicated, block: B:185:0x0b9b  */
    /* JADX WARN: Code duplicated, block: B:210:0x0dbb  */
    /* JADX WARN: Code duplicated, block: B:235:0x0fdb  */
    /* JADX WARN: Code duplicated, block: B:258:0x11f0  */
    /* JADX WARN: Code duplicated, block: B:283:0x13f7  */
    /* JADX WARN: Code duplicated, block: B:308:0x1617  */
    /* JADX WARN: Code duplicated, block: B:333:0x181b  */
    /* JADX WARN: Code duplicated, block: B:356:0x19b3  */
    /* JADX WARN: Code duplicated, block: B:379:0x1b65  */
    /* JADX WARN: Code duplicated, block: B:517:? A[ADDED_TO_REGION, RETURN, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:83:0x0305  */
    /* JADX WARN: Code duplicated, block: B:85:0x030c  */
    /* JADX WARN: Code duplicated, block: B:92:0x0362 A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:94:0x037c A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:95:0x0417 A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:97:0x041d A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    /* JADX WARN: Code duplicated, block: B:98:0x0451 A[Catch: Exception -> 0x051d, TryCatch #10 {Exception -> 0x051d, blocks: (B:90:0x033a, B:92:0x0362, B:94:0x037c, B:95:0x0417, B:97:0x041d, B:98:0x0451, B:100:0x0469, B:101:0x047b, B:102:0x0512, B:103:0x051c), top: B:420:0x033a }] */
    ...
    /* JADX WARN: Type inference failed for: r2v108, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v128, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v144, types: [java.lang.StringBuilder] */
    ...
    /* JADX WARN: Type inference failed for: r2v261, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v284, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v300, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v323, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v339, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v362, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v378, types: [java.lang.StringBuilder] */
    /* JADX WARN: Type inference failed for: r2v401, types: [java.lang.StringBuilder] */
    ...
    /* JADX WARN: Type inference failed for: r31v0, types: [in.gov.eci.bloapp.views.fragments.checklist.form6.Form6, in.gov.eci.bloapp.views.fragments.checklist.form6.Hilt_Form6] */
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (r14 != 105 || r15 != -1) {
            ...
            r29 = "KB";
            str2 = "/";
            str11 = "Image size exceeded 2MB limit.";
            r11 = "MB";
        } else {
            try {
                        ...
                        try {
                            if (this.filesize >= 1024) {
                                    ...
                                    if (this.filesize > 2048) {
                                        ...
                                        if (dRound2 > 2.0d) {
                                            ...
                                            try {
                                                ...
                                                ?? r16 = obj;
                                                this.binding.annexureDIncludedLayout.after2004selfSize.setText(new StringBuilder().append(dRound2).append(r16).toString());
                                                r13 = r16;
                                                r214 = str14;
                                                str7 = str13;
                                            } catch (Exception e2) {
                                ...
                                try {
                                    ...
                                    String str16 = this.asmblyNO;
                                    String str17 = this.partNo;
                                    String str18 = this.filepathimg;
                                    str2 = "/";
                                    try {
                                        String str19 = this.saveImageFileName;
                                        try {
                                            String str20 = this.token;
                                            obj = "MB";
                                            try {
                                                String str21 = this.referenceNo;
                                                Object obj2 = "ALERT";
                                                try {
                                                    String str22 = this.after2004Str;
                                                    r15 = obj2;
                                                    str9 = "";
                                                    str11 = "Image size exceeded 2MB limit.";
                                                    str10 = TAG;
                                                    str6 = "KB";
                                                    uploadPhoto(str15, str16, str17, str18, str19, str20, str21, str22);
                                                    this.binding.annexureDIncludedLayout.viewLayoutAfter2004self.setVisibility(0);
                                                    this.binding.annexureDIncludedLayout.cancelAfter2004self.setVisibility(0);
                                                    this.binding.annexureDIncludedLayout.after2004selfName.setVisibility(0);
                                                    this.binding.annexureDIncludedLayout.after2004selfSize.setVisibility(0);
                                                    this.binding.annexureDIncludedLayout.imageAfter2004self.setVisibility(0);
                                                    ImageView imageView2 = this.binding.annexureDIncludedLayout.imageAfter2004self;
                                                    byte[] bArr2 = this.pdfbyteArray;
                                                    imageView2.setImageBitmap(BitmapFactory.decodeByteArray(bArr2, 0, bArr2.length));
                                                    this.binding.annexureDIncludedLayout.chooseFileAfter2004Self.setTextColor(Color.parseColor(this.greycolor));
                                                    this.binding.annexureDIncludedLayout.chooseFileAfter2004Self.setEnabled(false);
                                                    this.binding.annexureDIncludedLayout.after2004selfName.setText(strArrSplit2[strArrSplit2.length - 1]);
                                                    this.binding.annexureDIncludedLayout.after2004selfSize.setText(this.filesize + str6);
                                                } catch (Exception e4) {
                                                    str9 = "";
                                                    str11 = "Image size exceeded 2MB limit.";
                                                    str10 = TAG;
                                                ...
                                                if (i == 106) {
                                                    ...
                                                    if (i3 == -1) {
                                                        try {
                                                            ...
                                                            Logger.d(str9, e6.getMessage());
                                                        }
                                                        try {
                                                            saveImagePath = getSaveImagePath(Base64.encodeToString(this.pdfbyteArray, 0), this.img);
                                                            ...
                                                            Logger.d(str3, Arrays.toString(strArrSplit));
                                                            if (this.filesize < 1024) {
                                                                ...
                                                                this.binding.annexureDIncludedLayout.chooseFileAfter2004Father.setEnabled(false);
                                                                this.binding.annexureDIncludedLayout.list3Name.setText(strArrSplit[strArrSplit.length - 1]);
                                                                this.binding.annexureDIncludedLayout.list3Size.setText(new StringBuilder().append(this.filesize).append(r29).toString());
                                                                return;
                                                            }
                                                            if (this.filesize > 2048) {
                                                                this.binding.annexureDIncludedLayout.viewList3.setVisibility(8);
                                                            ...
                                                            this.binding.annexureDIncludedLayout.list3Size.setVisibility(0);
                                                            this.binding.annexureDIncludedLayout.imageList3.setVisibility(0);
                                                            ImageView imageView4 = this.binding.annexureDIncludedLayout.imageList3;
                                                            byte[] bArr4 = this.pdfbyteArray;
                                                            imageView4.setImageBitmap(BitmapFactory.decodeByteArray(bArr4, 0, bArr4.length));
                                                            this.binding.annexureDIncludedLayout.chooseFileAfter2004Father.setTextColor(Color.parseColor(this.greycolor));
                                                            this.binding.annexureDIncludedLayout.chooseFileAfter2004Father.setEnabled(false);
                                                            this.binding.annexureDIncludedLayout.list3Name.setText(strArrSplit[strArrSplit.length - 1]);
                                                            this.binding.annexureDIncludedLayout.list3Size.setText(new StringBuilder().append(dRound).append(r11).toString());
                                                            return;
                                                        } catch (Exception e7) {
                                                            Log.e(str3, e7.toString());
                                                            return;
                                                        }
                                                    }
                                                    r3 = r4;
        ...
        if (i != 107 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit3 = saveImagePath3.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit3));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.list4Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewList4.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileAfter2004Mother.setEnabled(false);
                this.binding.annexureDIncludedLayout.list4Name.setText(strArrSplit3[strArrSplit3.length - 1]);
                this.binding.annexureDIncludedLayout.list4Size.setText(new StringBuilder().append(dRound3).append(r11).toString());
                return;
            } catch (Exception e16) {
                Log.e(str3, e16.toString());
                return;
            }
        }
        if (i != 108 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit4 = saveImagePath4.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit4));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.list5Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewList5.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileAfter2004NotIndian.setEnabled(false);
                this.binding.annexureDIncludedLayout.list5Name.setText(strArrSplit4[strArrSplit4.length - 1]);
                this.binding.annexureDIncludedLayout.list5Size.setText(new StringBuilder().append(dRound4).append(r11).toString());
                return;
            } catch (Exception e18) {
                Log.e(str3, e18.toString());
                return;
            }
        }
        if (i != 109 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit5 = saveImagePath5.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit5));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.list6Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewList6.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileBornOutOfIndia.setEnabled(false);
                this.binding.annexureDIncludedLayout.list6Name.setText(strArrSplit5[strArrSplit5.length - 1]);
                this.binding.annexureDIncludedLayout.list6Size.setText(new StringBuilder().append(dRound5).append(r11).toString());
                return;
            } catch (Exception e20) {
                Log.e(str3, e20.toString());
                return;
            }
        }
        if (i != 110 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit6 = saveImagePath6.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit6));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.list7Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewList7.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileAcquired.setEnabled(false);
                this.binding.annexureDIncludedLayout.list7Name.setText(strArrSplit6[strArrSplit6.length - 1]);
                this.binding.annexureDIncludedLayout.list7Size.setText(new StringBuilder().append(dRound6).append(r11).toString());
                return;
            } catch (Exception e22) {
                Log.e(str3, e22.toString());
                return;
            }
        }
        if (i != 111 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit7 = saveImagePath7.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit7));
                if (this.filesize < 1024) {
                    uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, this.list4Str);
                    this.binding.annexureDIncludedLayout.viewLayoutList2.setVisibility(0);
                    this.binding.annexureDIncludedLayout.cancelList2.setVisibility(0);
                    ...
                    this.binding.annexureDIncludedLayout.list2Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewLayoutList2.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileBefore2004Father.setEnabled(false);
                this.binding.annexureDIncludedLayout.list2Name.setText(strArrSplit7[strArrSplit7.length - 1]);
                this.binding.annexureDIncludedLayout.list2Size.setText(new StringBuilder().append(dRound7).append(r11).toString());
                return;
            } catch (Exception e24) {
                Log.e(str3, e24.toString());
                return;
            }
        }
        if (i != 112 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit8 = saveImagePath8.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit8));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.list1Size.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewLayoutList1.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.chooseFileBefore1987.setEnabled(false);
                this.binding.annexureDIncludedLayout.list1Name.setText(strArrSplit8[strArrSplit8.length - 1]);
                this.binding.annexureDIncludedLayout.list1Size.setText(new StringBuilder().append(dRound8).append(r11).toString());
                return;
        ...
        if (i != 113 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit9 = saveImagePath9.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit9));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.before2004SelfSize.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewLayoutBefore2004Self.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.before2004SelfName.setText(strArrSplit9[strArrSplit9.length - 1]);
                this.binding.annexureDIncludedLayout.before2004SelfSize.setText(new StringBuilder().append(dRound9).append(r11).toString());
                return;
            } catch (Exception e27) {
                Log.e(str3, e27.toString());
                return;
            }
        }
        if (i != 114 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit10 = saveImagePath10.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit10));
                if (this.filesize < 1024) {
                    uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, this.list3Str);
                    this.binding.annexureDIncludedLayout.viewLayoutList2.setVisibility(0);
                    this.binding.annexureDIncludedLayout.cancelList2.setVisibility(0);
                    ...
                    this.binding.annexureDIncludedLayout.list2Size.setVisibility(0);
                    this.binding.annexureDIncludedLayout.imageList2.setVisibility(0);
                    ImageView imageView23 = this.binding.annexureDIncludedLayout.imageList2;
                ...
                this.binding.annexureDIncludedLayout.list2Size.setVisibility(0);
                this.binding.annexureDIncludedLayout.imageList2.setVisibility(0);
                ImageView imageView24 = this.binding.annexureDIncludedLayout.imageList2;
                byte[] bArr24 = this.pdfbyteArray;
                imageView24.setImageBitmap(BitmapFactory.decodeByteArray(bArr24, 0, bArr24.length));
                this.binding.annexureDIncludedLayout.chooseFileBefore2004Father.setTextColor(Color.parseColor(this.greycolor));
                this.binding.annexureDIncludedLayout.chooseFileBefore2004Father.setEnabled(false);
                this.binding.annexureDIncludedLayout.list2Name.setText(strArrSplit10[strArrSplit10.length - 1]);
                this.binding.annexureDIncludedLayout.list2Size.setText(new StringBuilder().append(dRound10).append(r11).toString());
                return;
            } catch (Exception e29) {
                Log.e(str3, e29.toString());
                return;
            }
        }
        if (i != 115 && i3 == -1) {
            ...
            try {
                ...
                String[] strArrSplit11 = saveImagePath11.getPath().split(str2);
                Logger.d(str3, Arrays.toString(strArrSplit11));
                if (this.filesize < 1024) {
                    ...
                    this.binding.annexureDIncludedLayout.signSize.setVisibility(0);
                    this.binding.annexureDIncludedLayout.imageSign.setVisibility(0);
                    ImageView imageView25 = this.binding.annexureDIncludedLayout.imageSign;
                    ...
                    this.binding.annexureDIncludedLayout.signSize.setText(new StringBuilder().append(this.filesize).append(r19).toString());
                    return;
                }
                if (this.filesize > 2048) {
                    this.binding.annexureDIncludedLayout.viewLayoutSign.setVisibility(8);
                ...
                this.binding.annexureDIncludedLayout.signSize.setVisibility(0);
                this.binding.annexureDIncludedLayout.imageSign.setVisibility(0);
                ImageView imageView26 = this.binding.annexureDIncludedLayout.imageSign;
                ...
                Log.e(str3, e31.toString());
                return;
            }
        }
        if (i != 879 && i3 == -1) {
            try {
                Bitmap bitmap14 = MediaStore.Images.Media.getBitmap(requireActivity().getContentResolver(), intent.getData());
                ...
                this.pdfbyteArray = byteArrayOutputStream14.toByteArray();
            } catch (Exception e32) {
                Logger.d(str25, e32.getMessage());
            }
            try {
                String strEncodeToString = Base64.encodeToString(this.pdfbyteArray, 0);
                this.additionalDocumentEncoded = strEncodeToString;
                Uri saveImagePath12 = getSaveImagePath(strEncodeToString, this.img);
                Cursor cursorQuery12 = getContext().getContentResolver().query(saveImagePath12, null, null, null, null);
                if (cursorQuery12.getCount() <= 0) {
                    cursorQuery12.close();
                    throw new IllegalArgumentException(this.imgmsg);
                }
                cursorQuery12.moveToFirst();
                String[] strArrSplit12 = saveImagePath12.getPath().split(str2);
                if (this.filesize < 1024) {
                    uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "AddDoc");
                    double dRound11 = Math.round(this.filesize * 100.0d) / 100.0d;
                    ImageView imageView27 = this.binding.addDocPhoto;
                    byte[] bArr27 = this.pdfbyteArray;
                    imageView27.setImageBitmap(BitmapFactory.decodeByteArray(bArr27, 0, bArr27.length));
                    this.binding.addDocCerti.setVisibility(0);
                    this.binding.addDocChooseFile.setTextColor(Color.parseColor(this.greycolor));
                    this.binding.addDocPhotoname.setText(strArrSplit12[strArrSplit12.length - 1]);
                    this.binding.addDocPhotoname.setVisibility(0);
                    this.binding.addDocSize.setVisibility(0);
                    this.binding.addDocSize.setText(new StringBuilder().append(dRound11).append(r19).toString());
                } else {
                    cursorQuery12.close();
                    if (this.filesize > 2048) {
                        this.binding.addDocCerti.setVisibility(8);
                        showDialog1(r3, str11);
                    } else {
                        uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "AddDoc");
                        this.filesize /= 1024;
                        double dRound12 = Math.round(this.filesize * 100.0d) / 100.0d;
                        this.binding.addDocCerti.setVisibility(0);
                        ImageView imageView28 = this.binding.addDocPhoto;
                        ...
                        this.binding.addDocPhotoname.setVisibility(0);
                        this.binding.addDocSize.setVisibility(0);
                        this.binding.addDocSize.setText(new StringBuilder().append(dRound12).append(r11).toString());
                    }
                }
                cursorQuery12.close();
                return;
            } catch (Exception e33) {
                Logger.d(str25, e33.getMessage());
                return;
            }
        }
        if (i != 880 && i3 == -1) {
            try {
                Bitmap bitmap15 = MediaStore.Images.Media.getBitmap(requireActivity().getContentResolver(), intent.getData());
                ...
                this.pdfbyteArray = byteArrayOutputStream15.toByteArray();
            } catch (Exception e34) {
                Logger.d(str25, e34.getMessage());
            }
            try {
                Uri saveImagePath13 = getSaveImagePath(Base64.encodeToString(this.pdfbyteArray, 0), this.img);
                Cursor cursorQuery13 = getContext().getContentResolver().query(saveImagePath13, null, null, null, null);
                if (cursorQuery13.getCount() <= 0) {
                    cursorQuery13.close();
                    throw new IllegalArgumentException(this.imgmsg);
                }
                cursorQuery13.moveToFirst();
                String[] strArrSplit13 = saveImagePath13.getPath().split(str2);
                if (this.filesize < 1024) {
                    uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "UploadForm6Page1");
                    double dRound13 = Math.round(this.filesize * 100.0d) / 100.0d;
                    ImageView imageView29 = this.binding.uploadDoc1Photo;
                    ...
                    this.binding.uploadDoc1Photoname.setText(strArrSplit13[strArrSplit13.length - 1]);
                    this.binding.uploadDoc1Size.setText(new StringBuilder().append(dRound13).append(r19).toString());
                    ...
                    if (this.filesize > 2048) {
                        ...
                        uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "UploadForm6Page1");
                        this.filesize /= 1024;
                        double dRound14 = Math.round(this.filesize * 100.0d) / 100.0d;
                        this.binding.uploadDoc1Certi.setVisibility(0);
                        ImageView imageView30 = this.binding.uploadDoc1Photo;
                        byte[] bArr30 = this.pdfbyteArray;
                        imageView30.setImageBitmap(BitmapFactory.decodeByteArray(bArr30, 0, bArr30.length));
                        this.binding.uploadDoc1ChooseFile.setTextColor(Color.parseColor(this.greycolor));
                        this.binding.uploadDoc1Photoname.setText(strArrSplit13[strArrSplit13.length - 1]);
                        this.binding.uploadDoc1Size.setText(new StringBuilder().append(dRound14).append(r11).toString());
                        this.binding.uploadDoc1Photo.setVisibility(0);
                        this.binding.uploadDoc1Photoname.setVisibility(0);
                        this.binding.uploadDoc1Size.setVisibility(0);
                        this.binding.uploadDoc1Delete.setVisibility(0);
        ...
        try {
            Bitmap bitmap16 = MediaStore.Images.Media.getBitmap(requireActivity().getContentResolver(), intent.getData());
            ...
            this.pdfbyteArray = byteArrayOutputStream16.toByteArray();
        } catch (Exception e36) {
            Logger.d(str25, e36.getMessage());
        }
        try {
            Uri saveImagePath14 = getSaveImagePath(Base64.encodeToString(this.pdfbyteArray, 0), this.img);
            Cursor cursorQuery14 = getContext().getContentResolver().query(saveImagePath14, null, null, null, null);
            if (cursorQuery14.getCount() <= 0) {
                cursorQuery14.close();
                throw new IllegalArgumentException(this.imgmsg);
            }
            cursorQuery14.moveToFirst();
            String[] strArrSplit14 = saveImagePath14.getPath().split(str2);
            if (this.filesize < 1024) {
                uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "UploadForm6Page2");
                double dRound15 = Math.round(this.filesize * 100.0d) / 100.0d;
                ImageView imageView31 = this.binding.uploadDoc2Photo;
                ...
                this.binding.uploadDoc2Photoname.setText(strArrSplit14[strArrSplit14.length - 1]);
                this.binding.uploadDoc2Size.setText(new StringBuilder().append(dRound15).append(r19).toString());
                ...
                if (this.filesize > 2048) {
                    ...
                    uploadPhoto(this.stateCode, this.asmblyNO, this.partNo, this.filepathimg, this.saveImageFileName, this.token, this.referenceNo, "UploadForm6Page2");
                    this.filesize /= 1024;
                    double dRound16 = Math.round(this.filesize * 100.0d) / 100.0d;
                    this.binding.uploadDoc2Certi.setVisibility(0);
                    ImageView imageView32 = this.binding.uploadDoc2Photo;
                    byte[] bArr32 = this.pdfbyteArray;
                    imageView32.setImageBitmap(BitmapFactory.decodeByteArray(bArr32, 0, bArr32.length));
                    this.binding.uploadDoc2ChooseFile.setTextColor(Color.parseColor(this.greycolor));
                    this.binding.uploadDoc2Photoname.setText(strArrSplit14[strArrSplit14.length - 1]);
                    this.binding.uploadDoc2Size.setText(new StringBuilder().append(dRound16).append(r11).toString());
                    this.binding.uploadDoc2Photo.setVisibility(0);
                    this.binding.uploadDoc2Photoname.setVisibility(0);
                    this.binding.uploadDoc2Size.setVisibility(0);
                    this.binding.uploadDoc2Delete.setVisibility(0);
            ...
            if (this.cat.equals("CAT-2") || this.cat.equals("CAT-3") || this.cat.equals("CAT-4")) {
                ...
                if (this.cat.equalsIgnoreCase("CAT-2")) {
                    ...
                    if (!TextUtils.isEmpty(this.ctDocOfFatherUrl) && !this.ctDocOfFatherUrl.trim().equalsIgnoreCase("null")) {
                        ...
                        this.flagcat3scenerio2 = "Y";
                        this.flagcat3scenerio1 = "N";
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda29
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$setSAnnexureDbData$101();
                            }
                        }, 2500L);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setSAnnexureDbData$101() {
        try {
            getList1(this.list4);
        } catch (Exception e) {
            Logger.d("Form6", e.toString());
    ...
    private void DisplayImage(final String url, final ImageView imageView, final String type) {
        this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), url, new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda38
            @Override // in.gov.eci.bloapp.MyCallback
            public final void onCallback(int i, String str) {
                this.f$0.lambda$DisplayImage$102(type, url, imageView, i, str);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$DisplayImage$102(String str, String str2, ImageView imageView, int i, String str3) {
    ...
    private void initializeSpinnerTouch() {
        this.binding.annexureDIncludedLayout.spinnerBefore2004Self.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.54
        ...
        this.binding.annexureDIncludedLayout.spinnerBefore1987Self.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.55
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerAfter2004Self.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.56
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerBefore2004Father.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.57
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerAfter2004Father.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.58
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerAfter2004Mother.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.59
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerAfter2004NotIndian.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.60
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerBornOutOfIndia.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.61
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
        ...
        this.binding.annexureDIncludedLayout.spinnerAcquired.setOnTouchListener(new View.OnTouchListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.62
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View v, MotionEvent event) {
                Form6.this.isUserSelected = true;
                return false;
    ...
    private void showImageDialog(Bitmap img, String name) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda61
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
    ...
    private void showPersonPdfDialog(String base64elementValue, String pdfNameFromObjectStorage) throws IOException {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda36
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dialog.dismiss();
            }
        ...
        dialog.show();
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda37
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showPersonPdfDialog$105();
            }
        }, 2000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showPersonPdfDialog$105() {
        this.alertDialog.dismiss();
    }
    ...
    private void DisplayImagebundleData(String url, final String filename, final String fileSize, final ImageView imageView, final TextView Filename, final TextView FileSize) {
        ...
        if (url.contains(".jpg") || url.contains(this.jpeg) || url.contains(".png")) {
            this.commonUtilClass.getuploadedfile(getContext(), this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), url, new MyCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda20
                @Override // in.gov.eci.bloapp.MyCallback
                public final void onCallback(int i, String str) {
                    Form6.lambda$DisplayImagebundleData$106(imageView, Filename, filename, FileSize, fileSize, i, str);
                }
            });
            return;
        }
    ...
    static /* synthetic */ void lambda$DisplayImagebundleData$106(ImageView imageView, TextView textView, String str, TextView textView2, String str2, int i, String str3) {
        byte[] bArrDecode = Base64.decode(str3, 0);
        imageView.setImageBitmap(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length));
    ...
    private void getCurrentLocation() {
        if (ActivityCompat.checkSelfPermission(requireContext(), "android.permission.ACCESS_FINE_LOCATION") == 0) {
            if (isGPSEnabled()) {
                LocationServices.getFusedLocationProviderClient(requireContext()).requestLocationUpdates(this.locationRequest, new LocationCallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6.63
    ...
    private void turnOnGPS() {
        ...
        LocationServices.getSettingsClient(requireContext()).checkLocationSettings(builderAddLocationRequest.build()).addOnCompleteListener(new OnCompleteListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda77
            public final void onComplete(Task task) {
                this.f$0.lambda$turnOnGPS$107(task);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$turnOnGPS$107(Task task) {
        try {
    ...
    public void setDeclarationUI() {
        if (Utils.isValideSIRState(this.stateCode)) {
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.radiochooseCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.lvCategoryRadio);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.decformCommonHeader);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.cdDfSelfCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.prevrelativeCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.relationtypecardview);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.removeView(this.binding.declarationSirIncludedLayout.prevBloSignCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.decformCommonHeader);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.radiochooseCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.lvCategoryRadio);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.cdDfSelfCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.prevrelativeCardView);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.relationtypecardview);
            this.binding.declarationSirIncludedLayout.llAnxureDeclaration.addView(this.binding.declarationSirIncludedLayout.prevBloSignCardView);
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void getAdditionalDocumenttype(String list) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", this.token);
        map.put("Content-Type", "application/json");
        map.put("state", this.stateCode);
        ...
        map.put("channelidobo", "BLOAPP");
        HashMap map2 = new HashMap();
        map2.put("lists", "LIST-1");
        ((UserClient) ApiClient.getClient(getActivity()).create(UserClient.class)).getSpecialRevisionList(map, map2).enqueue(new AnonymousClass64(list));
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$64, reason: invalid class name */
    class AnonymousClass64 implements Callback<JsonObject> {
        final /* synthetic */ String val$list;

        AnonymousClass64(final String val$list) {
            this.val$list = val$list;
        }

        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                Form6.this.additionalDocpayloadData1 = (JsonObject) response.body();
                if (Form6.this.additionalDocpayloadData1 != null) {
                    JsonArray asJsonArray = Form6.this.additionalDocpayloadData1.getAsJsonArray("payload");
                    int size = asJsonArray.size();
                    for (int i = 0; i < size; i++) {
                        JsonObject asJsonObject = Form6.this.gson.toJsonTree(asJsonArray.get(i)).getAsJsonObject();
                        if (!String.valueOf(asJsonObject.get("docCode")).replace(RegexMatcher.JSON_STRING_REGEX, "").equalsIgnoreCase("L1D13")) {
                            Form6.this.addDocName.add(String.valueOf(asJsonObject.get("docName")).replace(RegexMatcher.JSON_STRING_REGEX, ""));
                            Form6.this.addDocCode.add(String.valueOf(asJsonObject.get("docCode")).replace(RegexMatcher.JSON_STRING_REGEX, ""));
                            if (!Form6.this.addDocName.contains(Form6.this.selectDocumentType)) {
                                Form6.this.addDocName.add(0, Form6.this.selectDocumentType);
                                Form6.this.addDocCode.add(0, null);
                            }
                            if (!TextUtils.isEmpty(Form6.this.checkListForm6Model.getAddtionalDocType()) && String.valueOf(asJsonObject.get("docCode")).replace(RegexMatcher.JSON_STRING_REGEX, "").equalsIgnoreCase(Form6.this.checkListForm6Model.getAddtionalDocType())) {
                                Form6.this.addDocumentpos = i;
                            }
                        }
                        ArrayAdapter arrayAdapter = new ArrayAdapter((Context) Form6.this.getActivity(), R.layout.blo_spinner_dropdown, (List) Form6.this.addDocName);
                        arrayAdapter.setDropDownViewResource(R.layout.spinner_dropdown_list_item_sir);
                        Form6.this.binding.addDocumentSpinner.setAdapter((SpinnerAdapter) arrayAdapter);
                        if (Form6.this.addDocumentpos == 0) {
                            Form6.this.binding.addDocumentSpinner.setSelection(0);
                        } else {
                            Form6.this.binding.addDocumentSpinner.setSelection(Form6.this.addDocumentpos);
                        }
                    }
                    return;
                }
            ...
            if (response.code() == 401) {
                try {
                    ...
                    String str = Form6.this.refreshToken;
                    final String str2 = this.val$list;
                    commomUtility.getRefreshToken(activity, str, new aadharcallback() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$64$$ExternalSyntheticLambda0
                        @Override // in.gov.eci.bloapp.aadharcallback
            ...
            try {
                ...
                Logger.e(Form6.TAG, e2.getMessage());
            }
        }
        ...
        public /* synthetic */ void lambda$onResponse$1(String str, int i, String str2, String str3) {
            ...
            System.out.println("zxnbchdbvfhvb " + i + StringUtils.SPACE + str2 + StringUtils.SPACE + str3);
            if (i == 401 || i == 400) {
                Form6.this.commomUtility.showMessageOK(Form6.this.getActivity(), Form6.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$64$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        this.f$0.lambda$onResponse$0(dialogInterface, i2);
                    }
            ...
            SharedPref.getInstance(Form6.this.getActivity()).setRefreshToken(str3);
            SharedPref.getInstance(Form6.this.getActivity()).setToken("Bearer " + str2);
            Form6.this.getAdditionalDocumenttype(str);
        }
    ...
    public void deleteAddDoc() {
        this.addDocUrl = "";
        this.checkListForm6Model.setAddtionalDocDln("");
        this.binding.addDocPhotoname.setText("");
        this.binding.addDocSize.setText("");
        this.binding.addDocChooseFile.setEnabled(true);
        this.binding.addDocCerti.setVisibility(8);
        this.binding.addDocChooseFile.setTextColor(Color.parseColor(this.whitecolor));
        this.binding.addDocChooseFile.setVisibility(0);
    }

    public void deleteuploadDocPage1() {
        this.uploadForm6Page1Url = "";
        this.checkListForm6Model.setOfflineSignedPage1Url("");
    ...
    public void deleteuploadDocPage2() {
        this.uploadForm6Page2Url = "";
        this.checkListForm6Model.setOfflineSignedPage2Url("");
    ...
    public void selectImage4() {
        ...
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda28
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$selectImage4$108(charSequenceArr, dialogInterface, i);
            }
        });
        builder.show();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$selectImage4$108(CharSequence[] charSequenceArr, DialogInterface dialogInterface, int i) {
        if (charSequenceArr[i].equals(this.takephoto)) {
            this.alertDialog.show();
            ImagePicker.with(this).crop().compress(512).cameraOnly().start(879);
        } else if (charSequenceArr[i].equals(this.choosegallery)) {
            this.alertDialog.show();
            ImagePicker.with(this).crop().compress(512).galleryOnly().start(879);
    ...
    public void selectImage5() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(getContext());
        builder.setTitle(this.addphoto);
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda47
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$selectImage5$109(charSequenceArr, dialogInterface, i);
            }
        });
        builder.show();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$selectImage5$109(CharSequence[] charSequenceArr, DialogInterface dialogInterface, int i) {
        if (charSequenceArr[i].equals(this.takephoto)) {
            this.alertDialog.show();
    ...
    public void selectImage6() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(getContext());
        builder.setTitle(this.addphoto);
        builder.setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.checklist.form6.Form6$$ExternalSyntheticLambda34
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$selectImage6$110(charSequenceArr, dialogInterface, i);
            }
        });
        builder.show();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$selectImage6$110(CharSequence[] charSequenceArr, DialogInterface dialogInterface, int i) {
        if (charSequenceArr[i].equals(this.takephoto)) {
            this.alertDialog.show();
    ...
    public void openfile4() {
        ...
        intent.setType("*/*");
        intent.putExtra("android.intent.extra.MIME_TYPES", strArr);
        this.activityResultLauncher470.launch(Intent.createChooser(intent, this.chooseFile));
    }
}
