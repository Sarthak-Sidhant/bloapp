...
public final class DseVerificationItemBinding implements ViewBinding {
    ...
    public static DseVerificationItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static DseVerificationItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.dse_verification_item, parent, false);
        if (attachToParent) {
    ...
    public static DseVerificationItemBinding bind(View rootView) {
        int i = R.id.acName;
                    ...
                    if (textView3 != null) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                ...
                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.fill_form_dseVerified);
                                if (textView6 != null) {
                                    i = R.id.ll_deceased;
                                        ...
                                        if (linearLayout3 != null) {
                                            ...
                                            if (linearLayout4 != null) {
                                                ...
                                                if (linearLayout5 != null) {
                                                    i = R.id.noAction;
                                                    TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.noAction);
                                                    if (textView7 != null) {
                                                        i = R.id.partNo;
                                                        TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.partNo);
                                                        if (textView8 != null) {
                                                            i = R.id.serialNo;
                                                            TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.serialNo);
                                                            if (textView9 != null) {
                                                                i = R.id.state;
                                                                TextView textView10 = (TextView) ViewBindings.findChildViewById(rootView, R.id.state);
                                                                if (textView10 != null) {
                                                                    i = R.id.tv_asd;
                                                                    TextView textView11 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_asd);
                                                                    if (textView11 != null) {
                                                                        i = R.id.tv_clusterid;
                                                                        TextView textView12 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_clusterid);
                                                                        if (textView12 != null) {
                                                                            i = R.id.view_details_elector;
                                                                            TextView textView13 = (TextView) ViewBindings.findChildViewById(rootView, R.id.view_details_elector);
                                                                            if (textView13 != null) {
                                                                                return new DseVerificationItemBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, textView6, linearLayout2, linearLayout3, linearLayout4, linearLayout5, textView7, textView8, textView9, textView10, textView11, textView12, textView13);
                                                                            }
                                                                        }
                                                                    }
                                                                }
