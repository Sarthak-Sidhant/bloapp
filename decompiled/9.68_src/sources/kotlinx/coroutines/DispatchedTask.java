...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        Object objM5265constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m5265constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m5265constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    objM5265constructorimpl2 = Result.m5265constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM5265constructorimpl2 = Result.m5265constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException$kotlinx_coroutines_core(null, Result.m5268exceptionOrNullimpl(objM5265constructorimpl2));
            } catch (Throwable th2) {
                if (undispatchedCoroutineUpdateUndispatchedCompletion == null || undispatchedCoroutineUpdateUndispatchedCompletion.clearThreadContext()) {
                    ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                }
            ...
            try {
                ...
                objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException$kotlinx_coroutines_core(th3, Result.m5268exceptionOrNullimpl(objM5265constructorimpl));
        }
    }
