...
public final class MainRepository_Factory implements Factory<MainRepository> {
    ...
    public MainRepository m606get() {
        MainRepository mainRepositoryNewInstance = newInstance((ApiInterface) this.apiInterfaceProvider.get());
        MainRepository_MembersInjector.injectDbHandler(mainRepositoryNewInstance, (DatabaseHelper) this.dbHandlerProvider.get());
        MainRepository_MembersInjector.injectEciDatabase(mainRepositoryNewInstance, (EciDatabase) this.eciDatabaseProvider.get());
