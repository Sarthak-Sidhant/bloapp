...
public class ApplicantEpicDTO {
    public String applicantFirstName;
    public String applicantLastName;
    public int assemblyConstituencyNumber;
    ...
    public String tehsilTalukaMandal;
    ...
    public int getAssemblyConstituencyNumber() {
        return this.assemblyConstituencyNumber;
    }

    public void setAssemblyConstituencyNumber(int assemblyConstituencyNumber) {
