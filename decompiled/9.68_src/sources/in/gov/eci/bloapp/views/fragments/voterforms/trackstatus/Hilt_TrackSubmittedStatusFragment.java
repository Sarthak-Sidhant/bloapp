...
abstract class Hilt_TrackSubmittedStatusFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_TrackSubmittedStatusFragment() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_TrackSubmittedStatusFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((TrackSubmittedStatusFragment_GeneratedInjector) generatedComponent()).injectTrackSubmittedStatusFragment((TrackSubmittedStatusFragment) UnsafeCasts.unsafeCast(this));
    }
