    ...
    public YouTubePlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        AbstractYouTubePlayerListener abstractYouTubePlayerListener = new AbstractYouTubePlayerListener() { // from class: com.pierfrancescosoffritti.androidyoutubeplayer.core.player.views.YouTubePlayerView$youTubePlayerListener$1
            ...
            public void onReady(YouTubePlayer youTubePlayer) {
                ...
                String str = string;
                if (str != null) {
                    YouTubePlayerUtils.loadOrCueVideo(youTubePlayer, this.legacyTubePlayerView.getCanPlay() && z, str, CropImageView.DEFAULT_ASPECT_RATIO);
                }
                youTubePlayer.removeListener(this);
            }
        };
        if (this.enableAutomaticInitialization) {
            legacyYouTubePlayerView.initialize(abstractYouTubePlayerListener, z2, IFramePlayerOptions.INSTANCE.getDefault(context), string);
        }
    }
