...
public final class UByteSerializer implements KSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UByte.m5277boximpl(m6855deserializeWa3L5BU(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m6856serializeEK6454(encoder, ((UByte) obj).getData());
    }
    ...
    public void m6856serializeEK6454(Encoder encoder, byte value) {
    ...
    public byte m6855deserializeWa3L5BU(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UByte.m5283constructorimpl(decoder.decodeInline(getDescriptor()).decodeByte());
    }
}
