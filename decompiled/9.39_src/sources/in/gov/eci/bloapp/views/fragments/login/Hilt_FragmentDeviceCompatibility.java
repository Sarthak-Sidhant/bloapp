...
abstract class Hilt_FragmentDeviceCompatibility extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_FragmentDeviceCompatibility() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FragmentDeviceCompatibility_GeneratedInjector) generatedComponent()).injectFragmentDeviceCompatibility((FragmentDeviceCompatibility) UnsafeCasts.unsafeCast(this));
    }
