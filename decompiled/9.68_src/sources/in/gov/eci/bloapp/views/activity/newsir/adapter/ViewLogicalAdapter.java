...
public class ViewLogicalAdapter extends RecyclerView.Adapter<holder> {
    List<VerifyPayload> al;
    private Context context;
    List<VerifyPayload> filteredAl;
    AnomalyItemClickCallback itemClickCallback;

    public ViewLogicalAdapter(List<VerifyPayload> al, Context context, AnomalyItemClickCallback itemClickCallback) {
        this.al = al;
    ...
    public void onBindViewHolder(final holder holder2, int i) {
        ...
        holder2.viewDetails.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.adapter.ViewLogicalAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int adapterPosition = holder2.getAdapterPosition();
                ViewLogicalAdapter.this.itemClickCallback.onClicked(ViewLogicalAdapter.this.al.get(adapterPosition), adapterPosition + "");
            }
        });
    }
