...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public interface Logger {
        ...
        /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
        @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\u0005B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004ø\u0001\u0000¢\u0006\u0002\n\u0000¨\u0006\u0001\u0082\u0002\u0007\n\u0005\b\u0091F0\u0001¨\u0006\u0006"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger$Companion;", "", "()V", "DEFAULT", "Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "DefaultLogger", "okhttp-logging-interceptor"}, k = 1, mv = {1, 4, 1})
        public static final class Companion {
            ...
            /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
            @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger$Companion$DefaultLogger;", "Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "()V", "log", "", "message", "", "okhttp-logging-interceptor"}, k = 1, mv = {1, 4, 1})
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        String str2 = "--> " + request.method() + ' ' + request.url() + (connection != null ? StringUtils.SPACE + connection.protocol() : "");
        ...
        try {
            ...
            long jContentLength = responseBodyBody.get$contentLength();
            ...
            if (responseProceed.message().length() == 0) {
                ...
                c = ' ';
                str = String.valueOf(' ') + responseProceed.message();
            }
            logger.log(sbAppend.append(str).append(c).append(responseProceed.request().url()).append(" (").append(millis).append("ms").append(!z2 ? ", " + str3 + " body" : "").append(')').toString());
            if (z2) {
