...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = ((j - ((long) CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION)) / ((long) 1000)) + " µs";
        } else if (j >= 999500) {
            str = j < ((long) 999500000) ? ((j + ((long) 500000)) / ((long) 1000000)) + " ms" : ((j + ((long) 500000000)) / ((long) Http2Connection.DEGRADED_PONG_TIMEOUT_NS)) + " s ";
        } else {
            str = ((j + ((long) CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION)) / ((long) 1000)) + " µs";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
