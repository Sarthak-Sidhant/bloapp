...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    static final class ParallelReduceFullMainSubscriber<T> extends DeferredScalarSubscription<T> {
        ...
        SlotPair<T> addValue(T t) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.current, (Object) null, slotPair)) {
                        continue;
                    }
                }
                ...
                PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.current, slotPair, (Object) null);
            }
            if (iTryAcquireSlot == 0) {
                slotPair.first = t;
            } else {
        ...
        void innerError(Throwable th) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.error, (Object) null, th)) {
                cancel();
