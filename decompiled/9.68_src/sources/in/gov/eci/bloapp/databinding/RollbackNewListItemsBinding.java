...
public final class RollbackNewListItemsBinding implements ViewBinding {
    ...
    private RollbackNewListItemsBinding(LinearLayout rootView, TextView electorNamePendingSir, TextView epicPendingSir, TextView fillPendingSir, TextView remarks, TextView serialNoPendingSir, TextView uncollectablePendingSir) {
    ...
    public static RollbackNewListItemsBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RollbackNewListItemsBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.rollback_new_list_items, parent, false);
        if (attachToParent) {
    ...
    public static RollbackNewListItemsBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (textView6 != null) {
                                return new RollbackNewListItemsBinding((LinearLayout) rootView, textView, textView2, textView3, textView4, textView5, textView6);
                            }
                        }
                    }
                }
