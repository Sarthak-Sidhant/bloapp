...
public class Utils {
    ...
    public void infoDialog(Context context, String alertText, String message, final OkCallback okCallback) {
        if (context instanceof Activity) {
            Activity activity = (Activity) context;
            if (activity.isFinishing() || activity.isDestroyed()) {
                return;
            }
            new AlertDialog.Builder(context).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(context.getResources().getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.utils.Utils$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    Utils.lambda$infoDialog$0(okCallback, dialogInterface, i);
                }
            }).create().show();
        }
    }

    static /* synthetic */ void lambda$infoDialog$0(OkCallback okCallback, DialogInterface dialogInterface, int i) {
        okCallback.onPositiveButtonClicked();
    ...
    public void decisionDialog(Context context, String title, String message, String positiveButtonName, String NegativeButtonName, final DecisionDialogCallback decisionDialogCallback) {
        new AlertDialog.Builder(context).setTitle(title).setMessage(message).setCancelable(false).setPositiveButton(positiveButtonName, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.utils.Utils$$ExternalSyntheticLambda3
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                Utils.lambda$decisionDialog$2(decisionDialogCallback, dialogInterface, i);
            }
        }).setNegativeButton(NegativeButtonName, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.utils.Utils$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                Utils.lambda$decisionDialog$3(decisionDialogCallback, dialogInterface, i);
            }
        }).create().show();
    }
    ...
    static /* synthetic */ void lambda$decisionDialog$3(DecisionDialogCallback decisionDialogCallback, DialogInterface dialogInterface, int i) {
    ...
    public void infoDialogAction(Context context, String alertText, String message, final DecisionDialogCallback decisionDialogCallback) {
        if (context instanceof Activity) {
            ...
            new AlertDialog.Builder(context).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(context.getResources().getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.utils.Utils$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    Utils.lambda$infoDialogAction$4(decisionDialogCallback, dialogInterface, i);
                }
            }).create().show();
        }
    }

    static /* synthetic */ void lambda$infoDialogAction$4(DecisionDialogCallback decisionDialogCallback, DialogInterface dialogInterface, int i) {
        dialogInterface.dismiss();
        decisionDialogCallback.onPositiveButtonClicked();
    }
