...
public final class ActivityEpicDeliveryListBinding implements ViewBinding {
    ...
    private ActivityEpicDeliveryListBinding(LinearLayout rootView, ImageView IvScanCode, ImageView backBtnIv, ConstraintLayout blaTopLayout, Button btScanCode, FrameLayout fragmentContainer, LinearLayout main, TextView noteOpen, RecyclerView recyclerView, ConstraintLayout scanCode, EditText search, Spinner spinner, TextView textView3, TextView textView5, ImageView toolbarButton) {
    ...
    public static ActivityEpicDeliveryListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityEpicDeliveryListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_epic_delivery_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityEpicDeliveryListBinding bind(View rootView) {
                                            ...
                                            if (spinner != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (imageView3 != null) {
                                                            return new ActivityEpicDeliveryListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, frameLayout, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                        }
                                                    }
                                                }
                                            }
