...
import in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapterBH;
...
public class RollBAckNewFormsEroBH extends SuperBaseActivity {
    private static final int REQUEST_CODE_CAMERA_PORTRAIT = 1221;
    private String acNo;
    RollbackNewFormEroAdapterBH adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.adapter = new RollbackNewFormEroAdapterBH(this.rollBackSearchList, this);
    ...
    private void getAllRollBackNew() {
        ...
        Call<JsonObject> uncollectableRollBackForms = this.service.getUncollectableRollBackForms(map, map2);
        this.alertDialog.show();
        uncollectableRollBackForms.enqueue(new AnonymousClass1());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH$1, reason: invalid class name */
    class AnonymousClass1 implements Callback<JsonObject> {
        AnonymousClass1() {
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r2v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH] */
            ...
            try {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        RollBAckNewFormsEroBH.this.rollBackNewList.add(new RollbackNewModel(jSONObject.optString("electorName", null), strOptString, 0L, jSONObject.optString("partSerialNo", null), jSONObject.optString("backToBloRemarks", null), jSONObject.optString("efFrontUrl", ""), jSONObject.optString("efBackUrl", ""), jSONObject.optString("suppDoc1Url", ""), jSONObject.optString("suppDoc2Url", ""), jSONObject.optString("uncollectableReason", ""), jSONObject.optString("enrolledEpicNo", "")));
                    }
                    RollBAckNewFormsEroBH.this.rollBackSearchList.addAll(RollBAckNewFormsEroBH.this.rollBackNewList);
                    RollBAckNewFormsEroBH.this.binding.recyclerView.setAdapter(RollBAckNewFormsEroBH.this.adapter);
                    RollBAckNewFormsEroBH.this.alertDialog.dismiss();
                    RollBAckNewFormsEroBH.this.binding.search.addTextChangedListener(new TextWatcher() { // from class: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH.1.1
                        ...
                        public void afterTextChanged(Editable editable) {
                            ...
                            for (RollbackNewModel rollbackNewModel : RollBAckNewFormsEroBH.this.rollBackSearchList) {
                                if (rollbackNewModel.getEpicNo().toLowerCase().contains(string.toLowerCase())) {
                                    arrayList.add(rollbackNewModel);
                                }
                            }
                            RollBAckNewFormsEroBH.this.adapter.fun(arrayList);
                        }
                    });
                    return;
                }
                if (response.code() == 400 || response.code() == 401) {
                    if (RollBAckNewFormsEroBH.this.alertDialog != null) {
                        RollBAckNewFormsEroBH.this.alertDialog.dismiss();
                    }
                    CommomUtility commomUtility = RollBAckNewFormsEroBH.this.commomUtility;
                    ?? r2 = RollBAckNewFormsEroBH.this;
                    commomUtility.showMessageOK(r2, r2.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH$1$$ExternalSyntheticLambda0
                ...
                try {
                    ...
                    RollBAckNewFormsEroBH rollBAckNewFormsEroBH = RollBAckNewFormsEroBH.this;
                    rollBAckNewFormsEroBH.showDialog1(rollBAckNewFormsEroBH.getString(R.string.alertMsg), strOptString2);
        ...
        public /* synthetic */ void lambda$onResponse$0(DialogInterface dialogInterface, int i) {
            SharedPref.getInstance(RollBAckNewFormsEroBH.this.getApplicationContext()).setIsLoggedIn(false);
            SharedPref.getInstance(RollBAckNewFormsEroBH.this.getApplicationContext()).setLocaleBool(false);
            RollBAckNewFormsEroBH.this.startActivity(new Intent(RollBAckNewFormsEroBH.this.getApplicationContext(), (Class<?>) LoginActivity.class));
        }
    ...
    private void initClickListener() {
        this.binding.backBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initClickListener$0(view);
            }
        });
        this.binding.scanCode.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                RollBAckNewFormsEroBH.this.cameraPermission();
            }
        });
    }
    ...
    public void showDialog1(String alertText, String message) {
        ...
        new android.app.AlertDialog.Builder(this).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.SIRBH.RollBAckNewFormsEroBH$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
