...
public class EfTrackerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        Log.d("CheckingEFTRACKEr", efTrackerListModel.getIsDelivered() + " " + efTrackerListModel.getIsUncollectable() + " " + efTrackerListModel.getIsCollected());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void alertDialog_ef(String oldName, String epicNumber, String oldRelativeFullName, String relationType, String partNumber, String partName, String acNo1, String acName, String stateName) {
