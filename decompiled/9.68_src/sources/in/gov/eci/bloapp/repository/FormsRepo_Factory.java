...
public final class FormsRepo_Factory implements Factory<FormsRepo> {
    ...
    public FormsRepo get() {
        FormsRepo formsRepoNewInstance = newInstance(this.apiInterfaceProvider.get());
        FormsRepo_MembersInjector.injectDbHandler(formsRepoNewInstance, this.dbHandlerProvider.get());
        FormsRepo_MembersInjector.injectEciDatabase(formsRepoNewInstance, this.eciDatabaseProvider.get());
