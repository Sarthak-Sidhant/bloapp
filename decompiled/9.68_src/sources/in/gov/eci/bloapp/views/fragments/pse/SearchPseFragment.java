...
public class SearchPseFragment extends BaseFragment {
    ...
    class AnonymousClass3 implements FilterableRecyclerView.FilterGenericRecyclerAdapterInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            ((BloFormataPendingRvItemBinding) holder.binding).applicantName.setText(((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantFirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantLastname());
            ...
            final String str = ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantFirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantLastname();
            final String str2 = ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getRelationfirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getRelationlastname();
    ...
    public void bottomSheet(String name, String epicno, final String pseId, String partno, String gender, String rlnName, String rlnType, String address12, String acno, String dateofinclusion, String photo, Bitmap dummyimg, String clusterId) {
        ...
        ((UserClient) ApiClient.getClient2(requireContext()).create(UserClient.class)).getaddressDetailsPse(this.token, SharedPref.getInstance(requireContext()).getAtknBnd(), SharedPref.getInstance(requireContext()).getRtknBnd(), "BLOAPP", "blo", this.blostatecode, APPLICATION_JSON, "ANDROIDMOB", map).enqueue(new AnonymousClass5());
    ...
    class AnonymousClass7 implements FilterableRecyclerView.FilterGenericRecyclerAdapterInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            ((BloForm8generatedRvItemBinding) holder.binding).applicantName.setText(((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantFirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) SearchPseFragment.this.mSearchList.get(position)).getApplicantLastname());
