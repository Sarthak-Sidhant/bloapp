...
public class Conversion {
    ...
    public static char binaryBeMsb0ToHexDigit(boolean[] zArr, int i) {
        if (Integer.compareUnsigned(i, zArr.length) >= 0) {
            if (zArr.length == 0) {
                throw new IllegalArgumentException("Cannot convert an empty array.");
            }
    ...
    public static int shortArrayToInt(short[] sArr, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = (i5 * 16) + i3;
            i2 = (i2 & (~(Settings.DEFAULT_INITIAL_WINDOW_SIZE << i6))) | ((sArr[i5 + i] & UShort.MAX_VALUE) << i6);
        }
        return i2;
    }
    ...
    public static int byteArrayToInt(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = (i5 * 8) + i3;
            i2 = (i2 & (~(KotlinVersion.MAX_COMPONENT_VALUE << i6))) | ((bArr[i5 + i] & KotlinVersion.MAX_COMPONENT_VALUE) << i6);
        }
        return i2;
    }
    ...
    public static short byteArrayToShort(byte[] bArr, int i, short s, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            int i5 = (i4 * 8) + i2;
            s = (short) ((s & (~(KotlinVersion.MAX_COMPONENT_VALUE << i5))) | ((bArr[i4 + i] & KotlinVersion.MAX_COMPONENT_VALUE) << i5));
        }
        return s;
    }
    ...
    public static byte[] intToByteArray(int i, int i2, byte[] bArr, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            bArr[i3 + i5] = (byte) ((i >> ((i5 * 8) + i2)) & KotlinVersion.MAX_COMPONENT_VALUE);
        }
        return bArr;
    }
    ...
    public static byte[] shortToByteArray(short s, int i, byte[] bArr, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            bArr[i2 + i4] = (byte) ((s >> ((i4 * 8) + i)) & KotlinVersion.MAX_COMPONENT_VALUE);
        }
        return bArr;
    }
