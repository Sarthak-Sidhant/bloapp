...
public final class FutureSingleObserver<T> extends CountDownLatch implements SingleObserver<T>, Future<T>, Disposable {
    ...
    public boolean cancel(boolean z) {
        ...
        } while (!PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.upstream, disposableHelper, DisposableHelper.DISPOSED));
    ...
    public void onSuccess(T t) {
        ...
        this.value = t;
        PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.upstream, disposableHelper, this);
        countDown();
    }
    ...
    public void onError(Throwable th) {
        ...
        do {
            ...
            this.error = th;
        } while (!PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.upstream, disposableHelper, this));
        countDown();
    }
