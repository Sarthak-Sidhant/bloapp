...
public final class BloTotalListRvItemBinding implements ViewBinding {
    ...
    public static BloTotalListRvItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloTotalListRvItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_total_list_rv_item, parent, false);
        if (attachToParent) {
    ...
    public static BloTotalListRvItemBinding bind(View rootView) {
                                                        ...
                                                        if (textView12 != null) {
                                                            ...
                                                            if (textView13 != null) {
                                                                ...
                                                                if (viewFindChildViewById != null) {
                                                                    return new BloTotalListRvItemBinding((ConstraintLayout) rootView, textView, textView2, textView3, textView4, textView5, textView6, textView7, constraintLayoutFindChildViewById, textView8, textView9, textView10, textView11, textView12, textView13, viewFindChildViewById);
                                                                }
                                                            }
                                                        }
                                                    }
