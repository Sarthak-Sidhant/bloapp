...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01333<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C01333(Continuation<? super C01333> continuation) {
            super(continuation);
        }
    ...
    static final class C01341<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01391<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) {
        ...
        if (continuation instanceof C01391) {
            ...
            if ((c01391.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01391.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c01402 = new C01402<>(objectRef2, function3);
            c01391.L$0 = objectRef2;
            c01391.label = 1;
            if (flow.collect(c01402, c01391) == coroutine_suspended) {
    ...
    static final class C01402<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C01402(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) {
        ...
        if (continuation instanceof C01341) {
            ...
            if ((c01341.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01341.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            c01341.L$0 = objectRef2;
            c01341.label = 1;
            if (flow.collect(anonymousClass2, c01341) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01341.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C01411) {
            ...
            if ((c01411.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01411.label -= IntCompanionObject.MIN_VALUE;
            } else {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C01431) {
            ...
            if ((c01431.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01431.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c01431.L$1 = flowCollector2;
                c01431.label = 1;
                if (flow.collect(flowCollector2, c01431) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c01431.L$1;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C01321) {
            ...
            if ((c01321.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01321.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            try {
                c01321.L$0 = objectRef2;
                c01321.L$1 = flowCollector2;
                c01321.label = 1;
                if (flow.collect(flowCollector2, c01321) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c01321.L$1;
            objectRef = (Ref.ObjectRef) c01321.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C01333) {
            c01333 = (C01333) continuation;
            if ((c01333.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01333.label -= IntCompanionObject.MIN_VALUE;
            } else {
                c01333 = new C01333(continuation);
            }
        } else {
            c01333 = new C01333(continuation);
        }
        Object obj = c01333.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01333.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c01333.L$0 = objectRef2;
                c01333.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c01333.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c01333) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c01333.L$1;
            objectRef = (Ref.ObjectRef) c01333.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C01351) {
            ...
            if ((c01351.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01351.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            c01351.L$0 = objectRef2;
            c01351.label = 1;
            if (flow.collect(flowCollector, c01351) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01351.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (continuation instanceof C01371) {
            ...
            if ((c01371.label & IntCompanionObject.MIN_VALUE) != 0) {
                c01371.label -= IntCompanionObject.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            c01371.L$0 = objectRef2;
            c01371.label = 1;
            if (flow.collect(flowCollector, c01371) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01371.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
