...
public class FomatC7DetailsActivity extends SuperBaseActivity {
    ...
    public void setElectorDetails(Root formlist) {
        this.binding.electorNameTv1.setText((!TextUtils.isEmpty(formlist.getElectorEpicDTO().getApplicantFirstName()) ? formlist.getElectorEpicDTO().getApplicantFirstName() : "") + " " + (!TextUtils.isEmpty(formlist.getElectorEpicDTO().getApplicantLastName()) ? formlist.getElectorEpicDTO().getApplicantLastName() : ""));
    ...
    public void setApplicantDetails(Root formlist) {
        this.binding.applicantNameTv1.setText((!TextUtils.isEmpty(formlist.getApplicantEpicDto().getApplicantFirstName()) ? formlist.getApplicantEpicDto().getApplicantFirstName() : "") + " " + (!TextUtils.isEmpty(formlist.getApplicantEpicDto().getApplicantLastName()) ? formlist.getApplicantEpicDto().getApplicantLastName() : ""));
