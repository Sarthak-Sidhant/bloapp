                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (imageView3 != null) {
                                                        return new ActivityEfTrackerBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, textView3, imageView3);
                                                    }
                                                }
                                            }
                                        }
