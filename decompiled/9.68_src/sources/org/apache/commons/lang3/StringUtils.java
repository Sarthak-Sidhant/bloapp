...
public class StringUtils {
    ...
    public static String join(Iterator<?> it, char c) {
        ...
        return !it.hasNext() ? "" : (String) org.apache.commons.lang3.stream.Streams.of(it).collect(LangCollectors.joining(toStringOrEmpty(String.valueOf(c)), "", "", new StringUtils$$ExternalSyntheticLambda1()));
    }
    ...
    public static String join(Iterator<?> it, String str) {
        ...
        return !it.hasNext() ? "" : (String) org.apache.commons.lang3.stream.Streams.of(it).collect(LangCollectors.joining(toStringOrEmpty(str), "", "", new StringUtils$$ExternalSyntheticLambda1()));
    }
    ...
    public static String[] stripAll(final String[] strArr, final String str) {
        ...
        Arrays.setAll(strArr2, new IntFunction() { // from class: org.apache.commons.lang3.StringUtils$$ExternalSyntheticLambda0
