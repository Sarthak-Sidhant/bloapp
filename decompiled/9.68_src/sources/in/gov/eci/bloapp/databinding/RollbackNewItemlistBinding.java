...
public final class RollbackNewItemlistBinding implements ViewBinding {
    ...
    private RollbackNewItemlistBinding(LinearLayout rootView, TextView electorNamePendingSir, TextView epicPendingSir, TextView fillPendingSir, TextView serialNoPendingSir, TextView uncollectablePendingSir) {
    ...
    public static RollbackNewItemlistBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RollbackNewItemlistBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.rollback_new_itemlist, parent, false);
        if (attachToParent) {
    ...
    public static RollbackNewItemlistBinding bind(View rootView) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            return new RollbackNewItemlistBinding((LinearLayout) rootView, textView, textView2, textView3, textView4, textView5);
                        }
                    }
                }
            }
