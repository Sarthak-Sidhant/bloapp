...
import in.gov.eci.bloapp.databinding.BloFragmentDseIdentifiedBinding;
...
public class DseIdentifiedFragment extends Fragment {
    ...
    BloFragmentDseIdentifiedBinding binding;
    private final String[] tabs = {"DSE within Part", "DSE across Part", "DSE across AC"};
    Bundle bundle = new Bundle();

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.binding = BloFragmentDseIdentifiedBinding.inflate(getLayoutInflater());
        ...
        this.binding.homeBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.dse.generateform8.DseIdentifiedFragment$$ExternalSyntheticLambda1
    ...
    private void initClickListener() {
        this.binding.backBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.dse.generateform8.DseIdentifiedFragment$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void initViewPagerAndTagLayout() {
        ...
        new TabLayoutMediator(this.binding.tabLayout, this.binding.viewPager, new TabLayoutMediator.TabConfigurationStrategy() { // from class: in.gov.eci.bloapp.views.fragments.dse.generateform8.DseIdentifiedFragment$$ExternalSyntheticLambda2
