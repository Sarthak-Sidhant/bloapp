...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupAppBar() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(toolbarFindViewById, new OnApplyWindowInsetsListener() { // from class: com.yalantis.ucrop.UCropActivity$$ExternalSyntheticLambda0
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return UCropActivity.lambda$setupAppBar$1(view, windowInsetsCompat);
            }
        });
        toolbarFindViewById.setBackgroundColor(this.mToolbarColor);
        toolbarFindViewById.setTitleTextColor(this.mToolbarWidgetColor);
        TextView textView = (TextView) toolbarFindViewById.findViewById(R.id.toolbar_title);
        ...
        toolbarFindViewById.setNavigationIcon(drawableMutate);
