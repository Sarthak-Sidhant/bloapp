                    ...
                    if (textView3 != null) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (linearLayout2 != null) {
                                ...
                                if (textView5 != null) {
                                    i = 2131364119;
                                    ImageView imageView = (ImageView) ViewBindings.findChildViewById(rootView, 2131364119);
                                    if (imageView != null) {
                                        i = R.id.imageView9;
                                        ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.imageView9);
                                        if (imageView2 != null) {
                                            i = 2131364291;
                                            LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(rootView, 2131364291);
