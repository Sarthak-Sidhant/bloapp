                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            if (textView41 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                if (textView42 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                    if (linearLayout12 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                        if (textView43 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                            i = R.id.view4;
                                                                                                                                                                                                                                                                                                                                                                                                            View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.view4);
                                                                                                                                                                                                                                                                                                                                                                                                            if (viewFindChildViewById != null) {
                                                                                                                                                                                                                                                                                                                                                                                                                i = R.id.view_spinner1;
                                                                                                                                                                                                                                                                                                                                                                                                                View viewFindChildViewById2 = ViewBindings.findChildViewById(rootView, R.id.view_spinner1);
                                                                                                                                                                                                                                                                                                                                                                                                                if (viewFindChildViewById2 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                                    i = R.id.view_spinner2;
                                                                                                                                                                                                                                                                                                                                                                                                                    View viewFindChildViewById3 = ViewBindings.findChildViewById(rootView, R.id.view_spinner2);
                                                                                                                                                                                                                                                                                                                                                                                                                    if (viewFindChildViewById3 != null) {
                                                                                                                                                                                                                                                                                                                                                                                                                        i = R.id.view_spinner3;
                                                                                                                                                                                                                                                                                                                                                                                                                        View viewFindChildViewById4 = ViewBindings.findChildViewById(rootView, R.id.view_spinner3);
