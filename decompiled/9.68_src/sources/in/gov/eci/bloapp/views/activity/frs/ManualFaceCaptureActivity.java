...
public final class ManualFaceCaptureActivity extends AppCompatActivity {
    ...
    /* synthetic */ class AnonymousClass1 implements FaceCaptureListener, FunctionAdapter {
        ...
        public final void onFaceCaptureResult(FaceCaptureResult p0) {
            ...
            ManualFaceCaptureActivity.this.onFaceCaptureResult(p0);
        }
    }
    ...
    public final void onFaceCaptureResult(FaceCaptureResult result) {
    ...
    private final void handleInvalidFace(FaceCaptureInvalid cause) {
        int i;
        ActivityManualFaceCaptureBinding activityManualFaceCaptureBinding = this.binding;
        if (activityManualFaceCaptureBinding == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
        ...
        Button manualCaptureButton = activityManualFaceCaptureBinding.manualCaptureButton;
        Intrinsics.checkNotNullExpressionValue(manualCaptureButton, "manualCaptureButton");
        manualCaptureButton.setVisibility(4);
    ...
    static final class C00601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C00601(byte[] bArr, Continuation<? super C00601> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ManualFaceCaptureActivity.this.new C00601(this.$image, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            this.L$0 = imageView;
            this.label = 1;
            obj = new ByteArrayToBitmapConverter((CoroutineDispatcher) null, 1, (DefaultConstructorMarker) null).convert(this.$image, this);
            ...
            this.label = 2;
            Object objConvert = new ByteArrayToBitmapConverter((CoroutineDispatcher) null, 1, (DefaultConstructorMarker) null).convert(this.$image, this);
    ...
    private final void setValidImageAsResult(byte[] image) {
        ActivityManualFaceCaptureBinding activityManualFaceCaptureBinding = null;
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope((LifecycleOwner) this), null, null, new C00601(image, null), 3, null);
        ActivityManualFaceCaptureBinding activityManualFaceCaptureBinding2 = this.binding;
        if (activityManualFaceCaptureBinding2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
        } else {
    ...
    private final void startCamera() {
        ...
        activityManualFaceCaptureBinding.faceCaptureView.startCamera((LifecycleOwner) this, new C00611(), cameraConfiguration);
    ...
    /* JADX INFO: compiled from: ManualFaceCaptureActivity.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    /* synthetic */ class C00611 implements CameraStateListener, FunctionAdapter {
        C00611() {
        }
        ...
        public final void onCameraState(CameraState p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ManualFaceCaptureActivity.this.onCameraState(p0);
        }
    }
    ...
    private final void disableAutoFocusOnYotiCamera() {
        try {
            ...
            FaceCapture faceCaptureView = activityManualFaceCaptureBinding.faceCaptureView;
            Intrinsics.checkNotNullExpressionValue(faceCaptureView, "faceCaptureView");
            Class<?> cls = faceCaptureView.getClass();
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    Object obj = field.get(faceCaptureView);
                    if (obj != null) {
                        String name = obj.getClass().getName();
                        Intrinsics.checkNotNull(name);
                        if (StringsKt.contains((CharSequence) name, (CharSequence) "Camera", true) || StringsKt.contains((CharSequence) name, (CharSequence) "controller", true) || StringsKt.contains((CharSequence) name, (CharSequence) "preview", true) || StringsKt.contains((CharSequence) name, (CharSequence) "session", true)) {
            ...
            while (it2.hasNext()) {
                ...
                try {
                    ...
                    if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "setautofocus", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "enableautofocus", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "setaf", false, 2, (Object) null)) {
                        Log.d(this.TAG, "Invoking method " + lowerCase + " to disable AF");
                        try {
                            method.invoke(faceCaptureView, false);
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
                    if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "getcapture", false, 2, (Object) null) && StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "builder", false, 2, (Object) null)) {
                    ...
                    } else if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "getpreviewrequest", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "getpreview", false, 2, (Object) null)) {
                        Intrinsics.checkNotNull(method);
                    ...
                    } else if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "getcameradevice", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "getcameradev", false, 2, (Object) null)) {
                        Intrinsics.checkNotNull(method);
                    ...
                    } else if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "setautofocus", false, 2, (Object) null) || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "enableautofocus", false, 2, (Object) null)) {
                        try {
            ...
            while (it2.hasNext()) {
                ...
                try {
                    ...
                    if (obj2 != null) {
                        ...
                        if (!StringsKt.contains$default((CharSequence) lowerCase2, (CharSequence) "builder", false, 2, (Object) null)) {
                            String name3 = obj2.getClass().getName();
                            Intrinsics.checkNotNullExpressionValue(name3, "getName(...)");
                            if (StringsKt.contains((CharSequence) name3, (CharSequence) "builder", true)) {
                            }
                        }
    ...
    private final void setAfOffOnBuilderIfPossible(Object builderObj) {
        try {
            ...
            CollectionsKt.listOf((Object[]) new String[]{"set", "addTarget", "build"});
            try {
                Iterator it = ArrayIteratorKt.iterator(cls.getDeclaredMethods());
                while (it.hasNext()) {
                    Method method = (Method) it.next();
                    ...
                    String lowerCase = name.toLowerCase(Locale.ROOT);
                    Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
                    if (Intrinsics.areEqual(lowerCase, "set") || StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "set", false, 2, (Object) null)) {
    ...
    private final void setAfOffOnCameraDeviceIfPossible(Object camDevObj) {
        try {
            ...
            while (it.hasNext()) {
                ...
                String lowerCase = name.toLowerCase(Locale.ROOT);
                Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
                if (StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "create", false, 2, (Object) null) && StringsKt.contains$default((CharSequence) lowerCase, (CharSequence) "request", false, 2, (Object) null)) {
