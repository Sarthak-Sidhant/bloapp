...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM5265constructorimpl = Result.m5265constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5271isFailureimpl(objM5265constructorimpl) ? null : objM5265constructorimpl);
