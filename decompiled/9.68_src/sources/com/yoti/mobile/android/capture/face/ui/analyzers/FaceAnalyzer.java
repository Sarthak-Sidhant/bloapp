...
public final class FaceAnalyzer implements ImageAnalyzer {
    ...
    public FaceAnalyzer(Context context, LuminosityValidator luminosityValidator, IFaceDetection faceDetector, FaceCaptureResultMapper faceResultMapper, Handler mainHandler) {
        ...
        this.configuration = new FaceCaptureConfiguration(null, null, false, false, false, 0, false, false, KotlinVersion.MAX_COMPONENT_VALUE, null);
    }
    ...
    public /* synthetic */ FaceAnalyzer(Context context, LuminosityValidator luminosityValidator, IFaceDetection iFaceDetection, FaceCaptureResultMapper faceCaptureResultMapper, Handler handler, int i, DefaultConstructorMarker defaultConstructorMarker) {
        MlkitFaceDetection mlkitFaceDetection;
        LuminosityValidator luminosityValidator2 = (i & 2) != 0 ? new LuminosityValidator(context) : luminosityValidator;
        if ((i & 4) != 0) {
            mlkitFaceDetection = new MlkitFaceDetection(null, 1, 0 == true ? 1 : 0);
        } else {
            mlkitFaceDetection = iFaceDetection;
        }
        this(context, luminosityValidator2, mlkitFaceDetection, (i & 8) != 0 ? new FaceCaptureResultMapper(null, null, null, 7, null) : faceCaptureResultMapper, (i & 16) != 0 ? new Handler(Looper.getMainLooper()) : handler);
    }
    ...
    private final void onCaptureResult(final FaceCaptureResult result) {
        this.mainHandler.post(new Runnable() { // from class: com.yoti.mobile.android.capture.face.ui.analyzers.FaceAnalyzer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                FaceAnalyzer.m10onCaptureResult$lambda3(this.f$0, result);
            }
        });
    }
    ...
    public static final void m10onCaptureResult$lambda3(FaceAnalyzer this$0, FaceCaptureResult result) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(result, "$result");
        FaceCaptureListener faceCaptureListener = this$0.listener;
    ...
    private final void onFailure(FaceDetectionError exception, ImageBuffer buffer) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.yoti.mobile.android.capture.face.ui.analyzers.FaceAnalyzer$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                FaceAnalyzer.m11onFailure$lambda4(this.f$0, faceCaptureResultMapError);
            }
        });
    }
    ...
    public static final void m11onFailure$lambda4(FaceAnalyzer this$0, FaceCaptureResult result) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(result, "$result");
        FaceCaptureListener faceCaptureListener = this$0.listener;
        if (faceCaptureListener != null) {
