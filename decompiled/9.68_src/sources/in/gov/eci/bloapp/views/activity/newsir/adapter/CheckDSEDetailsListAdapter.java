...
public class CheckDSEDetailsListAdapter extends RecyclerView.Adapter<holder> {
    ...
    public void onBindViewHolder(final holder holder2, int i) {
        ...
        holder2.epic_no.setText(this.context.getResources().getString(R.string.epic_no) + StringUtils.SPACE + this.al.get(i).getEpicNumber());
        ...
        String str = this.al.get(i).getHouseNumber() + StringUtils.SPACE + this.al.get(i).getLocalityStreet() + StringUtils.SPACE + this.al.get(i).getTownVillage();
    ...
    class holder extends RecyclerView.ViewHolder {
        ...
        public holder(View itemView) {
            ...
            this.layout = (LinearLayout) itemView.findViewById(2131364428);
