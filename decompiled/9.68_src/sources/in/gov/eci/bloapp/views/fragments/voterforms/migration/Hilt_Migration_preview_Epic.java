...
abstract class Hilt_Migration_preview_Epic extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_Migration_preview_Epic() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_Migration_preview_Epic(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((Migration_preview_Epic_GeneratedInjector) generatedComponent()).injectMigration_preview_Epic((Migration_preview_Epic) UnsafeCasts.unsafeCast(this));
    }
