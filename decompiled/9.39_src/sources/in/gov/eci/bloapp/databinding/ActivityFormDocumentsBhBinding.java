...
public final class ActivityFormDocumentsBhBinding implements ViewBinding {
    ...
    public static ActivityFormDocumentsBhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityFormDocumentsBhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_form_documents_bh, parent, false);
        if (attachToParent) {
    ...
    public static ActivityFormDocumentsBhBinding bind(View rootView) {
        int i = R.id.annexure;
                                                                                                                                                    ...
                                                                                                                                                    if (button2 != null) {
                                                                                                                                                        ...
                                                                                                                                                        if (linearLayout2 != null) {
                                                                                                                                                            ...
                                                                                                                                                            if (textView14 != null) {
                                                                                                                                                                ...
                                                                                                                                                                if (button3 != null) {
                                                                                                                                                                    return new ActivityFormDocumentsBhBinding(linearLayout, textView, imageView, imageView2, constraintLayoutFindChildViewById, textView2, textView3, textView4, textView5, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, textView6, imageView9, imageView10, imageView11, imageView12, imageView13, imageView14, imageView15, linearLayout, textView7, textView8, textView9, button, textView10, textView11, imageView16, textView12, imageView17, imageView18, textView13, imageView19, imageView20, button2, linearLayout2, textView14, button3);
                                                                                                                                                                }
                                                                                                                                                            }
                                                                                                                                                        }
                                                                                                                                                    }
