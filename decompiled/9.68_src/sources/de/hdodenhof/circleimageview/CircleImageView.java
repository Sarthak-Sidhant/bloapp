...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderColor = typedArrayObtainStyledAttributes.getColor(R.styleable.CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
    ...
    private void updateShaderMatrix() {
        ...
        float fHeight2 = this.mBitmapWidth * this.mDrawableRect.height();
        float fWidth2 = this.mDrawableRect.width() * this.mBitmapHeight;
        float fWidth3 = CropImageView.DEFAULT_ASPECT_RATIO;
        if (fHeight2 > fWidth2) {
            fWidth = this.mDrawableRect.height() / this.mBitmapHeight;
            fHeight = 0.0f;
            fWidth3 = (this.mDrawableRect.width() - (this.mBitmapWidth * fWidth)) * 0.5f;
        } else {
        ...
        this.mShaderMatrix.postTranslate(((int) (fWidth3 + 0.5f)) + this.mDrawableRect.left, ((int) (fHeight + 0.5f)) + this.mDrawableRect.top);
