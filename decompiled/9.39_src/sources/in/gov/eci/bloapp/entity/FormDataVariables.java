...
public class FormDataVariables {
    ...
    public String toString() {
        return "FormDataVariables{id=" + this.id + ", stCode='" + this.stCode + "', epicNo='" + this.epicNo + "', houseNo='" + this.houseNo + "', dobVerified='" + this.dobVerified + "', erollDob='" + this.erollDob + "', districtCd='" + this.districtCd + "', acNo='" + this.acNo + "', partNo='" + this.partNo + "', partSerialNo='" + this.partSerialNo + "', createdDttm='" + this.createdDttm + "', createdBy='" + this.createdBy + "', modifiedDttm='" + this.modifiedDttm + "', modifiedBy='" + this.modifiedBy + "', photoUrl='" + this.photoUrl + "', srFormPage1Url='" + this.srFormPage1Url + "', citizenshipType='" + this.citizenshipType + "', citizenshipTypeCat='" + this.citizenshipTypeCat + "', surveyChannel='" + this.surveyChannel + "', list1Doc='" + this.list1Doc + "', list2Doc='" + this.list2Doc + "', list3Doc='" + this.list3Doc + "', list4Doc='" + this.list4Doc + "', list5Doc='" + this.list5Doc + "', list6Doc='" + this.list6Doc + "', list7Doc='" + this.list7Doc + "', list8Doc='" + this.list8Doc + "', list1DocUrl='" + this.list1DocUrl + "', list2DocUrl='" + this.list2DocUrl + "', list3DocUrl='" + this.list3DocUrl + "', list4DocUrl='" + this.list4DocUrl + "', list5DocUrl='" + this.list5DocUrl + "', list6DocUrl='" + this.list6DocUrl + "', list7DocUrl='" + this.list7DocUrl + "', aadharNo='" + this.aadharNo + "', mobileNo='" + this.mobileNo + "', fathersOrGuardianName='" + this.fathersOrGuardianName + "', fathersOrGuardianEpicNo='" + this.fathersOrGuardianEpicNo + "', mothersName='" + this.mothersName + "', mothersEpicNo='" + this.mothersEpicNo + "', spouseName='" + this.spouseName + "', spouseEpicNo='" + this.spouseEpicNo + "', annexureCUrl='" + this.annexureCUrl + "', preRevisionVoterFlg='" + this.preRevisionVoterFlg + "', preRevisionVoterDocUrl='" + this.preRevisionVoterDocUrl + "', submittedForRecommendation='" + this.submittedForRecommendation + "', fathersNationality='" + this.fathersNationality + "', mothersNationality='" + this.mothersNationality + "', srFormPage2Url='" + this.srFormPage2Url + "', oldAcNo='" + this.oldAcNo + "', oldPartNo='" + this.oldPartNo + "', oldPslNo='" + this.oldPslNo + "', documentUploadedFlg='" + this.documentUploadedFlg + "', list1docUrlPg2='" + this.list1docUrlPg2 + "', list2docUrlPg2='" + this.list2docUrlPg2 + "', list3docUrlPg2='" + this.list3docUrlPg2 + "', list4docUrlPg2='" + this.list4docUrlPg2 + "', list5docUrlPg2='" + this.list5docUrlPg2 + "', list5docUrlPg3='" + this.list5docUrlPg3 + "', list6docUrlPg2='" + this.list6docUrlPg2 + "', list7docUrlPg2='" + this.list7docUrlPg2 + "', preRevisionVoterDocUrlPg2='" + this.preRevisionVoterDocUrlPg2 + "', annexureCUrlPg2='" + this.annexureCUrlPg2 + "', formSubmissionPlace='" + this.formSubmissionPlace + "', citizenSignatureFilepath='" + this.citizenSignatureFilepath + "', moldAcNo='" + this.moldAcNo + "', moldPartNo='" + this.moldPartNo + "', moldPslNo='" + this.moldPslNo + "', foldAcNo='" + this.foldAcNo + "', foldPartNo='" + this.foldPartNo + "', foldPslNo='" + this.foldPslNo + "'}";
    }
}
