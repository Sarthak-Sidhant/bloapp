...
public final class STTrueFalseBlank$Enum extends StringEnumAbstractBase {
    ...
    public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new STTrueFalseBlank$Enum[]{new STTrueFalseBlank$Enum("t", 1), new STTrueFalseBlank$Enum("f", 2), new STTrueFalseBlank$Enum(BooleanUtils.TRUE, 3), new STTrueFalseBlank$Enum(BooleanUtils.FALSE, 4), new STTrueFalseBlank$Enum("", 5)});
