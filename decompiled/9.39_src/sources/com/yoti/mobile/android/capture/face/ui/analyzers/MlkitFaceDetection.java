...
public final class MlkitFaceDetection implements IFaceDetection {
    ...
    public MlkitFaceDetection() {
        MlkitFaceMapper mlkitFaceMapper = null;
        this(mlkitFaceMapper, 1, mlkitFaceMapper);
    }

    public MlkitFaceDetection(MlkitFaceMapper mlkitFaceMapper) {
        Intrinsics.checkNotNullParameter(mlkitFaceMapper, "faceMapper");
        this.faceMapper = mlkitFaceMapper;
        initDetector(new FaceCaptureConfiguration(null, null, false, false, false, 0, false, false, 255, null));
    }
