...
public final class CurrentElectorDetailsBinding implements ViewBinding {
    ...
    public final LinearLayout llRelativetype;
    public final LinearLayout llrelativename;
    ...
    private CurrentElectorDetailsBinding(LinearLayout rootView, TextView agePendingSir, LinearLayout ccEf, TextView electorNamePendingSir, TextView epicPendingSir, LinearLayout llAge, LinearLayout llRelativetype, LinearLayout llrelativename, TextView relativeNamePendingSir, TextView relativeTypePendingSir, TextView serialNoPendingSir) {
        ...
        this.llAge = llAge;
        this.llRelativetype = llRelativetype;
        this.llrelativename = llrelativename;
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        if (linearLayout2 != null) {
                            i = R.id.ll_relativetype;
                            LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.ll_relativetype);
                            if (linearLayout3 != null) {
                                i = R.id.llrelativename;
                                LinearLayout linearLayout4 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.llrelativename);
                                if (linearLayout4 != null) {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (textView5 != null) {
                                            ...
                                            if (textView6 != null) {
                                                return new CurrentElectorDetailsBinding((LinearLayout) rootView, textView, linearLayout, textView2, textView3, linearLayout2, linearLayout3, linearLayout4, textView4, textView5, textView6);
                                            }
                                        }
                                    }
                                }
