...
public final class BloFragmentFAQBinding implements ViewBinding {
    ...
    public static BloFragmentFAQBinding bind(View rootView) {
        RecyclerView recyclerViewFindChildViewById = ViewBindings.findChildViewById(rootView, 2131366254);
        if (recyclerViewFindChildViewById != null) {
            return new BloFragmentFAQBinding((LinearLayout) rootView, recyclerViewFindChildViewById);
        }
        throw new NullPointerException("Missing required view with ID: ".concat(rootView.getResources().getResourceName(2131366254)));
    }
}
