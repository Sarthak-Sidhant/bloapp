            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (response.body() != null) {
                    ...
                    for (int i = 0; i < TrackRejectedFragment.this.paylodJsonArray.size(); i++) {
                        ...
                        TrackRejectedFragment.this.statusList.add(String.valueOf(asJsonObject.get("formStatus")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
                        TrackRejectedFragment.this.formTypeNameList.add(String.valueOf(asJsonObject.get("formType")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
                        TrackRejectedFragment.this.referenceNoList.add(String.valueOf(asJsonObject.get("formRefNumber")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE));
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (String.valueOf(asJsonObject.get("formType")).replaceAll("^\"|\"$", "").replace("null", StringUtils.SPACE).equals("FORM7")) {
                                    if (jSONObject.has("lastnameApplicant")) {
                                        TrackRejectedFragment.this.applicantNameList.add(jSONObject.getString("firstNameApplicant") + StringUtils.SPACE + jSONObject.getString("lastnameApplicant"));
                                    } else {
                                    ...
                                    TrackRejectedFragment.this.applicantNameList.add(jSONObject.getString(Constants.FIRST_NAME) + StringUtils.SPACE + jSONObject.getString(Constants.LAST_NAME));
                                } else {
