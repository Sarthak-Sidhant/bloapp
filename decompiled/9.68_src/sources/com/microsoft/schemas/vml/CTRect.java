    ...
    public static final class Factory {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (schemaTypeLoaderTypeLoaderForClassLoader == null) {
                schemaTypeLoaderTypeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTRect.class.getClassLoader());
        ...
        public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return getTypeLoader().newValidatingXMLInputStream(xMLInputStream, CTRect.type, null);
        }
        ...
        public static CTRect parse(String str) throws XmlException {
            return (CTRect) getTypeLoader().parse(str, CTRect.type, (XmlOptions) null);
        }

        public static CTRect parse(String str, XmlOptions xmlOptions) throws XmlException {
            return (CTRect) getTypeLoader().parse(str, CTRect.type, xmlOptions);
        }
        ...
        @Deprecated
        public static CTRect parse(XMLInputStream xMLInputStream) throws XMLStreamException, XmlException {
            return (CTRect) getTypeLoader().parse(xMLInputStream, CTRect.type, (XmlOptions) null);
        }

        @Deprecated
        public static CTRect parse(XMLInputStream xMLInputStream, XmlOptions xmlOptions) throws XMLStreamException, XmlException {
