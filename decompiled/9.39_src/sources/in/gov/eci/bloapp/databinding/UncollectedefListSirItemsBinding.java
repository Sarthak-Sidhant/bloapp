...
public final class UncollectedefListSirItemsBinding implements ViewBinding {
    ...
    private UncollectedefListSirItemsBinding(LinearLayout rootView, TextView electorNamePendingSir, TextView epicPendingSir, TextView serialNoPendingSir, TextView uncollectabledefDoc) {
    ...
    public static UncollectedefListSirItemsBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static UncollectedefListSirItemsBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.uncollectedef_list_sir_items, parent, false);
        if (attachToParent) {
    ...
    public static UncollectedefListSirItemsBinding bind(View rootView) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        return new UncollectedefListSirItemsBinding((LinearLayout) rootView, textView, textView2, textView3, textView4);
                    }
                }
            }
        }
