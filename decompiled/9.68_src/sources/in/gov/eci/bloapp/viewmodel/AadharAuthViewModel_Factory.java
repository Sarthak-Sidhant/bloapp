...
public final class AadharAuthViewModel_Factory implements Factory<AadharAuthViewModel> {
    ...
    public AadharAuthViewModel get() {
        AadharAuthViewModel aadharAuthViewModelNewInstance = newInstance(this.aadharAuthRepositoryProvider.get());
        AadharAuthViewModel_MembersInjector.injectApiInterface(aadharAuthViewModelNewInstance, this.apiInterfaceProvider.get());
