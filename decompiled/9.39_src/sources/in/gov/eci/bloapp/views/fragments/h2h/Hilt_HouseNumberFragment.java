...
abstract class Hilt_HouseNumberFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_HouseNumberFragment() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_HouseNumberFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((HouseNumberFragment_GeneratedInjector) generatedComponent()).injectHouseNumberFragment((HouseNumberFragment) UnsafeCasts.unsafeCast(this));
    }
