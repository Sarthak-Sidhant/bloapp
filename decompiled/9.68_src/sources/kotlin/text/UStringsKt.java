...
public final class UStringsKt {
    ...
    public static final String m6597toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m6599toStringolVBNx4(short s, int i) {
    ...
    public static final String m6598toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m6596toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m5360constructorimpl(KotlinVersion.MAX_COMPONENT_VALUE)) > 0) {
            return null;
        }
        return UByte.m5277boximpl(UByte.m5283constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m5360constructorimpl(Settings.DEFAULT_INITIAL_WINDOW_SIZE)) > 0) {
            return null;
        }
        return UShort.m5540boximpl(UShort.m5546constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM5360constructorimpl = UInt.m5360constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM5360constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM5360constructorimpl2 = UInt.m5360constructorimpl(i3 * iM5360constructorimpl);
            int iM5360constructorimpl3 = UInt.m5360constructorimpl(UInt.m5360constructorimpl(iDigitOf) + iM5360constructorimpl2);
            if (Integer.compareUnsigned(iM5360constructorimpl3, iM5360constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM5360constructorimpl3;
        }
        return UInt.m5354boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM5439constructorimpl = ULong.m5439constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM5439constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM5439constructorimpl2 = ULong.m5439constructorimpl(j * jM5439constructorimpl);
            long jM5439constructorimpl3 = ULong.m5439constructorimpl(ULong.m5439constructorimpl(((long) UInt.m5360constructorimpl(iDigitOf)) & 4294967295L) + jM5439constructorimpl2);
            if (Long.compareUnsigned(jM5439constructorimpl3, jM5439constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM5439constructorimpl3;
        }
        return ULong.m5433boximpl(j);
    }
}
