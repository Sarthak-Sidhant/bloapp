...
public class SentbackNewFormAdapter extends RecyclerView.Adapter<ViewHolder> {
    private Context context;
    ArrayList<RollbackNewModel> datalist;
    ArrayList<RollbackNewModel> filteredAl;

    public SentbackNewFormAdapter(ArrayList<RollbackNewModel> datalist, Context context) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.fillEF.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.SentbackNewFormAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(SentbackNewFormAdapter.this.context, (Class<?>) specialRevisionActivity.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
                SentbackNewFormAdapter.this.context.startActivity(intent);
            }
        });
        viewHolder.uncollectable.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.SentbackNewFormAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(SentbackNewFormAdapter.this.context, (Class<?>) UncollectableSIRold.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
