...
public class FormChartFragment extends Fragment {
    ...
    int[] colors1 = {Color.rgb(254, 177, 57), Color.rgb(59, 172, 182), Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, 140, 140), Color.rgb(TarConstants.PREFIXLEN, 163, 235), Color.rgb(0, 0, 0), Color.rgb(128, 128, 128)};
    int[] colors2 = {Color.rgb(TarConstants.PREFIXLEN, 163, 235), Color.rgb(0, 0, 0), Color.rgb(128, 128, 128)};
    ...
    private List<BarEntry> dataValues1() {
        ...
        this.form6entry = new BarEntry(CropImageView.DEFAULT_ASPECT_RATIO, (float) Double.parseDouble(this.form_6));
