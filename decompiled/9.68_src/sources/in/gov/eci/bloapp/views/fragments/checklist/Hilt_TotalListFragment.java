...
abstract class Hilt_TotalListFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_TotalListFragment() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_TotalListFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((TotalListFragment_GeneratedInjector) generatedComponent()).injectTotalListFragment((TotalListFragment) UnsafeCasts.unsafeCast(this));
    }
