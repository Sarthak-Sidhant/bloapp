...
public final class C0160SegmentedByteString extends ByteString {
    ...
    public C0160SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0160SegmentedByteString c0160SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0160SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c0160SegmentedByteString;
        }
