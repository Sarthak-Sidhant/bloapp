...
public class EndianUtils {
    public static int swapInteger(int i) {
        return ((i & KotlinVersion.MAX_COMPONENT_VALUE) << 24) + (((i >> 8) & KotlinVersion.MAX_COMPONENT_VALUE) << 16) + (((i >> 16) & KotlinVersion.MAX_COMPONENT_VALUE) << 8) + ((i >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
    }
    ...
    public static short swapShort(short s) {
        return (short) (((s & 255) << 8) + ((s >> 8) & KotlinVersion.MAX_COMPONENT_VALUE));
    }
    ...
    public static void writeSwappedShort(OutputStream outputStream, short s) throws IOException {
        ...
        outputStream.write((byte) ((s >> 8) & KotlinVersion.MAX_COMPONENT_VALUE));
    }

    public static short readSwappedShort(InputStream inputStream) throws IOException {
        return (short) ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) + ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) << 8));
    }

    public static int readSwappedUnsignedShort(InputStream inputStream) throws IOException {
        return (read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) + ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) << 8);
    }

    public static void writeSwappedInteger(OutputStream outputStream, int i) throws IOException {
        outputStream.write((byte) (i & KotlinVersion.MAX_COMPONENT_VALUE));
        outputStream.write((byte) ((i >> 8) & KotlinVersion.MAX_COMPONENT_VALUE));
        outputStream.write((byte) ((i >> 16) & KotlinVersion.MAX_COMPONENT_VALUE));
        outputStream.write((byte) ((i >> 24) & KotlinVersion.MAX_COMPONENT_VALUE));
    }

    public static int readSwappedInteger(InputStream inputStream) throws IOException {
        return (read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) + ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) << 8) + ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) << 16) + ((read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE) << 24);
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        ...
        return (((long) (read(inputStream) & KotlinVersion.MAX_COMPONENT_VALUE)) << 24) + (((long) ((i & KotlinVersion.MAX_COMPONENT_VALUE) + ((i2 & KotlinVersion.MAX_COMPONENT_VALUE) << 8) + ((i3 & KotlinVersion.MAX_COMPONENT_VALUE) << 16))) & 4294967295L);
    }
