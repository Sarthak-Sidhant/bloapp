...
public final class AadharAuthRepository_Factory implements Factory<AadharAuthRepository> {
    ...
    public AadharAuthRepository m596get() {
        AadharAuthRepository aadharAuthRepositoryNewInstance = newInstance((ApiInterface) this.apiInterfaceProvider.get());
        AadharAuthRepository_MembersInjector.injectDbHandler(aadharAuthRepositoryNewInstance, (DatabaseHelper) this.dbHandlerProvider.get());
        AadharAuthRepository_MembersInjector.injectEciDatabase(aadharAuthRepositoryNewInstance, (EciDatabase) this.eciDatabaseProvider.get());
