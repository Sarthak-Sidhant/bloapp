...
public class TotalListFragment extends Hilt_TotalListFragment {
    ...
    class AnonymousClass1 implements GenericRecyclerView.GenericRecyclerViewInterface {
                ...
                if (jsonArray.size() > 0) {
                    ...
                    if (strReplace.equals("null") && strReplace2.equals("null")) {
                        ...
                        if (TotalListFragment.this.formType == 9 || TotalListFragment.this.formType == 10) {
                            TotalListFragment.this.alertDialog.show();
                            TotalListFragment.this.commonUtilClass.getchecklistdetailsform8(TotalListFragment.this.getContext(), TotalListFragment.this.stateCode, TotalListFragment.this.atkBand, TotalListFragment.this.rtkBand, TotalListFragment.this.referenceNo, TotalListFragment.this.token, new C00481(bundle));
                            return;
                        }
        ...
        class C00481 implements Forms8Respponse {
            final /* synthetic */ Bundle val$bundleList;

            C00481(final Bundle val$bundleList) {
        ...
        public /* synthetic */ void lambda$onBindViewHolder$12(final int i, final JsonArray jsonArray, final int i2, final String str, final int i3, int i4, final String str2, final String str3) {
            System.out.println("zxnbchdbvfhvb " + i4 + StringUtils.SPACE + str2 + StringUtils.SPACE + str3);
            if (i4 == 401 || i4 == 400) {
            ...
            System.out.println("zxnbchdbvfhvb ---> else refresh" + i4 + StringUtils.SPACE + str2 + StringUtils.SPACE);
        ...
        if (jsonArray != null) {
            ...
            try {
                ...
                for (int i = 0; i < this.chekListData.size(); i++) {
                    ...
                    String strReplaceAll = String.valueOf(asJsonObject.get(this.applicantNameText)).replaceAll("^\"|\"$", "").replaceAll(" null | null", StringUtils.SPACE);
            ...
            try {
                ...
                for (int i = 0; i < this.chekListData.size(); i++) {
                    ...
                    if (!strReplaceAll3.equals("null")) {
                        ...
                        long time = ((this.todayDate.getTime() - this.d1.getTime()) / org.apache.commons.lang3.time.DateUtils.MILLIS_PER_DAY) % 365;
                        if (time <= 7 && time >= 1) {
        ...
        if (jsonArray != null) {
            ...
            try {
                ...
                for (int i = 0; i < this.chekListData.size(); i++) {
                    ...
                    String strReplaceAll3 = String.valueOf(asJsonObject.get(this.applicantNameText)).replaceAll("^\"|\"$", "").replaceAll(" null | null", StringUtils.SPACE);
