...
import in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapter;
...
public class RollBAckNewFormsEro extends SuperBaseActivity {
    private static final int REQUEST_CODE_CAMERA_PORTRAIT = 1221;
    private String acNo;
    RollbackNewFormEroAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.adapter = new RollbackNewFormEroAdapter(this.rollBackSearchList, this);
    ...
    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro$1, reason: invalid class name */
    class AnonymousClass1 implements Callback<JsonObject> {
        AnonymousClass1() {
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r2v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro] */
            ...
            try {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        RollBAckNewFormsEro.this.rollBackNewList.add(new RollbackNewModel(jSONObject.optString("electorName", null), strOptString, lValueOf, jSONObject.optString("partSerialNo", null), jSONObject.optString("backToBloRemarks", null), jSONObject.optString("efFrontUrl", ""), jSONObject.optString("efBackUrl", ""), jSONObject.optString("suppDoc1Url", ""), jSONObject.optString("suppDoc2Url", ""), jSONObject.optString("uncollectableReason", ""), jSONObject.optString("enrolledEpicNo", "")));
                    }
                    RollBAckNewFormsEro.this.rollBackSearchList.addAll(RollBAckNewFormsEro.this.rollBackNewList);
                    RollBAckNewFormsEro.this.binding.recyclerView.setAdapter(RollBAckNewFormsEro.this.adapter);
                    RollBAckNewFormsEro.this.alertDialog.dismiss();
                    RollBAckNewFormsEro.this.binding.search.addTextChangedListener(new TextWatcher() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro.1.1
                        ...
                        public void afterTextChanged(Editable editable) {
                            ...
                            for (RollbackNewModel rollbackNewModel : RollBAckNewFormsEro.this.rollBackSearchList) {
                                if (rollbackNewModel.getEpicNo().toLowerCase().contains(string.toLowerCase())) {
                                    arrayList.add(rollbackNewModel);
                                }
                            }
                            RollBAckNewFormsEro.this.adapter.fun(arrayList);
                        }
                    });
                    return;
                }
                if (response.code() == 400 || response.code() == 401) {
                    if (RollBAckNewFormsEro.this.alertDialog != null) {
                        RollBAckNewFormsEro.this.alertDialog.dismiss();
                    }
                    CommomUtility commomUtility = RollBAckNewFormsEro.this.commomUtility;
                    ?? r2 = RollBAckNewFormsEro.this;
                    commomUtility.showMessageOK(r2, r2.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro$1$$ExternalSyntheticLambda0
                ...
                try {
                    ...
                    RollBAckNewFormsEro rollBAckNewFormsEro = RollBAckNewFormsEro.this;
                    rollBAckNewFormsEro.showDialog1(rollBAckNewFormsEro.getString(R.string.alertMsg), strOptString2);
        ...
        public /* synthetic */ void lambda$onResponse$0(DialogInterface dialogInterface, int i) {
            SharedPref.getInstance(RollBAckNewFormsEro.this.getApplicationContext()).setIsLoggedIn(false);
            SharedPref.getInstance(RollBAckNewFormsEro.this.getApplicationContext()).setLocaleBool(false);
            RollBAckNewFormsEro.this.startActivity(new Intent(RollBAckNewFormsEro.this.getApplicationContext(), (Class<?>) LoginActivity.class));
        }
    ...
    private void initClickListener() {
        this.binding.backBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initClickListener$0(view);
            }
        });
        this.binding.scanCode.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                RollBAckNewFormsEro.this.cameraPermission();
            }
        });
        this.binding.btScanCode.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                RollBAckNewFormsEro.this.cameraPermission();
            }
    ...
    public void showDialog1(String alertText, String message) {
        ...
        new android.app.AlertDialog.Builder(this).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton(getString(R.string.okMsg), new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.RollBAckNewFormsEro$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
