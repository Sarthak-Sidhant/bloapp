...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM6786trySendImplMj0NB7M = conflatedBufferedChannel.m6786trySendImplMj0NB7M(e, true);
        if (objM6786trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m6773exceptionOrNullimpl(objM6786trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM6786trySendImplMj0NB7M = conflatedBufferedChannel.m6786trySendImplMj0NB7M(e, true);
        if (!(objM6786trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo6758trySendJP2dKIU(E element) {
        return m6786trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m6786trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m6785trySendDropLatestMj0NB7M(element, isSendOp) : m6764trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m6785trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo6758trySendJP2dKIU = super.mo6758trySendJP2dKIU(element);
        if (ChannelResult.m6779isSuccessimpl(objMo6758trySendJP2dKIU) || ChannelResult.m6777isClosedimpl(objMo6758trySendJP2dKIU)) {
            return objMo6758trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo6758trySendJP2dKIU = mo6758trySendJP2dKIU(element);
        if (!(objMo6758trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo6758trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m6773exceptionOrNullimpl(objMo6758trySendJP2dKIU);
