...
public final class UMathKt {
    ...
    private static final int m6485minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6464minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m6486mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m6472minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m6483maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m6452maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m6484maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m6460maxOfeb3DHEI(j, j2);
    }
}
