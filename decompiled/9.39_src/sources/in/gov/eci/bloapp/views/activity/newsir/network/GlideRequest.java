...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
    ...
    public GlideRequest<File> getDownloadOnlyRequest() {
        return new GlideRequest(File.class, this).m1850apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public <Y> GlideRequest<TranscodeType> m1908set(Option<Y> option, Y y) {
        return super.set(option, y);
    }

    /* JADX INFO: renamed from: decode, reason: collision with other method in class */
    public GlideRequest<TranscodeType> m1858decode(Class<?> clazz) {
    ...
    public GlideRequest<TranscodeType> m1918transform(Transformation<Bitmap> transformation) {
        return super.transform(transformation);
    }

    /* JADX INFO: renamed from: transform, reason: collision with other method in class */
    public GlideRequest<TranscodeType> m1920transform(Transformation<Bitmap>... transformations) {
        return super.transform(transformations);
    }

    @Deprecated
    /* JADX INFO: renamed from: transforms, reason: collision with other method in class */
    public GlideRequest<TranscodeType> m1921transforms(Transformation<Bitmap>... transformations) {
    ...
    public GlideRequest<TranscodeType> m1901optionalTransform(Transformation<Bitmap> transformation) {
    ...
    /* JADX INFO: renamed from: apply, reason: collision with other method in class */
    public GlideRequest<TranscodeType> m1850apply(BaseRequestOptions<?> options) {
    ...
    public GlideRequest<TranscodeType> m1891load(Object o) {
        return (GlideRequest) super.load(o);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1886load(Bitmap bitmap) {
        return (GlideRequest) super.load(bitmap);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1887load(Drawable drawable) {
        return (GlideRequest) super.load(drawable);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1892load(String string) {
        return (GlideRequest) super.load(string);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1888load(Uri uri) {
        return (GlideRequest) super.load(uri);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1889load(File file) {
        return (GlideRequest) super.load(file);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1890load(Integer id) {
        return (GlideRequest) super.load(id);
    }

    @Deprecated
    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1893load(URL url) {
        return (GlideRequest) super.load(url);
    }

    /* JADX INFO: renamed from: load, reason: collision with other method in class and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public GlideRequest<TranscodeType> m1894load(byte[] bytes) {
    ...
    public GlideRequest<TranscodeType> m1857clone() {
