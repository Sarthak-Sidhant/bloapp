...
public interface UserClient {
    ...
    @POST("{stateCode}/bloapp-sir/getAnomalyUserListV2")
    ...
    @GET("form7/getForm7byApplicantFirstName")
    Call<JSONArray> getForm7byApplicantFirstNameOthers(@Query("applicantFirstName") String applicantFirstName, @Query("state") String stateQuery, @Query("assemblyConstituencyNumber") String assemblyConstituencyNumber, @Query("partNumber") String partNumber, @Header("Authorization") String authorization, @Header("CurrentRole") String currentRole, @Header("state") String state, @Header("PLATFORM-TYPE") String platformType);
