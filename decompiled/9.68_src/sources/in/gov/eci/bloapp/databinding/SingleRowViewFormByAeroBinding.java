...
public final class SingleRowViewFormByAeroBinding implements ViewBinding {
    ...
    private SingleRowViewFormByAeroBinding(LinearLayout rootView, TextView acName, TextView address, LinearLayout cardViewLL, TextView documentSubmitted, TextView electorName, TextView epic, TextView modifiedBy, TextView partNo, TextView state, TextView viewDetails) {
    ...
    public static SingleRowViewFormByAeroBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SingleRowViewFormByAeroBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.single_row_view_form_by_aero, parent, false);
        if (attachToParent) {
    ...
    public static SingleRowViewFormByAeroBinding bind(View rootView) {
        int i = R.id.acName;
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (textView7 != null) {
                                        ...
                                        if (textView8 != null) {
                                            ...
                                            if (textView9 != null) {
                                                return new SingleRowViewFormByAeroBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, textView6, textView7, textView8, textView9);
                                            }
                                        }
                                    }
                                }
