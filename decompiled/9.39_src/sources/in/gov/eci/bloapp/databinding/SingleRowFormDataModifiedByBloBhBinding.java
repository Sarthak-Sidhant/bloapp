...
public final class SingleRowFormDataModifiedByBloBhBinding implements ViewBinding {
    ...
    private SingleRowFormDataModifiedByBloBhBinding(LinearLayout rootView, TextView acName, TextView address, LinearLayout cardViewLL, TextView documentSubmitted, TextView electorName, TextView epic, TextView partNo, TextView state, TextView viewDetails) {
    ...
    public static SingleRowFormDataModifiedByBloBhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SingleRowFormDataModifiedByBloBhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.single_row_form_data_modified_by_blo_bh, parent, false);
        if (attachToParent) {
    ...
    public static SingleRowFormDataModifiedByBloBhBinding bind(View rootView) {
        int i = R.id.acName;
                            ...
                            if (textView5 != null) {
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (textView7 != null) {
                                        ...
                                        if (textView8 != null) {
                                            return new SingleRowFormDataModifiedByBloBhBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, textView6, textView7, textView8);
                                        }
                                    }
                                }
                            }
