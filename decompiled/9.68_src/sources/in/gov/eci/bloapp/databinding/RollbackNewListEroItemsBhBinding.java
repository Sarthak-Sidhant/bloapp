...
public final class RollbackNewListEroItemsBhBinding implements ViewBinding {
    ...
    private RollbackNewListEroItemsBhBinding(LinearLayout rootView, TextView electorNamePendingSir, TextView epicPendingSir, TextView fillPendingSir, TextView remarks, TextView serialNoPendingSir, TextView uncollectablePendingSir) {
    ...
    public static RollbackNewListEroItemsBhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RollbackNewListEroItemsBhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.rollback_new_list_ero_items_bh, parent, false);
        if (attachToParent) {
    ...
    public static RollbackNewListEroItemsBhBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (textView6 != null) {
                                return new RollbackNewListEroItemsBhBinding((LinearLayout) rootView, textView, textView2, textView3, textView4, textView5, textView6);
                            }
                        }
                    }
                }
