...
public final class EfTrackerMatchEpicAlertBinding implements ViewBinding {
    ...
    public static EfTrackerMatchEpicAlertBinding bind(View rootView) {
        int i = R.id.acPartSerialName;
        LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.acPartSerialName);
        if (linearLayout != null) {
            i = R.id.acPartSerialNumber;
            LinearLayout linearLayout2 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.acPartSerialNumber);
            if (linearLayout2 != null) {
                i = R.id.acPartStateName;
                LinearLayout linearLayout3 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.acPartStateName);
                        ...
                        if (imageView != null) {
                            ...
                            if (linearLayout4 != null) {
                                ...
                                if (linearLayout5 != null) {
                                    ...
                                    LinearLayout linearLayout6 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.linearPartName);
                                    if (linearLayout6 != null) {
                                        i = R.id.linearPartNumber;
                                        LinearLayout linearLayout7 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.linearPartNumber);
                                                                                            ...
                                                                                            if (textView11 != null) {
                                                                                                ...
                                                                                                if (textView12 != null) {
                                                                                                    ...
                                                                                                    if (textView13 != null) {
                                                                                                        ...
                                                                                                        if (textView14 != null) {
                                                                                                            return new EfTrackerMatchEpicAlertBinding((LinearLayout) rootView, linearLayout, linearLayout2, linearLayout3, constraintLayoutFindChildViewById, imageView, linearLayout4, linearLayout5, linearLayout6, linearLayout7, linearLayout8, linearLayout9, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
