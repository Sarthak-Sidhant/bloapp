...
public class MainActivity extends Hilt_MainActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem menuItemFindItem2 = navigationViewFindViewById.getMenu().findItem(R.id.nav_logout);
        MenuItem menuItemFindItem3 = navigationViewFindViewById.getMenu().findItem(R.id.nav_ElectorData);
        MenuItem menuItemFindItem4 = navigationViewFindViewById.getMenu().findItem(R.id.nav_change_language);
        if (!TextUtils.isEmpty(SharedPref.getInstance(this).getUserRole()) && SharedPref.getInstance(this).getUserRole().equalsIgnoreCase("blos")) {
        ...
        menuItemFindItem2.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: in.gov.eci.bloapp.views.activity.MainActivity$$ExternalSyntheticLambda2
        ...
        this.version_text.setText("v" + new CommomUtility().appversion);
    }
    ...
    public /* synthetic */ void lambda$onCreate$1(NavController navController, NavDestination navDestination, Bundle bundle) {
        ...
        if (navDestination.getLabel().equals(getString(R.string.blo_nav_header_title))) {
            ...
            this.toolbarTitle.setText(navDestination.getLabel());
            return;
        }
