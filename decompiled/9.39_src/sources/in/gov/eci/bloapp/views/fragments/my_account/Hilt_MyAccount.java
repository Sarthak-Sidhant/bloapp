...
abstract class Hilt_MyAccount extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_MyAccount(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((MyAccount_GeneratedInjector) generatedComponent()).injectMyAccount((MyAccount) UnsafeCasts.unsafeCast(this));
    }
