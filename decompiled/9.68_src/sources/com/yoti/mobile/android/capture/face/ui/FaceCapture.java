...
public final class FaceCapture extends ConstraintLayout implements LifecycleObserver {
        ...
        if (!arePermissionsGranted()) {
            ...
            processCameraProvider.addListener(new Runnable() { // from class: com.yoti.mobile.android.capture.face.ui.FaceCapture$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    FaceCapture.m9startCamera$lambda1$lambda0(this.f$0, processCameraProvider, lifecycleOwner, cameraConfiguration);
                }
    ...
    public static final void m9startCamera$lambda1$lambda0(FaceCapture this$0, ListenableFuture this_with, LifecycleOwner lifecycleOwner, CameraConfiguration cameraConfiguration) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(this_with, "$this_with");
        Intrinsics.checkNotNullParameter(lifecycleOwner, "$lifecycleOwner");
        Intrinsics.checkNotNullParameter(cameraConfiguration, "$cameraConfiguration");
        this$0.initCamera(this_with, lifecycleOwner, cameraConfiguration);
    }
