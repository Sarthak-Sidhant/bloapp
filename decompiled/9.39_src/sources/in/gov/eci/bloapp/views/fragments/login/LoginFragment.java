...
public class LoginFragment extends Hilt_LoginFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable(requireContext())) {
            ...
            new android.app.AlertDialog.Builder(requireActivity()).setTitle("Alert").setMessage("Please check network").setPositiveButton("Okay", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.login.LoginFragment$$ExternalSyntheticLambda6
    ...
    private void initCLickListener() {
        this.binding.requestOtpLayout.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.login.LoginFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initCLickListener$2(view);
            }
        });
        this.binding.forgotPasswordTv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.login.LoginFragment$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public boolean checkLocationPermission() {
        ...
        new android.app.AlertDialog.Builder(requireActivity()).setTitle(this.requestPermission).setMessage("Kindly Allow Location Permission").setPositiveButton("Okay", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.login.LoginFragment$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    private boolean validation() {
        String string = ((Editable) Objects.requireNonNull(this.binding.mobileNumEd.getText())).toString();
        String string2 = ((Editable) Objects.requireNonNull(this.binding.passwordEd.getText())).toString();
        if (ContextCompat.checkSelfPermission(requireActivity(), "android.permission.CAMERA") != 0) {
            new android.app.AlertDialog.Builder(requireActivity()).setTitle(this.requestPermission).setMessage("Kindly Allow Camera Permission").setPositiveButton("Okay", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.fragments.login.LoginFragment$$ExternalSyntheticLambda7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (string.isEmpty() || string2.isEmpty() || string.length() != 10) {
