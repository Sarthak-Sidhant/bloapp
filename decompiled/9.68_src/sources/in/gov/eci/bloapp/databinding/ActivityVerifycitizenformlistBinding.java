...
public final class ActivityVerifycitizenformlistBinding implements ViewBinding {
    ...
    public static ActivityVerifycitizenformlistBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityVerifycitizenformlistBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_verifycitizenformlist, parent, false);
        if (attachToParent) {
    ...
    public static ActivityVerifycitizenformlistBinding bind(View rootView) {
                                    ...
                                    if (editText != null) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (imageView3 != null) {
                                                    return new ActivityVerifycitizenformlistBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, imageView3);
                                                }
                                            }
                                        }
                                    }
