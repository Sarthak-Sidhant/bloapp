...
public final /* data */ class FaceCaptureResult {
    ...
    public FaceCaptureResult(ImageBuffer imageBuffer, FaceCaptureState faceCaptureState) {
        Intrinsics.checkNotNullParameter(faceCaptureState, "state");
        this.originalImage = imageBuffer;
        this.state = faceCaptureState;
    }
