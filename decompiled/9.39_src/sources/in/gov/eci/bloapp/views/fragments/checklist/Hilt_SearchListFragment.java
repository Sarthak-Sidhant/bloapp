...
abstract class Hilt_SearchListFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_SearchListFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((SearchListFragment_GeneratedInjector) generatedComponent()).injectSearchListFragment((SearchListFragment) UnsafeCasts.unsafeCast(this));
    }
