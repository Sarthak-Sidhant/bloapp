...
abstract class Hilt_FragmentLanguageSelection extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_FragmentLanguageSelection() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_FragmentLanguageSelection(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FragmentLanguageSelection_GeneratedInjector) generatedComponent()).injectFragmentLanguageSelection((FragmentLanguageSelection) UnsafeCasts.unsafeCast(this));
    }
