...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, (Object) null) && this.errors.addThrowable(th)) {
                if (this.delayErrors) {
                    if (this.done) {
        ...
        void innerComplete(SwitchMapInnerObserver switchMapInnerObserver) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, (Object) null) && this.done) {
                Throwable thTerminate = this.errors.terminate();
                if (thTerminate == null) {
                    this.downstream.onComplete();
                } else {
