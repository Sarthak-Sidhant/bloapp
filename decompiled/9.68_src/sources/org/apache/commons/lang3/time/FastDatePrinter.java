...
public class FastDatePrinter implements DatePrinter, Serializable {
    ...
    /* JADX WARN: Code duplicated, block: B:77:0x014d A[DONT_INVERT] */
        ...
        while (i3 < length) {
            ...
            if (cCharAt != '\'') {
                if (cCharAt == 'S') {
                    ...
                    objSelectNumberRule = new TimeZoneNameRule(this.timeZone, this.locale, 1);
                } else {
                    objSelectNumberRule = new TimeZoneNameRule(this.timeZone, this.locale, 0);
                    i = 0;
                }
                i = 0;
            } else {
