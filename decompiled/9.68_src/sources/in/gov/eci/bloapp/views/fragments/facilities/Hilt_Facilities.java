...
abstract class Hilt_Facilities extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((Facilities_GeneratedInjector) generatedComponent()).injectFacilities((Facilities) UnsafeCasts.unsafeCast(this));
    }
