...
public final class BloFragmentDseBinding implements ViewBinding {
    ...
    private BloFragmentDseBinding(ConstraintLayout rootView, ImageView backBtnIv, ImageView homeBtnIv, ConstraintLayout homeFragmentTopConstraintLayout, TabLayout tabLayout, TextView textView3, ViewPager2 viewPager) {
    ...
    public static BloFragmentDseBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloFragmentDseBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_fragment_dse, parent, false);
        if (attachToParent) {
    ...
    public static BloFragmentDseBinding bind(View rootView) {
                    ...
                    if (tabLayoutFindChildViewById != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (viewPager2FindChildViewById != null) {
                                return new BloFragmentDseBinding((ConstraintLayout) rootView, imageView, imageView2, constraintLayoutFindChildViewById, tabLayoutFindChildViewById, textView, viewPager2FindChildViewById);
                            }
                        }
                    }
                }
