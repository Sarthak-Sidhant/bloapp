...
abstract class Hilt_ApplicantDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((ApplicantDetailsFragment_GeneratedInjector) generatedComponent()).injectApplicantDetailsFragment((ApplicantDetailsFragment) UnsafeCasts.unsafeCast(this));
    }
