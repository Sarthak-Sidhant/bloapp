...
public final class ActivityFormDataForBloModificationListBinding implements ViewBinding {
    ...
    private ActivityFormDataForBloModificationListBinding(LinearLayout rootView, ImageView IvScanCode, ImageView backBtnIv, ConstraintLayout blaTopLayout, Button btScanCode, LinearLayout main, TextView noteOpen, RecyclerView recyclerView, ConstraintLayout scanCode, EditText search, Spinner spinner, TextView textView3, ImageView toolbarButton) {
    ...
    public static ActivityFormDataForBloModificationListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityFormDataForBloModificationListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_form_data_for_blo_modification_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityFormDataForBloModificationListBinding bind(View rootView) {
                                    ...
                                    if (editText != null) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (imageView3 != null) {
                                                    return new ActivityFormDataForBloModificationListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, imageView3);
                                                }
                                            }
                                        }
                                    }
