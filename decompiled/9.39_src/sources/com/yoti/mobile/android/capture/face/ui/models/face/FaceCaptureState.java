...
public abstract class FaceCaptureState {
    ...
    public static final /* data */ class InvalidFace extends FaceCaptureState {
        ...
        public InvalidFace(FaceCaptureInvalid faceCaptureInvalid) {
            super(null);
            Intrinsics.checkNotNullParameter(faceCaptureInvalid, "cause");
            this.cause = faceCaptureInvalid;
        }
    ...
    public static final /* data */ class ValidFace extends FaceCaptureState {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ValidFace(byte[] bArr, Rect rect, Rect rect2, FacialLandmarks facialLandmarks, FacialLandmarks facialLandmarks2, Float f) {
            super(null);
            Intrinsics.checkNotNullParameter(bArr, "croppedImage");
            Intrinsics.checkNotNullParameter(rect, "croppedFaceBoundingBox");
            Intrinsics.checkNotNullParameter(rect2, "faceBoundingBox");
            Intrinsics.checkNotNullParameter(facialLandmarks, "originalLandmarks");
            Intrinsics.checkNotNullParameter(facialLandmarks2, "croppedLandmarks");
            this.croppedImage = bArr;
            this.croppedFaceBoundingBox = rect;
            this.faceBoundingBox = rect2;
            this.originalLandmarks = facialLandmarks;
            this.croppedLandmarks = facialLandmarks2;
            this.smileScore = f;
        }
    }
}
