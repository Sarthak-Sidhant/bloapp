...
public class StrSubstitutor {
                        ...
                        if (iIsMatch3 == 0) {
                            ...
                            if (i10 == 0) {
                                ...
                                if (valueDelimiterMatcher != null) {
                                    ...
                                    int i12 = 0;
                                    while (true) {
                                        if (i12 >= charArray.length || !(zIsEnableSubstitutionInVariables || variablePrefixMatcher.isMatch(charArray, i12, i12, charArray.length) == 0)) {
                                            strMatcher = variablePrefixMatcher;
                                        } else {
                                    ...
                                    arrayList.add(str);
                                    strResolveVariable = resolveVariable(str, strBuilder, i3, i11);
                                ...
                                if (strSubstring != null) {
                                    ...
                                    strBuilder.replace(i3, i11, strSubstring);
                                    int iSubstitute2 = (substitute(strBuilder, i3, length2, arrayList) + length2) - (i11 - i3);
                                    i4 += iSubstitute2;
                                    i5 += iSubstitute2;
                                    cArr = strBuilder.buffer;
                                    i3 = i11 + iSubstitute2;
    ...
    private void checkCyclicSubstitution(String str, List<String> list) {
        if (list.contains(str)) {
            StrBuilder strBuilder = new StrBuilder(CpioConstants.C_IRUSR);
