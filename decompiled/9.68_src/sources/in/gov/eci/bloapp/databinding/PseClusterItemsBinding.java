...
public final class PseClusterItemsBinding implements ViewBinding {
    ...
    public final TextView electorNamelable;
    public final TextView electorNametv;
    ...
    private PseClusterItemsBinding(ConstraintLayout rootView, TextView ACPartNO, TextView SerialNoTv, TextView acnoName, LinearLayout actionTokenLayout, TextView addressEt, TextView addressTv, TextView electorNamelable, TextView electorNametv, TextView epicNo, ImageView imageView9, ConstraintLayout layout, LinearLayout lvWatermark, TextView parnumber, View view2) {
        ...
        this.electorNamelable = electorNamelable;
        this.electorNametv = electorNametv;
        this.epicNo = epicNo;
    ...
    public static PseClusterItemsBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static PseClusterItemsBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.pse_cluster_items, parent, false);
        if (attachToParent) {
    ...
    public static PseClusterItemsBinding bind(View rootView) {
                ...
                if (textView3 != null) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (textView4 != null) {
                            ...
                            if (textView5 != null) {
                                i = R.id.electorNamelable;
                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.electorNamelable);
                                if (textView6 != null) {
                                    i = R.id.electorNametv;
                                    TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.electorNametv);
                                    if (textView7 != null) {
                                        i = R.id.epic_no;
                                            ...
                                            if (imageView != null) {
                                                ...
                                                if (constraintLayoutFindChildViewById != null) {
                                                    ...
                                                    if (linearLayout2 != null) {
                                                        i = R.id.parnumber;
                                                        TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.parnumber);
                                                        if (textView9 != null) {
                                                            i = R.id.view2;
                                                            View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.view2);
                                                            if (viewFindChildViewById != null) {
                                                                return new PseClusterItemsBinding((ConstraintLayout) rootView, textView, textView2, textView3, linearLayout, textView4, textView5, textView6, textView7, textView8, imageView, constraintLayoutFindChildViewById, linearLayout2, textView9, viewFindChildViewById);
                                                            }
                                                        }
                                                    }
                                                }
