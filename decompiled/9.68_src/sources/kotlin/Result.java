...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m5264boximpl(Object obj) {
        return new Result(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m5265constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m5266equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5267equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m5270hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m5266equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m5270hashCodeimpl(this.value);
    }
    ...
    public static final boolean m5272isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* JADX INFO: renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m5271isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m5269getOrNullimpl(Object obj) {
        if (m5271isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m5268exceptionOrNullimpl(Object obj) {
    ...
    public String toString() {
        return m5273toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m5273toStringimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m5265constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m5265constructorimpl(ResultKt.createFailure(exception));
        }
    }
