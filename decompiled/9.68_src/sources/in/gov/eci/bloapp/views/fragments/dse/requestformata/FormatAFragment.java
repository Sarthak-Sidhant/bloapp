...
public class FormatAFragment extends BaseFragment {
    ...
    private String photoref = StringUtils.SPACE;
    ...
    class AnonymousClass2 implements GenericRecyclerView.GenericRecyclerViewInterface {
        ...
        public void onBindViewHolder(RecyclerViewHolder holder, int position) {
            ...
            ((BloFormataPendingRvItemBinding) holder.binding).applicantName.setText(((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getApplicantFirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getApplicantLastname());
            ((BloFormataPendingRvItemBinding) holder.binding).layout.setBackgroundColor(Color.parseColor("#ffffff"));
            final String str = ((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getApplicantFirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getApplicantLastname();
            ...
            final String str2 = ((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getRelationfirstname() + StringUtils.SPACE + ((clusterDetailsDseModel) FormatAFragment.this.allhousesList.get(position)).getRelationlastname();
    ...
    public /* synthetic */ void lambda$bottomSheet$7(String str, String str2, String str3, String str4, String str5, String str6, View view) {
        ...
        if (str7 == null || str7.equals("null") || this.photoref.equals("") || this.photoref.equals(StringUtils.SPACE)) {
