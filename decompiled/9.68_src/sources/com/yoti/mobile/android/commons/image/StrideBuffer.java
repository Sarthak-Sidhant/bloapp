...
public class StrideBuffer implements ImageBuffer {
    ...
    public StrideBuffer(int i, int i2, byte[] raw) {
        this(i, i2, raw, 0, 0, 24, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(raw, "raw");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public StrideBuffer(int i, int i2, byte[] raw, int i3) {
        this(i, i2, raw, i3, 0, 16, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(raw, "raw");
    }
