...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(getValues(), index, obj, (Object) null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (hashedWeakRef != null) {
                    ...
                    if (Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(getKeys(), iIndex, (Object) null, weakKey0)) {
                        break;
                    }
                } else {
                    return null;
