...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM5265constructorimpl = Result.m5265constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5268exceptionOrNullimpl(objM5265constructorimpl) == null) {
            obj2 = objM5265constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM5265constructorimpl2 = Result.m5265constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM5265constructorimpl2 = Result.m5265constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5268exceptionOrNullimpl(objM5265constructorimpl2) == null) {
            obj = objM5265constructorimpl2;
        }
