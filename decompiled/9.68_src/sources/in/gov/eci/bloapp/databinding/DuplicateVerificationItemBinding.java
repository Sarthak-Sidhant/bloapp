...
public final class DuplicateVerificationItemBinding implements ViewBinding {
    ...
    private DuplicateVerificationItemBinding(LinearLayout rootView, TextView acName, TextView address, TextView call, LinearLayout cardViewLL, TextView categoryTypeLabel, TextView electorName, TextView epic, LinearLayout llDeceased, LinearLayout lvAsd, LinearLayout lvCluster, LinearLayout lvEightfive, TextView partNo, TextView serialNo, TextView state, TextView tvAsd, TextView tvClusterid, TextView uncollectablePendingSir, TextView viewDetails, TextView viewDetailsElector) {
    ...
    public static DuplicateVerificationItemBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static DuplicateVerificationItemBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.duplicate_verification_item, parent, false);
        if (attachToParent) {
    ...
    public static DuplicateVerificationItemBinding bind(View rootView) {
        int i = R.id.acName;
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                i = R.id.call;
                TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, R.id.call);
                if (textView3 != null) {
                    i = R.id.cardViewLL;
                                                    ...
                                                    if (textView7 != null) {
                                                        ...
                                                        if (textView8 != null) {
                                                            ...
                                                            if (textView9 != null) {
                                                                ...
                                                                if (textView10 != null) {
                                                                    i = R.id.tv_clusterid;
                                                                    TextView textView11 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_clusterid);
                                                                    if (textView11 != null) {
                                                                        i = R.id.uncollectable_pending_sir;
                                                                        TextView textView12 = (TextView) ViewBindings.findChildViewById(rootView, R.id.uncollectable_pending_sir);
                                                                        if (textView12 != null) {
                                                                            i = R.id.viewDetails;
                                                                            TextView textView13 = (TextView) ViewBindings.findChildViewById(rootView, R.id.viewDetails);
                                                                            if (textView13 != null) {
                                                                                ...
                                                                                if (textView14 != null) {
                                                                                    return new DuplicateVerificationItemBinding((LinearLayout) rootView, textView, textView2, textView3, linearLayout, textView4, textView5, textView6, linearLayout2, linearLayout3, linearLayout4, linearLayout5, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
