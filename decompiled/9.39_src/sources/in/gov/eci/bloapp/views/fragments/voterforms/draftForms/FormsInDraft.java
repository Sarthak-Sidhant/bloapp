...
public class FormsInDraft extends Hilt_FormsInDraft implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.addhar_auth /* 2131362201 */:
                ...
                break;
            case R.id.back_btn_iv /* 2131362458 */:
                openFragment1(new VoterFormsFragment(), this.forms);
                break;
            case R.id.deletion_Objection /* 2131363114 */:
                ...
                break;
            case R.id.new_vot_reg /* 2131364826 */:
                ...
                break;
            case R.id.overseas_Elector_Voter /* 2131364993 */:
                ...
                break;
            case R.id.shifting_correctness /* 2131365708 */:
