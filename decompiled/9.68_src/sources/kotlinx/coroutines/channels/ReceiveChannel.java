...
public interface ReceiveChannel<E> {
    ...
    Object mo6762receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo6763tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo6763tryReceivePtdJZtk = receiveChannel.mo6763tryReceivePtdJZtk();
            if (ChannelResult.m6779isSuccessimpl(objMo6763tryReceivePtdJZtk)) {
                return (E) ChannelResult.m6775getOrThrowimpl(objMo6763tryReceivePtdJZtk);
            }
            Throwable thM6773exceptionOrNullimpl = ChannelResult.m6773exceptionOrNullimpl(objMo6763tryReceivePtdJZtk);
            if (thM6773exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM6773exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object objMo6762receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo6762receiveCatchingJP2dKIU = receiveChannel.mo6762receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo6762receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo6762receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m6774getOrNullimpl(objMo6762receiveCatchingJP2dKIU);
        }
