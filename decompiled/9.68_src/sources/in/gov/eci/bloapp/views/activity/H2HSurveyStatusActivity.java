    ...
    private void initRecyclerViewAdapter() {
        this.adapter = new GenericRecyclerView(new GenericRecyclerView.GenericRecyclerViewInterface() { // from class: in.gov.eci.bloapp.views.activity.H2HSurveyStatusActivity.1
            ...
            public void onBindViewHolder(RecyclerViewHolder holder, int position) {
                ...
                ((BloAllStatusRvItemsBinding) holder.binding).applicantNameEd.setText(H2HSurveyStatusActivity.this.h2hSurveyStatusDraftList.get(position).getApplicantFirstName() + StringUtils.SPACE + H2HSurveyStatusActivity.this.h2hSurveyStatusDraftList.get(position).getApplicantLastName());
