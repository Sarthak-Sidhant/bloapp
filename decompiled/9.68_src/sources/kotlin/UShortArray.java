...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m5597boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m5599constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m5602equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5603equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m5606hashCodeimpl(short[] sArr) {
        return Arrays.hashCode(sArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m5610toStringimpl(short[] sArr) {
    ...
    public boolean m5611addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object other) {
        return m5602equalsimpl(this.storage, other);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m5606hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m5610toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m5612containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m5598constructorimpl(int i) {
        return m5599constructorimpl(new short[i]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m5604getMh2AYeg(short[] sArr, int i) {
        return UShort.m5546constructorimpl(sArr[i]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m5609set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m5605getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public int size() {
        return m5605getSizeimpl(this.storage);
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UShort> m5608iteratorimpl(short[] sArr) {
        return new Iterator(sArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UShort> iterator() {
        return m5608iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m5540boximpl(m5614nextMh2AYeg());
        }
    ...
    public boolean m5612containsxj2QHRw(short s) {
        return m5600containsxj2QHRw(this.storage, s);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m5600containsxj2QHRw(short[] sArr, short s) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m5601containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m5601containsAllimpl(short[] sArr, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m5607isEmptyimpl(short[] sArr) {
        return sArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m5607isEmptyimpl(this.storage);
    }
}
