...
public final class ActivityFormDataPage1BhBinding implements ViewBinding {
    ...
    public static ActivityFormDataPage1BhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityFormDataPage1BhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_form_data_page1_bh, parent, false);
        if (attachToParent) {
    ...
    public static ActivityFormDataPage1BhBinding bind(View rootView) {
