...
public class UploadCaller {
    ...
    public void uploadFileInBackground(final Context context, final String presignedUrl, final File file, final ValidationEFCallback validationEFCallback) {
        this.executor.execute(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.newsir.network.UploadCaller$$ExternalSyntheticLambda0
    ...
    public /* synthetic */ void lambda$uploadFileInBackground$4(Context context, String str, File file, final ValidationEFCallback validationEFCallback) {
        try {
            Response responseUploadToPresignedPut = new S3Uploader(context).uploadToPresignedPut(str, file, "image/jpeg", new S3Uploader.ProgressListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.network.UploadCaller$$ExternalSyntheticLambda2
            ...
            try {
                ...
                this.mainHandler.post(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.newsir.network.UploadCaller$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        UploadCaller.lambda$uploadFileInBackground$2(validationEFCallback, iCode);
                    }
                });
            } finally {
            ...
            this.mainHandler.post(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.newsir.network.UploadCaller$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    UploadCaller.lambda$uploadFileInBackground$3(validationEFCallback, e);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$uploadFileInBackground$1(long j, long j2) {
        ...
        this.mainHandler.post(new Runnable() { // from class: in.gov.eci.bloapp.views.activity.newsir.network.UploadCaller$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
