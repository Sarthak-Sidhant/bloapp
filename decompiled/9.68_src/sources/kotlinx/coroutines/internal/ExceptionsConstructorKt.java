...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM5265constructorimpl = Result.m5265constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM5265constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM5265constructorimpl = Result.m5265constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m5271isFailureimpl(objM5265constructorimpl) ? null : objM5265constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5265constructorimpl = Result.m5265constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5271isFailureimpl(objM5265constructorimpl)) {
            objM5265constructorimpl = numValueOf;
        }
        return ((Number) objM5265constructorimpl).intValue();
    }
