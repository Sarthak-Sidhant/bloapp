...
public final class SchedulerCoroutineDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo6814dispatch(CoroutineContext context, Runnable block) {
        this.scheduler.scheduleDirect(block);
    }

    @Override // kotlinx.coroutines.Delay
    /* JADX INFO: renamed from: scheduleResumeAfterDelay */
    public void mo6815scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
