...
public class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m6820getSegmentimpl(objFindSegmentInternal);
        int i = (int) (andIncrement % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (!Striped$SmallLazyStriped$.ExternalSyntheticBackportWithForwarding0.m(semaphoreSegment2.getAcquirers(), i, (Object) null, waiter)) {
