...
public final class BufferConversion {
    public static final byte[] toJpeg(ImageBuffer imageBuffer, ImageQuality quality) {
        ...
        byte[] toJpeg = byteArrayOutputStream.toByteArray();
        Intrinsics.checkNotNullExpressionValue(toJpeg, "toJpeg");
        return toJpeg;
    }
}
