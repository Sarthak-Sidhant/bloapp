...
public final class BloFragmentForgotpasswordPinBinding implements ViewBinding {
    ...
    private BloFragmentForgotpasswordPinBinding(ConstraintLayout rootView, TextView backBtnIv, LinearLayout forgetPasswordLayout, ImageView imageView4, LinearLayout linearLayout5, TextView mobileno, TextView otpTimer, PinView pinView, TextView textView19, TextView verifyOtpLayout) {
    ...
    public static BloFragmentForgotpasswordPinBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BloFragmentForgotpasswordPinBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.blo_fragment_forgotpassword_pin, parent, false);
        if (attachToParent) {
    ...
    public static BloFragmentForgotpasswordPinBinding bind(View rootView) {
                            ...
                            if (textView3 != null) {
                                ...
                                if (pinViewFindChildViewById != null) {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (textView5 != null) {
                                            return new BloFragmentForgotpasswordPinBinding((ConstraintLayout) rootView, textView, linearLayout, imageView, linearLayout2, textView2, textView3, pinViewFindChildViewById, textView4, textView5);
                                        }
                                    }
                                }
                            }
