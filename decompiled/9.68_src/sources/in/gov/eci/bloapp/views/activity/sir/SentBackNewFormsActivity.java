...
import in.gov.eci.bloapp.adapter.SentbackNewFormAdapter;
...
public class SentBackNewFormsActivity extends SuperBaseActivity {
    private static final int REQUEST_CODE_CAMERA_PORTRAIT = 1221;
    private String acNo;
    SentbackNewFormAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.adapter = new SentbackNewFormAdapter(this.rollBackSearchList, this);
    ...
    private void getAllRollBackNew() {
        ...
        Call<JsonObject> uncollectableRollBackFormsSIR = this.service.getUncollectableRollBackFormsSIR(map, map2);
        this.alertDialog.show();
        uncollectableRollBackFormsSIR.enqueue(new AnonymousClass1());
    }

    /* JADX INFO: renamed from: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity$1, reason: invalid class name */
    class AnonymousClass1 implements Callback<JsonObject> {
        AnonymousClass1() {
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r2v1, types: [android.content.Context, in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity] */
            ...
            try {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        Long lValueOf = Long.valueOf(jSONObject.optLong("epicNo"));
                        SentBackNewFormsActivity.this.rollBackNewList.add(new RollbackNewModel(jSONObject.optString("electorName", null), strOptString, lValueOf, jSONObject.optString("partSerialNo", null), jSONObject.optString("backToBloRemarks", null), jSONObject.optString("efFrontUrl", ""), jSONObject.optString("efBackUrl", ""), jSONObject.optString("suppDoc1Url", ""), jSONObject.optString("suppDoc2Url", ""), jSONObject.optString("uncollectableReason", ""), jSONObject.optString("enrolledEpicNo", "")));
                    }
                    SentBackNewFormsActivity.this.rollBackSearchList.addAll(SentBackNewFormsActivity.this.rollBackNewList);
                    SentBackNewFormsActivity.this.binding.recyclerView.setAdapter(SentBackNewFormsActivity.this.adapter);
                    SentBackNewFormsActivity.this.alertDialog.dismiss();
                    SentBackNewFormsActivity.this.binding.search.addTextChangedListener(new TextWatcher() { // from class: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity.1.1
                        ...
                        public void afterTextChanged(Editable editable) {
                            ...
                            for (RollbackNewModel rollbackNewModel : SentBackNewFormsActivity.this.rollBackSearchList) {
                                if (rollbackNewModel.getEpicNo().toLowerCase().contains(string.toLowerCase())) {
                                    arrayList.add(rollbackNewModel);
                                }
                            }
                            SentBackNewFormsActivity.this.adapter.fun(arrayList);
                        }
                    });
                    return;
                }
                if (response.code() == 400 || response.code() == 401) {
                    if (SentBackNewFormsActivity.this.alertDialog != null) {
                        SentBackNewFormsActivity.this.alertDialog.dismiss();
                    }
                    CommomUtility commomUtility = SentBackNewFormsActivity.this.commomUtility;
                    ?? r2 = SentBackNewFormsActivity.this;
                    commomUtility.showMessageOK(r2, r2.SESSION, new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity$1$$ExternalSyntheticLambda0
                ...
                try {
                    ...
                    SentBackNewFormsActivity sentBackNewFormsActivity = SentBackNewFormsActivity.this;
                    sentBackNewFormsActivity.showDialog1(sentBackNewFormsActivity.getString(R.string.alertMsg), strOptString2);
        ...
        public /* synthetic */ void lambda$onResponse$0(DialogInterface dialogInterface, int i) {
            SharedPref.getInstance(SentBackNewFormsActivity.this.getApplicationContext()).setIsLoggedIn(false);
            SharedPref.getInstance(SentBackNewFormsActivity.this.getApplicationContext()).setLocaleBool(false);
            SentBackNewFormsActivity.this.startActivity(new Intent(SentBackNewFormsActivity.this.getApplicationContext(), (Class<?>) LoginActivity.class));
        }
    ...
    private void initClickListener() {
        this.binding.backBtnIv.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initClickListener$0(view);
            }
        });
        this.binding.scanCode.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                SentBackNewFormsActivity.this.cameraPermission();
            }
        });
    }
    ...
    public void showDialog1(String alertText, String message) {
        ...
        new android.app.AlertDialog.Builder(this).setTitle(alertText).setMessage(message).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.SentBackNewFormsActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
