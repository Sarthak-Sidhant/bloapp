...
public class FacilitiesRemarkDetailsModel {
    ...
    public FacilitiesRemarkDetailsModel(String provisionRamp, String drinkingWater, String amfAdequateFurniture, String lighting, String helpDesk, String signnage, String toilet, String permanentRamp, String emfAdequateFurniture, String shatter, String roadConnectivity, String crossing, String landlineFaxConnection, String mobileConnectivity, String electricityArrangements, String internetFacility, String signance, String lweAffectedArea, String forestArea, String vulnerableLocation, String sensitivePs, String buildingQuality, String psLessThan20, String buildingStatus, String governmentPs, String religiousPs, String schoolPs, String groundFloorPs, String separateEntryExit, String provisionRampRemarks, String drinkingWaterRemarks, String amfAdequateFurnitureRemarks, String lightingRemarks, String helpDeskRemarks, String signnageRemarks, String toiletRemarks, String permanentRampRemarks, String emfAdequateFurnitureRemarks, String shatterRemarks, String roadConnectivityRemarks, String crossingRemarks, String landlineFaxConnectionRemarks, String mobileConnectivityRemarks, String electricityArrangementsRemarks, String internetFacilityRemarks, String signanceRemarks, String lweAffectedAreaRemarks, String forestAreaRemarks, String vulnerableLocationRemarks, String sensitivePsRemarks, String buildingQualityRemarks, String psLessThan20Remarks, String buildingStatusRemarks, String governmentPsRemarks, String religiousPsRemarks, String schoolPsRemarks, String groundFloorPsRemarks, String separateEntryExitRemarks, String provisionRampAMFEMFStatus, String drinkingWaterAMFEMFStatus, String amfAdequateFurnitureAMFEMFStatus, String lightingAMFEMFStatus, String helpDeskAMFEMFStatus, String signnageAMFEMFStatus, String toiletAMFEMFStatus, String permanentRampAMFEMFStatus, String emfAdequateFurnitureAMFEMFStatus, String shatterAMFEMFStatus, String roadConnectivityAMFEMFStatus, String crossingAMFEMFStatus, String landlineFaxConnectionAMFEMFStatus, String mobileConnectivityAMFEMFStatus, String electricityArrangementsAMFEMFStatus, String internetFacilityAMFEMFStatus, String signanceAMFEMFStatus, String lweAffectedAreaAMFEMFStatus, String forestAreaAMFEMFStatus, String vulnerableLocationAMFEMFStatus, String sensitivePsAMFEMFStatus, String buildingQualityAMFEMFStatus, String psLessThan20AMFEMFStatus, String buildingStatusAMFEMFStatus, String governmentPsAMFEMFStatus, String religiousPsAMFEMFStatus, String schoolPsAMFEMFStatus, String groundFloorPsAMFEMFStatus, String separateEntryExitAMFEMFStatus, String provisionRampApprovalStatus, String drinkingWaterApprovalStatus, String amfAdequateFurnitureApprovalStatus, String lightingApprovalStatus, String helpDeskApprovalStatus, String signnageApprovalStatus, String toiletApprovalStatus, String permanentRampApprovalStatus, String emfAdequateFurnitureApprovalStatus, String shatterApprovalStatus, String roadConnectivityApprovalStatus, String crossingApprovalStatus, String landlineFaxConnectionApprovalStatus, String mobileConnectivityApprovalStatus, String electricityArrangementsApprovalStatus, String internetFacilityApprovalStatus, String signanceApprovalStatus, String lweAffectedAreaApprovalStatus, String forestAreaApprovalStatus, String vulnerableLocationApprovalStatus, String sensitivePsApprovalStatus, String buildingQualityApprovalStatus, String psLessThan20ApprovalStatus, String buildingStatusApprovalStatus, String governmentPsApprovalStatus, String religiousPsApprovalStatus, String schoolPsApprovalStatus, String groundFloorPsApprovalStatus, String separateEntryExitApprovalStatus, String provisionRampRating, String drinkingWaterRating, String amfAdequateFurnitureRating, String lightingRating, String helpDeskRating, String signnageRating, String toiletRating, String permanentRampRating, String emfAdequateFurnitureRating, String shatterRating, String roadConnectivityRating, String crossingRating, String landlineFaxConnectionRating, String mobileConnectivityRating, String electricityArrangementsRating, String internetFacilityRating, String signanceRating, String lweAffectedAreaRating, String forestAreaRating, String vulnerableLocationRating, String sensitivePsRating, String buildingQualityRating, String psLessThan20Rating, String buildingStatusRating, String governmentPsRating, String religiousPsRating, String schoolPsRating, String groundFloorPsRating, String separateEntryExitRating) {
        this.provisionRamp = provisionRamp;
        this.drinkingWater = drinkingWater;
        this.amfAdequateFurniture = amfAdequateFurniture;
        this.lighting = lighting;
        this.helpDesk = helpDesk;
        this.signnage = signnage;
        this.toilet = toilet;
        this.permanentRamp = permanentRamp;
        this.emfAdequateFurniture = emfAdequateFurniture;
        this.shatter = shatter;
        this.roadConnectivity = roadConnectivity;
        this.crossing = crossing;
        this.landlineFaxConnection = landlineFaxConnection;
        this.mobileConnectivity = mobileConnectivity;
        this.electricityArrangements = electricityArrangements;
        this.internetFacility = internetFacility;
        this.signance = signance;
        this.lweAffectedArea = lweAffectedArea;
        this.forestArea = forestArea;
        this.vulnerableLocation = vulnerableLocation;
        this.sensitivePs = sensitivePs;
        this.buildingQuality = buildingQuality;
        this.psLessThan20 = psLessThan20;
        this.buildingStatus = buildingStatus;
        this.governmentPs = governmentPs;
        this.religiousPs = religiousPs;
        this.schoolPs = schoolPs;
        this.groundFloorPs = groundFloorPs;
        this.separateEntryExit = separateEntryExit;
        this.provisionRampRemarks = provisionRampRemarks;
        this.drinkingWaterRemarks = drinkingWaterRemarks;
        this.amfAdequateFurnitureRemarks = amfAdequateFurnitureRemarks;
        this.lightingRemarks = lightingRemarks;
        this.helpDeskRemarks = helpDeskRemarks;
        this.signnageRemarks = signnageRemarks;
        this.toiletRemarks = toiletRemarks;
        this.permanentRampRemarks = permanentRampRemarks;
        this.emfAdequateFurnitureRemarks = emfAdequateFurnitureRemarks;
        this.shatterRemarks = shatterRemarks;
        this.roadConnectivityRemarks = roadConnectivityRemarks;
        this.crossingRemarks = crossingRemarks;
        this.landlineFaxConnectionRemarks = landlineFaxConnectionRemarks;
        this.mobileConnectivityRemarks = mobileConnectivityRemarks;
        this.electricityArrangementsRemarks = electricityArrangementsRemarks;
        this.internetFacilityRemarks = internetFacilityRemarks;
        this.signanceRemarks = signanceRemarks;
        this.lweAffectedAreaRemarks = lweAffectedAreaRemarks;
        this.forestAreaRemarks = forestAreaRemarks;
        this.vulnerableLocationRemarks = vulnerableLocationRemarks;
        this.sensitivePsRemarks = sensitivePsRemarks;
        this.buildingQualityRemarks = buildingQualityRemarks;
        this.psLessThan20Remarks = psLessThan20Remarks;
        this.buildingStatusRemarks = buildingStatusRemarks;
        this.governmentPsRemarks = governmentPsRemarks;
        this.religiousPsRemarks = religiousPsRemarks;
        this.schoolPsRemarks = schoolPsRemarks;
        this.groundFloorPsRemarks = groundFloorPsRemarks;
        this.separateEntryExitRemarks = separateEntryExitRemarks;
        this.provisionRampAMFEMFStatus = provisionRampAMFEMFStatus;
        this.drinkingWaterAMFEMFStatus = drinkingWaterAMFEMFStatus;
        this.amfAdequateFurnitureAMFEMFStatus = amfAdequateFurnitureAMFEMFStatus;
        this.lightingAMFEMFStatus = lightingAMFEMFStatus;
        this.helpDeskAMFEMFStatus = helpDeskAMFEMFStatus;
        this.signnageAMFEMFStatus = signnageAMFEMFStatus;
        this.toiletAMFEMFStatus = toiletAMFEMFStatus;
        this.permanentRampAMFEMFStatus = permanentRampAMFEMFStatus;
        this.emfAdequateFurnitureAMFEMFStatus = emfAdequateFurnitureAMFEMFStatus;
        this.shatterAMFEMFStatus = shatterAMFEMFStatus;
        this.roadConnectivityAMFEMFStatus = roadConnectivityAMFEMFStatus;
        this.crossingAMFEMFStatus = crossingAMFEMFStatus;
        this.landlineFaxConnectionAMFEMFStatus = landlineFaxConnectionAMFEMFStatus;
        this.mobileConnectivityAMFEMFStatus = mobileConnectivityAMFEMFStatus;
        this.electricityArrangementsAMFEMFStatus = electricityArrangementsAMFEMFStatus;
        this.internetFacilityAMFEMFStatus = internetFacilityAMFEMFStatus;
        this.signanceAMFEMFStatus = signanceAMFEMFStatus;
        this.lweAffectedAreaAMFEMFStatus = lweAffectedAreaAMFEMFStatus;
        this.forestAreaAMFEMFStatus = forestAreaAMFEMFStatus;
        this.vulnerableLocationAMFEMFStatus = vulnerableLocationAMFEMFStatus;
        this.sensitivePsAMFEMFStatus = sensitivePsAMFEMFStatus;
        this.buildingQualityAMFEMFStatus = buildingQualityAMFEMFStatus;
        this.psLessThan20AMFEMFStatus = psLessThan20AMFEMFStatus;
        this.buildingStatusAMFEMFStatus = buildingStatusAMFEMFStatus;
        this.governmentPsAMFEMFStatus = governmentPsAMFEMFStatus;
        this.religiousPsAMFEMFStatus = religiousPsAMFEMFStatus;
        this.schoolPsAMFEMFStatus = schoolPsAMFEMFStatus;
        this.groundFloorPsAMFEMFStatus = groundFloorPsAMFEMFStatus;
        this.separateEntryExitAMFEMFStatus = separateEntryExitAMFEMFStatus;
        this.provisionRampApprovalStatus = provisionRampApprovalStatus;
        this.drinkingWaterApprovalStatus = drinkingWaterApprovalStatus;
        this.amfAdequateFurnitureApprovalStatus = amfAdequateFurnitureApprovalStatus;
        this.lightingApprovalStatus = lightingApprovalStatus;
        this.helpDeskApprovalStatus = helpDeskApprovalStatus;
        this.signnageApprovalStatus = signnageApprovalStatus;
        this.toiletApprovalStatus = toiletApprovalStatus;
        this.permanentRampApprovalStatus = permanentRampApprovalStatus;
        this.emfAdequateFurnitureApprovalStatus = emfAdequateFurnitureApprovalStatus;
        this.shatterApprovalStatus = shatterApprovalStatus;
        this.roadConnectivityApprovalStatus = roadConnectivityApprovalStatus;
        this.crossingApprovalStatus = crossingApprovalStatus;
        this.landlineFaxConnectionApprovalStatus = landlineFaxConnectionApprovalStatus;
        this.mobileConnectivityApprovalStatus = mobileConnectivityApprovalStatus;
        this.electricityArrangementsApprovalStatus = electricityArrangementsApprovalStatus;
        this.internetFacilityApprovalStatus = internetFacilityApprovalStatus;
        this.signanceApprovalStatus = signanceApprovalStatus;
        this.lweAffectedAreaApprovalStatus = lweAffectedAreaApprovalStatus;
        this.forestAreaApprovalStatus = forestAreaApprovalStatus;
        this.vulnerableLocationApprovalStatus = vulnerableLocationApprovalStatus;
        this.sensitivePsApprovalStatus = sensitivePsApprovalStatus;
        this.buildingQualityApprovalStatus = buildingQualityApprovalStatus;
        this.psLessThan20ApprovalStatus = psLessThan20ApprovalStatus;
        this.buildingStatusApprovalStatus = buildingStatusApprovalStatus;
        this.governmentPsApprovalStatus = governmentPsApprovalStatus;
        this.religiousPsApprovalStatus = religiousPsApprovalStatus;
        this.schoolPsApprovalStatus = schoolPsApprovalStatus;
        this.groundFloorPsApprovalStatus = groundFloorPsApprovalStatus;
        this.separateEntryExitApprovalStatus = separateEntryExitApprovalStatus;
        this.provisionRampRating = provisionRampRating;
        this.drinkingWaterRating = drinkingWaterRating;
        this.amfAdequateFurnitureRating = amfAdequateFurnitureRating;
        this.lightingRating = lightingRating;
        this.helpDeskRating = helpDeskRating;
        this.signnageRating = signnageRating;
        this.toiletRating = toiletRating;
        this.permanentRampRating = permanentRampRating;
        this.emfAdequateFurnitureRating = emfAdequateFurnitureRating;
        this.shatterRating = shatterRating;
        this.roadConnectivityRating = roadConnectivityRating;
        this.crossingRating = crossingRating;
        this.landlineFaxConnectionRating = landlineFaxConnectionRating;
        this.mobileConnectivityRating = mobileConnectivityRating;
        this.electricityArrangementsRating = electricityArrangementsRating;
        this.internetFacilityRating = internetFacilityRating;
        this.signanceRating = signanceRating;
        this.lweAffectedAreaRating = lweAffectedAreaRating;
        this.forestAreaRating = forestAreaRating;
        this.vulnerableLocationRating = vulnerableLocationRating;
        this.sensitivePsRating = sensitivePsRating;
        this.buildingQualityRating = buildingQualityRating;
        this.psLessThan20Rating = psLessThan20Rating;
        this.buildingStatusRating = buildingStatusRating;
        this.governmentPsRating = governmentPsRating;
        this.religiousPsRating = religiousPsRating;
        this.schoolPsRating = schoolPsRating;
        this.groundFloorPsRating = groundFloorPsRating;
        this.separateEntryExitRating = separateEntryExitRating;
    }
