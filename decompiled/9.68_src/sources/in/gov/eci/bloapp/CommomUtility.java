...
public class CommomUtility {
        ...
        ((UserClient) ApiClient.getClient(context).create(UserClient.class)).getaddproof(Token, atkn, rtkn, "BLOAPP", this.currentRole, "ANDROIDMOB").enqueue(new Callback<JSONArray>() { // from class: in.gov.eci.bloapp.CommomUtility.11
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                if (response.code() == 200) {
                    ...
                    for (int i = 0; i < jSONArray.size(); i++) {
                        JsonObject asJsonObject = CommomUtility.this.gson.toJsonTree(jSONArray.get(i)).getAsJsonObject();
                        if ("ADHR".equalsIgnoreCase(asJsonObject.get("code").getAsString())) {
                    ...
                    for (int i2 = 0; i2 < jSONArray2.size(); i2++) {
                        JsonObject asJsonObject2 = CommomUtility.this.gson.toJsonTree(jSONArray2.get(i2)).getAsJsonObject();
                        arrayList.add(String.valueOf(asJsonObject2.get(CommomUtility.this.codeDescText)).substring(1, String.valueOf(asJsonObject2.get(CommomUtility.this.codeDescText)).length() - 1));
                        CommomUtility.this.addproofcode.add(String.valueOf(asJsonObject2.get(CommomUtility.this.codeText)).substring(1, String.valueOf(asJsonObject2.get(CommomUtility.this.codeText)).length() - 1));
                    }
            ...
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                if (response.code() == 200) {
                    ...
                    for (int i2 = 0; i2 < jSONArray2.size(); i2++) {
                        JsonObject asJsonObject2 = CommomUtility.this.gson.toJsonTree(jSONArray2.get(i2)).getAsJsonObject();
                        arrayList.add(String.valueOf(asJsonObject2.get(CommomUtility.this.codeDescText)).substring(1, String.valueOf(asJsonObject2.get(CommomUtility.this.codeDescText)).length() - 1));
                        CommomUtility.this.ageroofcode.add(String.valueOf(asJsonObject2.get(CommomUtility.this.codeText)).substring(1, String.valueOf(asJsonObject2.get(CommomUtility.this.codeText)).length() - 1));
                    }
    ...
    public void getVerifiedList(Context context, String stateCode, String atkBand, String rtkBand, String token, String currentRole, MyResponse myCallback) {
        ...
        map.put("pageSize", Integer.valueOf(XmlValidationError.LIST_INVALID));
    ...
    class AnonymousClass54 implements Callback<JsonObject> {
        ...
        public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
            if (response.code() == 200) {
                ...
                if (!CommomUtility.this.submitResponse.get("Status").getAsString().equals(BooleanUtils.FALSE)) {
    ...
    public void getPseVerifiedList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackPse verifyCitizenListCallback) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", token);
        map.put("currentRole", "blo");
        map.put("state", state);
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getBloActionPseList(state.toLowerCase(), map, map2).enqueue(new Callback<PseFormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.81
            public void onResponse(Call<PseFormVerifyRoot> call, Response<PseFormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<PseVerifyPayload> list = ((PseFormVerifyRoot) response.body()).payload;
                        if (list != null && list.size() > 0) {
                            verifyCitizenListCallback.onCallBack(response.code(), list, "");
                        } else {
                            verifyCitizenListCallback.onCallBack(response.code(), null, "No Record Found");
            ...
            public void onFailure(Call<PseFormVerifyRoot> call, Throwable t) {
                verifyCitizenListCallback.onCallBack(0, null, "");
            }
        });
    }
    ...
    public void getDsepseList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getDsePseElectorList(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.82
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getEpicDeliverStatus(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final EpicDeliverCallback epicDeliverCallback) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", token);
        map.put("currentRole", "blo");
        map.put("state", state);
        ...
        HashMap map2 = new HashMap();
        map2.put("acNo", oldAc);
        map2.put("partNo", null);
        map2.put("stateCd", state);
        map2.put("batchId", null);
        map2.put("fromDate", null);
        map2.put("toDate", null);
        map2.put("pageNumber", 0);
        map2.put("pageSize", Integer.valueOf(XmlValidationError.LIST_INVALID));
        ((UserClient) ApiClient.getClient1(context).create(UserClient.class)).getEpicDeliveryStatus(map, map2).enqueue(new Callback<EpicDeliveryRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.83
            public void onResponse(Call<EpicDeliveryRoot> call, Response<EpicDeliveryRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VoterDataPayload> voterData = ((EpicDeliveryRoot) response.body()).getPayload().getVoterData();
                        if (voterData != null && voterData.size() > 0) {
                            epicDeliverCallback.onCallBack(response.code(), voterData, "");
                        } else {
                            epicDeliverCallback.onCallBack(response.code(), null, "No Record Found");
                        }
                        return;
                    } catch (Exception e) {
                        Logger.e(" List", e.getMessage());
                        Toast.makeText(context, "Something went wrong", 1).show();
                        epicDeliverCallback.onCallBack(response.code(), null, "Something went wrong");
                        return;
                    }
                }
                try {
                    epicDeliverCallback.onCallBack(response.code(), null, new JSONObject(response.errorBody().string()).getString("message"));
                } catch (Exception e2) {
                    Logger.d("TAG", e2.toString());
                    epicDeliverCallback.onCallBack(response.code(), null, "");
                }
            }

            public void onFailure(Call<EpicDeliveryRoot> call, Throwable t) {
                epicDeliverCallback.onCallBack(0, null, "");
            }
        });
    }
    ...
    public void getElectorListForPSEData(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final PSEListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getElectorListForPSEData(state.toLowerCase(), map, map2).enqueue(new Callback<PSEVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.84
    ...
    public void getAnomalyListNew(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final AnomalyListCallback verifyCitizenListCallback) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", token);
        map.put("currentRole", "blo");
        map.put("state", state);
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getAnomalyUserListV2New(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.85
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getAnomalyList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final AnomalyListCallback verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getAnomalyUserListV2(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.86
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getElectorEfList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfMoveToDraftElector(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.87
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getListOfNaCategory(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfNaCategory(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.88
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getNomappingData(final Context context, String token, Long epicId, String atkband, String rtkband, String state, String oldAc, String OldPart, final VerifyCitizenListCallback verifyCitizenListCallback) {
        ...
        map2.put("epicId", epicId);
        map2.put("stCode", state);
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getNoMappingData(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerificationRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.89
            public void onResponse(Call<FormVerificationRoot> call, Response<FormVerificationRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<FormverificationPayload> list = ((FormVerificationRoot) response.body()).payload;
    ...
    public void getDraftData(final Context context, String token, Long epicId, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallback verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getDraftData(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerificationRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.90
            public void onResponse(Call<FormVerificationRoot> call, Response<FormVerificationRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<FormverificationPayload> list = ((FormVerificationRoot) response.body()).payload;
    ...
    public void getSelectPhotoList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfElectorPhoto(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.91
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getAnomalyDataByEpic(final Context context, String token, Long epicId, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallback verifyCitizenListCallback) {
        ...
        map2.put("epicId", epicId);
        map2.put("stCode", state);
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getAnomalyDataByEpic(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerificationRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.92
            public void onResponse(Call<FormVerificationRoot> call, Response<FormVerificationRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<FormverificationPayload> list = ((FormVerificationRoot) response.body()).payload;
    ...
    public void getSelectPhotoList1(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        state.toLowerCase();
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfElectorPhoto1(map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.93
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getDocumentsidList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfHearingScheduleEf(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.94
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void getDetails(final Context context, String token, String atkband, String rtkband, String epicnumber, String state, final DetailsOfEpicCallback searchByAcPartCallback) {
        ...
        map2.put("stateCd", state);
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getDetailsfromEpic(map, map2).enqueue(new Callback<List<DetailsofEpicRoot>>() { // from class: in.gov.eci.bloapp.CommomUtility.95
    ...
    public void getUploadAttendenceList(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallbackNew verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListOfuploadAttendence(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerifyRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.96
            public void onResponse(Call<FormVerifyRoot> call, Response<FormVerifyRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<VerifyPayload> list = ((FormVerifyRoot) response.body()).payload;
    ...
    public void callErollData(final Context context, String token, String atkband, String rtkband, String oldState, String oldAc, String OldPart, String serialnumber, final ErollDataCallback searchByAcPartCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getErollDatafinal(map, map2).enqueue(new Callback<ErollDataModel>() { // from class: in.gov.eci.bloapp.CommomUtility.97
    ...
    public void getListforUpdateMobile(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final UpdateMobileCallback verifyCitizenListCallback) {
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getListofElectorMobile(state.toLowerCase(), map, map2).enqueue(new Callback<UpdateMobileRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.98
    ...
    public void getAllAC2025(String state, String Token, String atkn, String rtkn, Context context, final IAcPartListCallback acpartcallback) {
        final ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        ((UserClient) ApiClient.getClient(context).create(UserClient.class)).getConstituency2025(state, Token, atkn, rtkn, "BLOAPP", this.currentRole, "application/vnd.common.api.v2+json").enqueue(new Callback<JSONArray>() { // from class: in.gov.eci.bloapp.CommomUtility.99
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        Collections.sort(arrayList4, new Comparator<String>() { // from class: in.gov.eci.bloapp.CommomUtility.99.1
    ...
    public void getPartByAc2025(final Context context, int ac, String state, String Token, String atkn, String rtkn, final IAcPartListCallback acPartListCallback) {
        final ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        ((UserClient) ApiClient.getClient(context).create(UserClient.class)).getPartbyACState(String.valueOf(ac), state, Token, atkn, rtkn, "BLOAPP", this.currentRole, state).enqueue(new Callback<JSONArray>() { // from class: in.gov.eci.bloapp.CommomUtility.100
            public void onFailure(Call<JSONArray> call, Throwable t) {
            }
            ...
            public void onResponse(Call<JSONArray> call, Response<JSONArray> response) {
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        ArrayList arrayList4 = new ArrayList(arrayList3.subList(1, arrayList3.size()));
                        Collections.sort(arrayList4, new Comparator<String>() { // from class: in.gov.eci.bloapp.CommomUtility.100.1
                            @Override // java.util.Comparator
                            public int compare(String s1, String s2) {
                                return Integer.compare(Integer.parseInt(s1.split("-")[0].trim()), Integer.parseInt(s2.split("-")[0].trim()));
                            }
    ...
    public void getFVRPending(final Context context, String token, String atkband, String rtkband, String state, String oldAc, String OldPart, int key, final FormatCListCallback verifyCitizenListCallback) {
        ...
        state.toLowerCase();
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getFVRPending(map, map2).enqueue(new Callback<Root>() { // from class: in.gov.eci.bloapp.CommomUtility.101
    ...
    public void getDetailsByEpicOrRefno(final Context context, String token, String atkband, String rtkband, String state, String formtype, String refno, String key, final FormatCDetailsCallback verifyCitizenListCallback) {
        ...
        map.put("rtkn_bnd", rtkband);
        map.put("channelidobo", "BLOAPP");
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getDetailsByEpicOrRefno(formtype, refno, map).enqueue(new Callback<in.gov.eci.bloapp.views.activity.newsir.model.formatcdetails.Root>() { // from class: in.gov.eci.bloapp.CommomUtility.102
    ...
    public void formatCSubmit(Context context, HashMap<String, String> header, Map<String, Object> body, final FormatCListCallback verifyCitizenListCallback) {
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).formatCSubmit(header, body).enqueue(new Callback<Void>() { // from class: in.gov.eci.bloapp.CommomUtility.103
    ...
    public void submitForm(Context context, HashMap<String, String> header, Map<String, Object> body, final FormatCListCallback verifyCitizenListCallback) {
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).updateRefNoInFormatC(header, body).enqueue(new Callback<Void>() { // from class: in.gov.eci.bloapp.CommomUtility.104
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    try {
                        verifyCitizenListCallback.onCallBack(response.code(), null, "No Record Found");
    ...
    public void getMigrationEfToBeVerifyByEpicId(final Context context, String token, Long epicId, String atkband, String rtkband, String state, String oldAc, String OldPart, String key, final VerifyCitizenListCallback verifyCitizenListCallback) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", token);
        map.put("currentRole", "blo");
        map.put("state", state);
        ...
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).getMigrationEfToBeVerifyByEpicId(state.toLowerCase(), map, map2).enqueue(new Callback<FormVerificationRoot>() { // from class: in.gov.eci.bloapp.CommomUtility.105
            public void onResponse(Call<FormVerificationRoot> call, Response<FormVerificationRoot> response) {
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        List<FormverificationPayload> list = ((FormVerificationRoot) response.body()).payload;
    ...
    public void getuploadedfileBLOpatrika(Context context, String token, String atkn, String rtkn, String fileName, String role, final MyCallback myCallback) {
        this.myCallback = myCallback;
        Logger.d(this.logTag, "getting downloaded file");
        Logger.d(this.logTag, "nisthadsrt" + fileName);
        ((UserClient) ApiClient.getClient(context).create(UserClient.class)).getdownloaded(token, atkn, rtkn, "BLOAPP", role, "ANDROIDMOB", "objectstorage", fileName, "BLOAPP").enqueue(new Callback<JsonObject>() { // from class: in.gov.eci.bloapp.CommomUtility.106
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.code() == 200) {
                    JsonObject jsonObject = (JsonObject) response.body();
                    Logger.d(CommomUtility.this.logTag, "error in image" + jsonObject.get("file"));
    ...
    public void checkSelfMappingConflict(Context context, String token, String state, String atkband, String rtkband, String oldState, String oldAc, String OldPart, String serialnumber, String current_ac_no, String current_part_no, String current_State_code, int currentAge, int oldAge, String current_EpicNo, String current_EpicId, String PreMappedBloName, String PreMappedBloNo, String preEpicNo, String currentPartSerialNo) {
        HashMap<String, String> map = new HashMap<>();
        map.put("Authorization", token);
        map.put("currentRole", "blo");
        map.put("state", state);
        ...
        map.put("channelidobo", "BLOAPP");
        HashMap map2 = new HashMap();
        map2.put("oldStateCode", oldState);
        map2.put("oldAcNo", oldAc);
        map2.put("oldPartNo", OldPart);
        map2.put("oldPartSerialNo", serialnumber);
        map2.put("currentPartNo", current_part_no);
        map2.put("currentAcNo", current_ac_no);
        map2.put("currentStateCd", current_State_code);
        map2.put("currentPartSerialNo", currentPartSerialNo);
        map2.put("currentEpicNo", current_EpicNo);
        map2.put("currentEpicId", current_EpicId);
        map2.put("preMappedBloName", PreMappedBloName);
        map2.put("preMappedBloNo", PreMappedBloNo);
        map2.put("preEpicNo", preEpicNo);
        ((UserClient) ApiClient.getClient2(context).create(UserClient.class)).checkSelfMappingConflict(state.toLowerCase(), map, map2).enqueue(new Callback<JsonObject>() { // from class: in.gov.eci.bloapp.CommomUtility.107
            public void onFailure(Call<JsonObject> call, Throwable t) {
            }
