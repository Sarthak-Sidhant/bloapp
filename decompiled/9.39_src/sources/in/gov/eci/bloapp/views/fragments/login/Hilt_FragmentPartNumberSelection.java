...
abstract class Hilt_FragmentPartNumberSelection extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_FragmentPartNumberSelection() {
    }
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FragmentPartNumberSelection_GeneratedInjector) generatedComponent()).injectFragmentPartNumberSelection((FragmentPartNumberSelection) UnsafeCasts.unsafeCast(this));
    }
