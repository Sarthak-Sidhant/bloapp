...
public final class ActivityRollbackFormsListBinding implements ViewBinding {
    ...
    public static ActivityRollbackFormsListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityRollbackFormsListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_rollback_forms_list, parent, false);
        if (attachToParent) {
    ...
    public static ActivityRollbackFormsListBinding bind(View rootView) {
                                    ...
                                    if (editText != null) {
                                        ...
                                        if (spinner != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (imageView3 != null) {
                                                    return new ActivityRollbackFormsListBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView2, imageView3);
                                                }
                                            }
                                        }
                                    }
