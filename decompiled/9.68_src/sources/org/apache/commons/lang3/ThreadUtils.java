...
public class ThreadUtils {
    ...
    private static final Predicate<?> ALWAYS_TRUE = new Predicate() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda0
    ...
    public static Thread findThreadById(final long j) {
        ...
        Collection<Thread> collectionFindThreads = findThreads((Predicate<Thread>) new Predicate() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    static /* synthetic */ boolean lambda$findThreadById$1(long j, Thread thread) {
    ...
    public static Collection<ThreadGroup> findThreadGroups(ThreadGroup threadGroup, boolean z, final ThreadGroupPredicate threadGroupPredicate) {
        ...
        return findThreadGroups(threadGroup, z, (Predicate<ThreadGroup>) new Predicate() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public static Collection<Thread> findThreads(ThreadGroup threadGroup, boolean z, final ThreadPredicate threadPredicate) {
        ...
        return findThreads(threadGroup, z, (Predicate<Thread>) new Predicate() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda7
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public static void join(final Thread thread, Duration duration) throws Throwable {
        thread.getClass();
        DurationUtils.accept(new FailableBiConsumer() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda3
    ...
    static /* synthetic */ boolean lambda$namePredicate$3(Function function, String str, Object obj) {
    ...
    private static <T> Predicate<T> namePredicate(final String str, final Function<T, String> function) {
        return new Predicate() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda9
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    private static Predicate<Thread> predicateThread(String str) {
        return namePredicate(str, new Function() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda8
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    private static Predicate<ThreadGroup> predicateThreadGroup(String str) {
        return namePredicate(str, new Function() { // from class: org.apache.commons.lang3.ThreadUtils$$ExternalSyntheticLambda6
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
