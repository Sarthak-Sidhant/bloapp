...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    ...
    public static final /* synthetic */ Double m5696max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = XmlOptions.GENERATE_JAVA_15, hiddenSince = "1.6", warningSince = XmlOptions.GENERATE_JAVA_14)
    /* JADX INFO: renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m5697max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt.maxOrNull(iterable);
    }
    ...
    public static final /* synthetic */ Double m5698min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = XmlOptions.GENERATE_JAVA_15, hiddenSince = "1.6", warningSince = XmlOptions.GENERATE_JAVA_14)
    /* JADX INFO: renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m5699min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt.minOrNull(iterable);
    }
