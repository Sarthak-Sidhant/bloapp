...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public final void mo6814dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            AbstractResolvableFuture$SafeAtomicHelper$.ExternalSyntheticBackportWithForwarding0.m(_delayed$volatile$FU, this, (Object) null, new DelayedTaskQueue(now));
