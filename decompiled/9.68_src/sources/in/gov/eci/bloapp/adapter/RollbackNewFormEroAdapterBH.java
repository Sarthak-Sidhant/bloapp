...
public class RollbackNewFormEroAdapterBH extends RecyclerView.Adapter<ViewHolder> {
    private Context context;
    ArrayList<RollbackNewModel> datalist;
    ArrayList<RollbackNewModel> filteredAl;

    public RollbackNewFormEroAdapterBH(ArrayList<RollbackNewModel> datalist, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.rollback_new_list_ero_items_bh, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.fillEF.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapterBH.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormEroAdapterBH.this.context, (Class<?>) specialRevisionActivityBH.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
                RollbackNewFormEroAdapterBH.this.context.startActivity(intent);
            }
        });
        viewHolder.uncollectable.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.adapter.RollbackNewFormEroAdapterBH.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(RollbackNewFormEroAdapterBH.this.context, (Class<?>) UncollectableSIRoldBH.class);
                intent.putExtra("epic", rollbackNewModel.getEpicNo());
