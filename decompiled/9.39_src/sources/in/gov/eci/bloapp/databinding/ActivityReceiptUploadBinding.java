                        ...
                        if (imageView3 != null) {
                            ...
                            if (spinner != null) {
                                ...
                                if (linearLayout != null) {
                                    i = 2131364126;
                                    ImageView imageView4 = (ImageView) ViewBindings.findChildViewById(rootView, 2131364126);
                                    if (imageView4 != null) {
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        ...
                                                                        if (textView7 != null) {
                                                                            ...
                                                                            if (imageView6 != null) {
                                                                                ...
                                                                                TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_upload_image);
                                                                                if (textView8 != null) {
                                                                                    i = R.id.tv_upload_receipt;
                                                                                    TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_upload_receipt);
                                                                                    if (textView9 != null) {
                                                                                        return new ActivityReceiptUploadBinding(linearLayout2, imageView, constraintLayoutFindChildViewById, imageView2, textView, imageView3, spinner, linearLayout, imageView4, imageView5, linearLayout2, linearLayout3, linearLayout4, textView2, textView3, textView4, textView5, textView6, textView7, imageView6, textView8, textView9);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
