...
public class CheckListForm6Model implements Serializable {
    ...
    String ageProofType;
    String annexuredetsilsSameorNot;
    String anxDSignUrl;
    ...
    String offlineSignedPage1Url;
    String offlineSignedPage2Url;
    ...
    String photograph;
    String placeOfBirthOutsideIndia;
    String preEpicNo;
    String prevAcNo;
    ...
    String serialNumber;
    String setDeclarationSameOrNot;
    ...
    public String getPlaceOfBirthOutsideIndia() {
        return this.placeOfBirthOutsideIndia;
    }

    public void setPlaceOfBirthOutsideIndia(String placeOfBirthOutsideIndia) {
        this.placeOfBirthOutsideIndia = placeOfBirthOutsideIndia;
    }
    ...
    public void setFormProcessingId(int formProcessingId) {
        this.formProcessingId = formProcessingId;
    }
    ...
    public void setWorkflowConfigId(int workflowConfigId) {
    ...
    public void setPersonalDetailsSameOrNot(String personalDetailsSameOrNot) {
        this.personalDetailsSameOrNot = personalDetailsSameOrNot;
    }
    ...
    public void setAuthenticationSameOrNot(String authenticationSameOrNot) {
        this.authenticationSameOrNot = authenticationSameOrNot;
    }
    ...
    public void setDateOfBirthSameOrNot(String dateOfBirthSameOrNot) {
        this.dateOfBirthSameOrNot = dateOfBirthSameOrNot;
    }
    ...
    public void setAddressSameOrNot(String addressSameOrNot) {
        this.addressSameOrNot = addressSameOrNot;
    }
    ...
    public void setFamilyDetailsSameOrNot(String familyDetailsSameOrNot) {
        this.familyDetailsSameOrNot = familyDetailsSameOrNot;
    }
    ...
    public void setDisabilityDetailsSameOrNot(String disabilityDetailsSameOrNot) {
        this.disabilityDetailsSameOrNot = disabilityDetailsSameOrNot;
    }
    ...
    public void setSectionNameAndNumber(ArrayList<String> sectionNameAndNumber) {
        this.sectionNameAndNumber = sectionNameAndNumber;
    }
    ...
    public void setSectionNameAndNumberModel(ArrayList<SectionNumberModel.Root> sectionNameAndNumberModel) {
        this.sectionNameAndNumberModel = sectionNameAndNumberModel;
    }
    ...
    public void setRelationListCode(ArrayList<String> relationListCode) {
        this.relationListCode = relationListCode;
    }
    ...
    public void setAddressPoofListCode(ArrayList<String> addressPoofListCode) {
        this.addressPoofListCode = addressPoofListCode;
    }
    ...
    public void setAgeProofListCode(ArrayList<String> ageProofListCode) {
        this.ageProofListCode = ageProofListCode;
    }
    ...
    public String getAnnexuredetsilsSameorNot() {
        return this.annexuredetsilsSameorNot;
    }

    public void setAnnexuredetsilsSameorNot(String annexuredetsilsSameorNot) {
        this.annexuredetsilsSameorNot = annexuredetsilsSameorNot;
    }
    ...
    public String getSetDeclarationSameOrNot() {
        return this.setDeclarationSameOrNot;
    }

    public void setSetDeclarationSameOrNot(String setDeclarationSameOrNot) {
        this.setDeclarationSameOrNot = setDeclarationSameOrNot;
    }
    ...
    public String getAddtionalDocType() {
        return this.addtionalDocType;
    }

    public void setAddtionalDocType(String addtionalDocType) {
        this.addtionalDocType = addtionalDocType;
    }

    public String getAddtionalDocDln() {
        return this.addtionalDocDln;
    }

    public void setAddtionalDocDln(String addtionalDocDln) {
        this.addtionalDocDln = addtionalDocDln;
    }

    public String getOfflineSignedPage1Url() {
        return this.offlineSignedPage1Url;
    }

    public void setOfflineSignedPage1Url(String offlineSignedPage1Url) {
        this.offlineSignedPage1Url = offlineSignedPage1Url;
    }

    public String getOfflineSignedPage2Url() {
        return this.offlineSignedPage2Url;
    }

    public void setOfflineSignedPage2Url(String offlineSignedPage2Url) {
        this.offlineSignedPage2Url = offlineSignedPage2Url;
    }

    public Boolean getBloAddDocDeclaration() {
        return this.bloAddDocDeclaration;
    }

    public void setBloAddDocDeclaration(Boolean bloAddDocDeclaration) {
        this.bloAddDocDeclaration = bloAddDocDeclaration;
    }
}
