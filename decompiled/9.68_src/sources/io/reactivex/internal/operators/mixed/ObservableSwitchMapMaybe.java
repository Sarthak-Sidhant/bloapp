...
public final class ObservableSwitchMapMaybe<T, R> extends Observable<R> {
    ...
    static final class SwitchMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        void innerError(SwitchMapMaybeObserver<R> switchMapMaybeObserver, Throwable th) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapMaybeObserver, (Object) null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        void innerComplete(SwitchMapMaybeObserver<R> switchMapMaybeObserver) {
            if (PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapMaybeObserver, (Object) null)) {
                drain();
            }
        }
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z2 && switchMapMaybeObserver.item != null) {
                    PreviewView$1$.ExternalSyntheticBackportWithForwarding0.m(atomicReference, switchMapMaybeObserver, (Object) null);
