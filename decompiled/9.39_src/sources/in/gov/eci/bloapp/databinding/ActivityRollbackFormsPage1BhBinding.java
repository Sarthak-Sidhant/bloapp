...
public final class ActivityRollbackFormsPage1BhBinding implements ViewBinding {
    ...
    public static ActivityRollbackFormsPage1BhBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityRollbackFormsPage1BhBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_rollback_forms_page1_bh, parent, false);
        if (attachToParent) {
    ...
    public static ActivityRollbackFormsPage1BhBinding bind(View rootView) {
