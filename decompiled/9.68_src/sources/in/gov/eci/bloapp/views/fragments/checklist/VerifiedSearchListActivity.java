            ...
            try {
                ...
                if (this.verifiedListData.size() > 0) {
                    for (int i = 0; i < this.verifiedListData.size(); i++) {
                        ...
                        this.verifiedList.add(new TotalListModel(String.valueOf(asJsonObject.get("applicantName")).replaceAll("^\"|\"$", "").replaceAll(" null | null", StringUtils.SPACE), String.valueOf(asJsonObject.get("formRefNumber")).replaceAll("^\"|\"$", ""), "", "", "", "", "", "", Integer.parseInt(String.valueOf(asJsonObject.get("processMasterId"))), Integer.parseInt(String.valueOf(asJsonObject.get("formProcessingDetailsId"))), 0, String.valueOf(asJsonObject.get("remarks")), String.valueOf(asJsonObject.get("remarksType")), String.valueOf(asJsonObject.get("isExistingElector")).replaceAll("^\"|\"$", ""), String.valueOf(asJsonObject.get("uncollectableSir")).replaceAll("^\"|\"$", "")));
                    }
                } else {
