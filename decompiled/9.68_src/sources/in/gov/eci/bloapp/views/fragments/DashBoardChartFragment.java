...
public class DashBoardChartFragment extends Fragment {
    ...
    private ArrayList<BarEntry> dataValues1() {
        ...
        arrayList.add(new BarEntry(CropImageView.DEFAULT_ASPECT_RATIO, new float[]{(float) Double.parseDouble(this.withinForm6), (float) Double.parseDouble(this.withinForm6A), (float) Double.parseDouble(this.withinForm6B), (float) Double.parseDouble(this.withinForm7), (float) Double.parseDouble(this.withinForm8)}));
