...
public final class ActivityEfTrackerBinding implements ViewBinding {
    ...
    private ActivityEfTrackerBinding(LinearLayout rootView, ImageView IvScanCode, ImageView backBtnIv, ConstraintLayout blaTopLayout, Button btScanCode, LinearLayout main, TextView note3, TextView note4, TextView note5, TextView note6, TextView noteOpen, TextView noteTotal, RecyclerView recyclerView, ConstraintLayout scanCode, EditText search, Spinner spinner, TextView textView3, TextView textView5, ImageView toolbarButton) {
    ...
    public static ActivityEfTrackerBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityEfTrackerBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_ef_tracker, parent, false);
        if (attachToParent) {
    ...
    public static ActivityEfTrackerBinding bind(View rootView) {
            ...
            if (imageView2 != null) {
                ...
                if (constraintLayoutFindChildViewById != null) {
                    ...
                    if (button != null) {
                        ...
                        i = R.id.note3;
                        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.note3);
                        if (textView != null) {
                            i = R.id.note4;
                            TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, R.id.note4);
                            if (textView2 != null) {
                                i = R.id.note5;
                                TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, R.id.note5);
                                if (textView3 != null) {
                                    i = R.id.note6;
                                    TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.note6);
                                    if (textView4 != null) {
                                        i = R.id.noteOpen;
                                        TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.noteOpen);
                                        if (textView5 != null) {
                                            i = R.id.noteTotal;
                                            TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.noteTotal);
                                            if (textView6 != null) {
                                                i = R.id.recyclerView;
                                                            ...
                                                            if (spinner != null) {
                                                                ...
                                                                if (textView7 != null) {
                                                                    ...
                                                                    if (textView8 != null) {
                                                                        ...
                                                                        if (imageView3 != null) {
                                                                            return new ActivityEfTrackerBinding(linearLayout, imageView, imageView2, constraintLayoutFindChildViewById, button, linearLayout, textView, textView2, textView3, textView4, textView5, textView6, recyclerViewFindChildViewById, constraintLayoutFindChildViewById2, editText, spinner, textView7, textView8, imageView3);
                                                                        }
                                                                    }
                                                                }
                                                            }
