...
abstract class Hilt_VerifiedFragment extends Fragment implements GeneratedComponentManagerHolder {
    ...
    Hilt_VerifiedFragment() {
        this.componentManagerLock = new Object();
        this.injected = false;
    }

    Hilt_VerifiedFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((VerifiedFragment_GeneratedInjector) generatedComponent()).injectVerifiedFragment((VerifiedFragment) UnsafeCasts.unsafeCast(this));
    }
