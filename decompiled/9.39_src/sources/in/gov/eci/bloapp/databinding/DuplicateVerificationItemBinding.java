                                            ...
                                            if (linearLayout5 != null) {
                                                ...
                                                if (textView6 != null) {
                                                    ...
                                                    if (textView7 != null) {
                                                        ...
                                                        if (textView8 != null) {
                                                            i = R.id.tv_asd;
                                                            TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_asd);
                                                            if (textView9 != null) {
                                                                i = R.id.tv_clusterid;
                                                                TextView textView10 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_clusterid);
                                                                if (textView10 != null) {
                                                                    ...
                                                                    if (textView11 != null) {
                                                                        ...
                                                                        if (textView12 != null) {
                                                                            ...
                                                                            if (textView13 != null) {
                                                                                return new DuplicateVerificationItemBinding((LinearLayout) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, linearLayout2, linearLayout3, linearLayout4, linearLayout5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13);
                                                                            }
                                                                        }
                                                                    }
                                                                }
