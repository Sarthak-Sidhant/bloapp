...
public class FilenameUtils {
    ...
    private static String doGetPath(String str, int i) {
        ...
        if (prefixLength >= str.length() || iIndexOfLastSeparator < 0) {
            return "";
        }
        return str.substring(prefixLength, iIndexOfLastSeparator + i);
    }
    ...
    private static String doGetFullPath(String str, boolean z) {
        ...
        return str.substring(0, iIndexOfLastSeparator + (z ? 1 : 0));
    }
