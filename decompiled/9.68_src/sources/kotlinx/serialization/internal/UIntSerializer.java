...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m5354boximpl(m6863deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m6864serializeQn1smSk(encoder, ((UInt) obj).getData());
    }
    ...
    public void m6864serializeQn1smSk(Encoder encoder, int value) {
    ...
    public int m6863deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m5360constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}
