...
public class UncollectedEFAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.uncollectedefDoc.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.sir.UncollectedEF.UncollectedEFAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(UncollectedEFAdapter.this.context, (Class<?>) UncollectableSIR.class);
                ...
                intent.putExtra("epicId", uncollectedEFModel.getEpicId());
