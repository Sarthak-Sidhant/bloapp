...
public class EPIC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.binding.electorname.setText(arguments.getString("firstnameOfficial") + StringUtils.SPACE + arguments.getString("surnameOfficial"));
        this.binding.electorname1.setText(arguments.getString("firstNameEd") + StringUtils.SPACE + arguments.getString("surNameEd"));
        if (arguments.getString(this.relationSpinner).equals("FATHER")) {
            this.binding.fathername.setText(arguments.getString(this.relativeNameOfficial) + StringUtils.SPACE + arguments.getString(this.relativeSurNameOfficial));
            this.binding.fatherName1.setText(arguments.getString(this.relativeName) + StringUtils.SPACE + arguments.getString(this.relativeSurName));
        ...
        this.binding.epicDistrict.setText("Electoral Registration Officer, " + assemblyNumber + StringUtils.SPACE + SharedPref.getInstance(getContext()).getAssemblyName());
        this.binding.epicDistrict1.setText("निर्वाचक निबंधन पदाधिकारी, " + assemblyNumber + StringUtils.SPACE + assemblyNameL1);
        try {
