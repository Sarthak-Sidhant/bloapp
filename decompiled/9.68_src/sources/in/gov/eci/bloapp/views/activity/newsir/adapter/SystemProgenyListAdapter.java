...
public class SystemProgenyListAdapter extends RecyclerView.Adapter<ViewHolder> {
    Context context;
    ...
    public SystemProgenyListAdapter(Context context, List<MappingList> items, OnItemSelectedListener listener) {
        this.items = items;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() { // from class: in.gov.eci.bloapp.views.activity.newsir.adapter.SystemProgenyListAdapter$ViewHolder$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$new$0(View view) {
            int i = 0;
            while (true) {
                if (i >= SystemProgenyListAdapter.this.items.size()) {
                    i = -1;
                    break;
                } else {
                    if (((MappingList) SystemProgenyListAdapter.this.items.get(i)).isSelected()) {
                        ((MappingList) SystemProgenyListAdapter.this.items.get(i)).setSelected(false);
                        break;
                    }
                    i++;
                }
            }
            ((MappingList) SystemProgenyListAdapter.this.items.get(getAdapterPosition())).setSelected(true);
            if (i != -1) {
                SystemProgenyListAdapter.this.notifyItemChanged(i);
            }
            SystemProgenyListAdapter.this.notifyItemChanged(getAdapterPosition());
            SystemProgenyListAdapter.this.listener.onItemSelected();
        }
    }
