...
public final class ActivityRollBackFromAeroBinding implements ViewBinding {
    ...
    private ActivityRollBackFromAeroBinding(LinearLayout rootView, ImageView backBtnIv, ConstraintLayout blaTopLayout, LinearLayout main, LinearLayout rollbackEditLayout, TextView rollbackEditTv, LinearLayout rollbackNewLayout, TextView rollbackNewTv, TextView textView3, Toolbar toolbar, ImageView toolbarButton) {
    ...
    public static ActivityRollBackFromAeroBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityRollBackFromAeroBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_roll_back_from_aero, parent, false);
        if (attachToParent) {
    ...
    public static ActivityRollBackFromAeroBinding bind(View rootView) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (toolbarFindChildViewById != null) {
                                        ...
                                        if (imageView2 != null) {
                                            return new ActivityRollBackFromAeroBinding(linearLayout, imageView, constraintLayoutFindChildViewById, linearLayout, linearLayout2, textView, linearLayout3, textView2, textView3, toolbarFindChildViewById, imageView2);
                                        }
                                    }
                                }
                            }
